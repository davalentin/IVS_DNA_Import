...
namespace INPS.Pensioni.LiquidazioneCi.Data
{
    ...
    /// </summary>
    [Serializable]
    public class CI01 : BaseClass, ITransactionInfo
    {
        ...
        /// </summary>
        public CI01(PCIINPU7.Gruppo1 gruppo1, PCIINPU7.Gruppo2 gruppo2, PCIINPU7.Gruppo3 gruppo3, PCIINPU7.Gruppo4 gruppo4)
        {
        ...
        public HostResponse.CI01Response Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<CI01>(this);
                ...
                HostTransactionManager.AreaFromHost<CI01>(this, output);
