...
namespace INPS.Pensioni.LiquidazioneCi.Data
{
    ...
    /// </summary>
    [Serializable]
    public class CI02New : BaseClass, ITransactionInfo
    {
        ...
        /// </summary>
        public CI02New(PCIINPU7.Gruppo1 gruppo1, PCIINPU7.Gruppo2 gruppo2, PCIINPU7.Gruppo3 gruppo3, PCIINPU7.Gruppo4 gruppo4, PCIINPU7.Gruppo5 gruppo5)
        {
        ...
        public HostResponse.CI02ResponseNew Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<CI02New>(this);
                ...
                HostTransactionManager.AreaFromHost<CI02New>(this, output);
