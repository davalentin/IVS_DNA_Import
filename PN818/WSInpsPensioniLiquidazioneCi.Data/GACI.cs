...
namespace INPS.Pensioni.LiquidazioneCi.Data
{
    ...
    /// </summary>
    public class GACI : BaseClass, ITransactionInfo
    {
        ...
        public GACI(string sede, string categoria, string certificato, string codice_af, string codice_as, string altriDati, int annoCompetenza)
        {
            this.Request = new HostRequest.GACIRequest();
        ...
        public HostRequest.GACIRequest Request { get; set; }

        [HisComplexAreaInfoMapping(1, Direction = HostDirection.Output)]
        public HostResponse.GACIResponse Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<GACI>(this);
                ...
                HostTransactionManager.AreaFromHost<GACI>(this, output);
                ConvertAreaDati();
