...
{
    public class CI01Record_RE
    {
        #region Constructor
        internal CI01Record_RE()
        {
        }
        ...
        //      **                      TABELLA DATI CALCOLO SUPPLEMENTI    ***** 
        ...
        //                       07  DF97031-C         PIC X.                     
        //      **********                           DECORRENZA                   
        //                       07  DF97032-CA        PIC 9(4).                  
        //                       07  DF97032-CM        PIC 99.                    
        //      **********                           N.  SETTIMANE                
        //                       07  DF97033-C         PIC 9(4).                  
        //      **********                           RETRIBUZ. MEDIA SETTIM.      
        //                       07  DF97034-C         PIC S9(7)V9(4) COMP-3.     
        //      **********                           IMPORTO IVS                  
        //                       07  DF97035-C         PIC S9(7)V9(4) COMP-3.  
        ...
        //                           07  IMP-SOLIDA    PIC S9(5)V9(4) COMP-3.  
        ...
        //**********                                           CTR ITALIANI       
        //                         10  D15105-E-2    PIC S9(4).                   
        //**********                                           VIRTUALE           
        //                         10  D15105-E-3    PIC S9(7)V9(4) COMP-3.       
        //**********                                           COEFF.RIDUZ.       
        //                         10  D15105-E-4    PIC S9(5).                   
        //**********                                           PENS.DIRETTA       
        //                         10  D15105-E-5    PIC S9(7)V9(4) COMP-3.       
        //**********                                           PERC.SUPERSTITI    
        //                         10  D15105-E-6    PIC 9V9999 COMP-3.                     
        //**********                                           PENS.SUPERSTITI    
        //                         10  D15105-E-7    PIC S9(7)V9(4) COMP-3.       
        //**********                                           PENS.ESTERA        
        //                         10  D15105-E-8    PIC S9(7)V9(4) COMP-3.  
        ...
        //***********                                             DECORRENZA            
        //                               16  D15109-E-DEC1  PIC 9(4).             
        //                               16  D15109-E-DEC2  PIC 9(2).             
        //***********                                             CESSAZIONE           
        //                               16  D15109-E-CES1  PIC 9(4).             
        //                               16  D15109-E-CES2  PIC 9(2).             
        //***********                                             IMP.ESTERO      
        ...
        //***********    =   FLAG PRE CRI 'A'                                     
        //                       05  FLAGCRI335                   PIC X.          
        //***********    =   ARRETRATI BLOCCATI ESTERO                            
        //                       05  BLOCCO-ARRETRATI             PIC X.          
        //***********    = 1 IMPORTO FINE A L 10000                               
        ...
        //                          07  IMPO-TASSE COMP-3  PIC S9(5)V9(4).    
        ...
        //                       05  AXE3                       PIC X.            
        //***********    =  MONTANTE FITTIZIE                                     
        //                       05  MONTANTE-FITT      PIC S9(7)V9(4) COMP-3.    
        //***********    =  A DISPOSIZIONE                                        
        //                       05  FILLER                     PIC X(4).      
        ...
        //                           06  DF9325-C-503     PIC S9(7)V9(4) COMP-3.  
        //                           06  DF9326-C-503     PIC S9(4).            


        //***********    =  SETTIMANE FITTIZIE                                    
        //                       05  SETT-FITT             PIC 9(4).              
        //***********    =  RIMPATRIATI
        //                       05  COD-108               PIC X.
        //                           06  AA-DEC108         PIC 9(4).
        //                           06  MM-DEC108         PIC 99.
        //***********    =  A DISPOSIZIONE                                        
        //********************   05  DISPFILL              PIC X(54).
        //                       05  DISPFILL              PIC X(41).
        ...
        public List<Supplemento> LISTASUPPLEMENTI { get; set; }
        ...
        public List<StampaPLCIEstero> LISTASTAMPAPLCIESTERO { get; set; }

        [HisComplexAreaInfoMapping(4, ListCount = 5)]
        public List<Paragrafo> LISTAPARAGRAFO { get; set; }
        ...
        [HisComplexAreaInfoMapping(18, ListCount = 6)]
        public List<Tassa> LISTATASSE { get; set; }
        ...
        /// </summary>
        [HisFieldInfoMapping(26, 6, Scale = 4, CobolType = CobolType.Comp3)]
        ...
        [HisComplexAreaInfoMapping(28, ListCount = 6)]
        public List<Elem_503> LISTAELEM_503 { get; set; }
        ...
        public string COD_108 { get; set; }

        /// <summary>
        /// AA_DEC108 9(4)  
        /// </summary>
        [HisFieldInfoMapping(31, 4)]
        public short AA_DEC108 { get; set; }

        /// <summary>
        /// MM_DEC108 99  
        /// </summary>
        [HisFieldInfoMapping(32, 2)]
        public short MM_DEC108 { get; set; }
        ...
        /// DISPFILL X(41)  
        /// </summary>
        [HisFieldInfoMapping(33, 41)]
        public string DISPFILL { get; set; }

        /// <summary>
        /// NUME_DOMUS X(13)  
        /// </summary>
        [HisFieldInfoMapping(34, 13)]
        ...
        /// COGN_D_C X(32)  
        /// </summary>
        [HisFieldInfoMapping(38, 32)]
        public string COGN_D_C { get; set; }

        /// <summary>
        /// NOME_D_C X(32)  
        /// </summary>
        [HisFieldInfoMapping(39, 32)]
        ...
        /// NASC_D_C 9(8)  
        /// </summary>
        [HisFieldInfoMapping(41, 8)]
        public int NASC_D_C { get; set; }

        /// <summary>
        /// MATRICOLA X(16)  
        /// </summary>
        [HisFieldInfoMapping(42, 16)]
        ...
        public class StampaPLCIEstero
        {
            #region Constructor
            internal StampaPLCIEstero()
            {
            }
            #endregion Constructor
