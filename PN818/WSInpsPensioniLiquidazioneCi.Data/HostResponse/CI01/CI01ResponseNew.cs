...
{
    public class CI01ResponseNew
    {
        #region Constructor
        public CI01ResponseNew()
        {
            this.RecordZeroCentro = new AreaRecordZeroCentro();
            this.Record_RA = new CI01Record_RA();
            this.Record_RB = new CI01Record_RB();
            this.Record_RDA = new CI01Record_RDA();
            this.Record_RE = new CI01Record_RE();
        }
        ...
        public CI01Record_RA Record_RA { get; set; }

        [HisComplexAreaInfoMapping(3)]
        public CI01Record_RB Record_RB { get; set; }

        [HisComplexAreaInfoMapping(4)]
        public CI01Record_RDA Record_RDA { get; set; }

        [HisComplexAreaInfoMapping(5)]
        public CI01Record_RE Record_RE { get; set; }
        ...
        public CI01NonPresenzaREDD NonPresenzaREDD { get; set; }
