...
{
    public class GACIAreaDecompressaBis : ITransactionInfo
    {
        #region Constructor
        public GACIAreaDecompressaBis()
        {
            this.Gruppo1 = new PCIINPU7.Gruppo1Bis();
        ...
        public PCIINPU7.Gruppo1Bis Gruppo1 { get; set; }
