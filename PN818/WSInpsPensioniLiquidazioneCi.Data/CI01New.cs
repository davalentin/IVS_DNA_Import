...
{
    /// <summary>
    /// Invoca la transazione CI01: si occupa del calcolo delle prime liquidate
    /// </summary>
    [Serializable]
    public class CI01New : BaseClass, ITransactionInfo
    {
        private HisLiquidazioneCi.ClientContext _ClientContext;

        #region Constructor
        /// <summary>
        /// Crea un'instanza della classe CI01
        /// </summary>
        public CI01New(PCIINPU7.Gruppo1 gruppo1, PCIINPU7.Gruppo2 gruppo2, PCIINPU7.Gruppo3 gruppo3, PCIINPU7.Gruppo4 gruppo4, PCIINPU7.Gruppo5 gruppo5)
        {
            this.Request = new HostRequest.CI01_CI02RequestNew();
            this.Request.Gruppo1 = gruppo1;
            this.Request.Gruppo2 = gruppo2;
            this.Request.Gruppo3 = gruppo3;
            this.Request.Gruppo4 = gruppo4;
            this.Request.Gruppo5 = gruppo5;
        ...
        public HostRequest.CI01_CI02RequestNew Request { get; set; }

        [HisComplexAreaInfoMapping(1, Direction = HostDirection.Output)]
        public HostResponse.CI01ResponseNew Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<CI01New>(this);

                HisLiquidazioneCi.LiquidazioneCiClient proxy = new HisLiquidazioneCi.LiquidazioneCiClient();
                byte[] output = proxy.CI01(inputData, ref _ClientContext);
                ...
                HostTransactionManager.AreaFromHost<CI01New>(this, output);
                ...
                if (this.Response.RISP_UNTRASLATED != null && this.Response.RISP_UNTRASLATED.Length >= 4)
                {
                    ...
                    {
                        this.Response.NonPresenzaREDD = new CI01NonPresenzaREDD();
                        HostTransactionManager.AreaFromHost<CI01NonPresenzaREDD>(this.Response.NonPresenzaREDD, this.Response.RISP_UNTRASLATED);
                    }
                }
