...
namespace INPS.Pensioni.LiquidazioneCi
{
    public class MappingDaHostNew
    {
        ...
        public static void ValorizzaDatiPensione(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, bool isRiaperturaDomanda, short categoria, out GestionePensione.DatiPensione datiPensione)
        {
            datiPensione = null;
        ...
        public static void ValorizzaDatiSindacato(Data.GACINew AreaPrelievo, out GestionePensione.DatiSindacato datiSindacato)
        {
            datiSindacato = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo1 != null &&
        ...
        public static void ValorizzaDatiDetrazioni(Data.GACINew AreaPrelievo, out GestioneDetrazioniImposta.DatiDetrazioni datiDetrazioni)
        {
            datiDetrazioni = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo1 != null &&
        ...
        public static void ValorizzaDatiPagamento(Data.GACINew AreaPrelievo, out GestionePagamento.DatiPagamento datiPagamento)
        {
            datiPagamento = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo1 != null &&
        ...
        public static void ValorizzaDatiFamiliare(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<Entity.DatiFamiliari> ListaFamiliari)
        {
            ListaFamiliari = null;
                ...
                AreaPrelievo.FinalResponse.Gruppo2.AreaW4 != null)
            {
                    ...
                    areaW4.DATIFAMILIARI != null && areaW4.DATIFAMILIARI.Count > 0)
                {
                    for (int i = 0; i < areaW4.CODICIFISCALIFAMILIARI.Count; i++)
                    {
                        ...
                        //ordino l'elenco per data più recente e prendo la sigla familiare più recente
        ...
        public static void ValorizzaDatiCalcoloContributivo(Data.GACINew AreaPrelievo, out List<GestioneCalcolo.DatiCalcoloContributivo> ListaCalcoloContributivo)
        {
        ...
        public static void ValorizzaDatiCalcoloRetributivo(Data.GACINew AreaPrelievo, out List<GestioneCalcolo.DatiCalcoloRetributivo> ListaCalcoloRetributivo)
        {
        ...
        public static void ValorizzaDatiSupplementi(Data.GACINew AreaPrelievo, out List<INPS.Pensioni.Liquidazione.BLCommon.Entity.DatiSupplementi> ListaSupplementi)
        {
        ...
        public static void ValorizzaDatiDanteCausa(Data.GACINew AreaPrelievo, out DatiAnagDanteCausa datiAnagDanteCausa, out GestioneDanteCausa.DatiDanteCausa datiDanteCausa, GestionePrelievo.TipoDomanda tipoDomanda, short categoria)
        {
            datiDanteCausa = null;
        ...
        //ENG - Implementata la gestione mancante per le Reversibilità
        //al momento vengono prese in considerazione anche le Ric indirette perchè non si hanno le specifiche su come distinguere, in fase di prelievo, le due tipologie(RIC REVERSIBILITA' E RIC INDIRETTE)
        public static void ValorizzaDatiPensioniEstereDc(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out GestioneDanteCausa.PensioniEstereDcBL datiPensioniEstereDc)
        {
        ...
        //ENG - Implementata la gestione mancante per le Reversibilità
        //al momento vengono prese in considerazione anche le Ric indirette perchè non si hanno le specifiche su come distinguere, in fase di prelievo, le due tipologie(RIC REVERSIBILITA' E RIC INDIRETTE)
        public static void ValorizzaDatiPensioniEstereDcImportoTotaleSupplementi(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out GestioneDanteCausa.PensioniEstereDcBL importoTotSupplementi)
        {
        ...
        //ENG - Implementata la gestione mancante per le Reversibilità
        //al momento vengono prese in considerazione anche le Ric indirette perchè non si hanno le specifiche su come distinguere, in fase di prelievo, le due tipologie(RIC REVERSIBILITA' E RIC INDIRETTE)
        public static void ValorizzaDatiPensioniEstereDcImportoArt6(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out GestioneDanteCausa.PensioniEstereDcBL importoArt6)
        {
            importoArt6 = null;
            if (tipoDomanda == GestionePrelievo.TipoDomanda.Reversibilità || (tipoDomanda == GestionePrelievo.TipoDomanda.Ricostituzione && (categoria == 6 || categoria == 87 || categoria == 90 || categoria == 93)))
            {
        ...
        public static void ValorizzaDatiResidenzeEstere(Data.GACINew AreaPrelievo, out List<GestioneAnagrafica.DatiResidenzaEstero> ListaResidenzeEstere)
        {
        ...
        public static void ValorizzaDatiSentenza495_93(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out List<GestioneDanteCausa.DatiRedditoSentenza495_93> lDatiSentenze)
        {
        ...
        public static void ValorizzaDatiIstruttoria(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out GestioneIstruttoria.DatiIstruttoria datiIstruttoria)
        {
        ...
        public static void ValorizzaDatiDelegato(Data.GACINew AreaPrelievo, out DatiDelegato datiDelegato)
        {
            datiDelegato = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo1 != null &&
        ...
        public static void ValorizzaDatiTutore(Data.GACINew AreaPrelievo, out DatiTutore datiTutore)
        {
            datiTutore = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo1 != null &&
        ...
        public static void ValorizzaDatiVittimeTerrorismo(Data.GACINew AreaPrelievo, out GestioneVittimeTerrorismo.DatiVittimeTerrorismo datiVittimeTerrorismo)
        {
            datiVittimeTerrorismo = null;
        }

        public static void ValorizzaDatiStatiCivili(Data.GACINew AreaPrelievo, out List<GestioneAnagrafica.DatiStatoCivile> ListaStatiCivili)
        {
        ...
        public static void ValorizzaDatiPensioniCiDatiGenerici(Data.GACINew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out GestioneDatiGenericiAgoCi.PensioniDatiGenerici datiGenerici)
        {
            datiGenerici = null;
            string codCat = string.Empty;
        ...
        public static void ValorizzaDatiPensioniCIImportiValuta(Data.GACINew AreaPrelievo, out List<GestioneDatiContributiviCi.PensioniCiImportiValuta> ListaImportiValuta)
        {
        ...
        public static void ValorizzaDatiIntegrazioneArt11(Data.GACINew AreaPrelievo, out GestioneIntegrazioneArt11.IntegrazioneArt11 datiIntegrazioneArt11)
        {
        ...
        public static void ValorizzaDatiCalcoloContributivoEstero(Data.GACINew AreaPrelievo, out List<GestioneCalcolo.DatiCalcoloContributivoEstero> ListaCalcoloContributivoEstero)
        {
        ...
        public static void ValorizzaDatiPensioniCiMaternitaAcna(Data.GACINew AreaPrelievo, out List<GestioneDatiContributiviCi.PensioniCiMaternitaAcna> ListaPensioniCiMaternitaAcna)
        {
        ...
        public static void ValorizzaDatiNuoveLiquidate(Data.GACINew AreaPrelievo, out GestioneNuoveLiquidate.NuoveLiquidate datiNuoveLiquidate)
        {
        ...
        public static void ValorizzaDatiStatiEsteri(Data.GACINew AreaPrelievo, out List<GestioneContrib.StatoEstero> ListaStatiEsteri)
        {
        ...
        public static void ValorizzaDatiEliminazione(Data.GACINew AreaPrelievo, out GestionePensione.DatiEliminazione datiEliminazione)
        {
        ...
        public static void ValorizzaDatiMaggiorazioni(Data.GACINew AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, GestionePrelievo.TipoDomanda tipoDomanda, short categoria, out Liquidazione.BLCommon.GestioneMaggiorazioniBenefici.DatiMaggiorazioniBenefici datiMaggiorazioniBenefici)
        {
        ...
        public static void ValorizzaDatiOneri(Data.GACINew AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, out List<GestioneOneri.DatiOneri> ListaDatiOneri)
        {
            ListaDatiOneri = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.Gruppo4 != null && AreaPrelievo.FinalResponse.Gruppo4.AreaCampi2018 != null &&
                AreaPrelievo.FinalResponse.Gruppo4.AreaCampi2018.FELPE_ONERI != null && AreaPrelievo.FinalResponse.Gruppo4.AreaCampi2018.FELPE_ONERI.Count > 0)
        ...
        public static void ValorizzaDatiBeneficiParticolari(Data.GACINew AreaPrelievo, out List<GestioneBeneficiParticolari.DatiBeneficiParticolari> ListaDatiBeneficiParticolari)
        {
        ...
        public static void ValorizzaDatiBititolarita(Data.GACINew AreaPrelievo, out List<GestioneAltrePensioni.AltraPensione> ListaBititolarita)
        {
        ...
        public static void ValorizzaDatiPostDecOriginaria(Data.GACINew AreaPrelievo, out List<GestioneContrib.DatiPostDecOriginaria> ListaDatiPostDecOriginaria)
        {
        ...
        public static void ValorizzaDatiINAIL(Data.GACINew AreaPrelievo, out List<GestionePensioneInailInabilita.DatiPensioniINAIL> listaDatiInail)
        {
            listaDatiInail = null;
