...
namespace INPS.Pensioni.LiquidazioneFs.Data.HostResponse.AreaStampa
{
    public class Conguagli
    {
        ...
        public List<AnnoRiferimento> LISTAnnoRiferimento { get; set; }

        [HisComplexAreaInfoMapping(2, ListCount = 50)]
        public List<ImportoAnnuo> LISTImportoAnnuo { get; set; }

        [HisComplexAreaInfoMapping(3, ListCount = 50)]
        public List<TrattamentoFamiglia> LISTTrattamentoFamiglia { get; set; }
        ...
        public List<AssegnoAccompagnamento> LISTAssegnoAccompagnamento { get; set; }
        /// <summary>
        /// FILLER X(98)  
        /// </summary>
