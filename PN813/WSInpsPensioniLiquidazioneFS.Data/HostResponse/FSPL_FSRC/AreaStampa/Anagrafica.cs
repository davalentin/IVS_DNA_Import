...
namespace INPS.Pensioni.LiquidazioneFs.Data.HostResponse.AreaStampa
{
    public class Anagrafica
    {
        ...
        public List<TipoRapporto> LISTTipoRapporto { get; set; }

        [HisComplexAreaInfoMapping(1, ListCount = 3)]
        public List<Cognome> LISTCognome { get; set; }

        [HisComplexAreaInfoMapping(2, ListCount = 3)]
        public List<Nome> LISTNome { get; set; }

        [HisComplexAreaInfoMapping(3, ListCount = 3)]
        public List<CognomeAcquisito> LISTCognomeAcquisito { get; set; }

        [HisComplexAreaInfoMapping(4, ListCount = 3)]
        public List<DataNascita> LISTDataNascita { get; set; }

        [HisComplexAreaInfoMapping(5, ListCount = 3)]
        public List<CodiceComuneNascita> LISTCodiceComuneNascita { get; set; }

        [HisComplexAreaInfoMapping(6, ListCount = 3)]
        public List<ComuneNascita> LISTComuneNascita { get; set; }

        [HisComplexAreaInfoMapping(7, ListCount = 3)]
        public List<ProvinciaNascita> LISTProvinciaNascita { get; set; }

        [HisComplexAreaInfoMapping(8, ListCount = 3)]
        public List<CodiceFiscale> LISTCodiceFiscale { get; set; }

        [HisComplexAreaInfoMapping(9, ListCount = 3)]
        public List<Sesso> LISTSesso { get; set; }

        [HisComplexAreaInfoMapping(10, ListCount = 3)]
        public List<CodiceArca1> LISTCodiceArca1 { get; set; }

        [HisComplexAreaInfoMapping(11, ListCount = 3)]
        public List<CodiceArca2> LISTCodiceArca2 { get; set; }

        [HisComplexAreaInfoMapping(12, ListCount = 3)]
        public List<CodiceResidenza> LISTCodiceResidenza { get; set; }

        [HisComplexAreaInfoMapping(13, ListCount = 3)]
        public List<DataInizioResidenza> LISTDataInizioResidenza { get; set; }

        [HisComplexAreaInfoMapping(14, ListCount = 3)]
        public List<DataFineResidenza> LISTDataFineResidenza { get; set; }

        [HisComplexAreaInfoMapping(15, ListCount = 3)]
        public List<Indirizzo> LISTIndirizzo { get; set; }

        [HisComplexAreaInfoMapping(16, ListCount = 3)]
        public List<Civico> LISTCivico { get; set; }

        [HisComplexAreaInfoMapping(17, ListCount = 3)]
        public List<Frazione> LISTFrazione { get; set; }

        [HisComplexAreaInfoMapping(18, ListCount = 3)]
        public List<ProvinciaEstera> LISTProvinciaEstera { get; set; }

        [HisComplexAreaInfoMapping(19, ListCount = 3)]
        public List<CodiceCatastale> LISTCodiceCatastale { get; set; }

        [HisComplexAreaInfoMapping(20, ListCount = 3)]
        public List<ComuneResidenza> LISTComuneResidenza { get; set; }

        [HisComplexAreaInfoMapping(21, ListCount = 3)]
        public List<ProvinciaResidenza> LISTProvinciaResidenza { get; set; }

        [HisComplexAreaInfoMapping(22, ListCount = 3)]
        public List<Cap> LISTCap { get; set; }

        [HisComplexAreaInfoMapping(23, ListCount = 3)]
        public List<Sigla> LISTSigla { get; set; }
