...
namespace INPS.Pensioni.LiquidazioneFs.Data.HostResponse.AreaStampa
{
    public class Decorrenze_FS
    {
        ...
        public List<Ago> LISTAgo { get; set; }

        [HisComplexAreaInfoMapping(1, ListCount = 32)]
        public List<AgoOld> LISTAgoOld { get; set; }

        [HisComplexAreaInfoMapping(2, ListCount = 32)]
        public List<Fondo> LISTFondo { get; set; }

        [HisComplexAreaInfoMapping(3, ListCount = 32)]
        public List<FondoOld> LISTFondoOld { get; set; }

        [HisComplexAreaInfoMapping(4, ListCount = 32)]
        public List<Quota> LISTQuota { get; set; }

        [HisComplexAreaInfoMapping(5, ListCount = 32)]
        public List<QuotaOld> LISTQuotaOld { get; set; }

        [HisComplexAreaInfoMapping(6, ListCount = 32)]
        public List<Diff> LISTDiff { get; set; }

        [HisComplexAreaInfoMapping(7, ListCount = 32)]
        public List<DiffOld> LISTDiffOld { get; set; }

        [HisComplexAreaInfoMapping(8, ListCount = 32)]
        public List<ScalaMobile> LISTScalaMobile { get; set; }

        [HisComplexAreaInfoMapping(9, ListCount = 32)]
        public List<ScalaMobileOld> LISTScalaMobileOld { get; set; }

        [HisComplexAreaInfoMapping(10, ListCount = 32)]
        public List<Eccedenza> LISTEccedenza { get; set; }

        [HisComplexAreaInfoMapping(11, ListCount = 32)]
        public List<EccedenzaOld> LISTEccedenzaOld { get; set; }

        [HisComplexAreaInfoMapping(12, ListCount = 32)]
        public List<ServizioMilitare> LISTServizioMilitare { get; set; }

        [HisComplexAreaInfoMapping(13, ListCount = 32)]
        public List<ServizioMilitareOld> LISTServizioMilitareOld { get; set; }
        ...
        public List<Articolo57Old> LISTArticolo57Old { get; set; }

        [HisComplexAreaInfoMapping(16, ListCount = 32)]
        public List<TrattenutaInail> LISTTrattenutaInail { get; set; }

        [HisComplexAreaInfoMapping(17, ListCount = 32)]
        public List<TrattenutaInailOld> LISTTrattenutaInailOld { get; set; }

        [HisComplexAreaInfoMapping(18, ListCount = 32)]
        public List<TrattenutaInail2> LISTTrattenutaInail2 { get; set; }

        [HisComplexAreaInfoMapping(19, ListCount = 32)]
        public List<TrattenutaInail2Old> LISTTrattenutaInail2Old { get; set; }
