...
namespace INPS.Pensioni.LiquidazioneFs.Data
{
    ...
    /// </summary>
    public class FSPR : BaseClass, ITransactionInfo
    {
        ...
        public FSPR(short sede, short sedeOperatore, short categoria, int certificato, string tipoOperazione, string lavorazione, string annoCompetenza)
        {
        ...
        public HostResponse.FSPRResponse Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<FSPR>(this);
                ...
                HostTransactionManager.AreaFromHost<FSPR>(this, output);
