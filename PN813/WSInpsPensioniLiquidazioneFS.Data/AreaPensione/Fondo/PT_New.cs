...
{
    public class PT_New : ITransactionInfo
    {
        #region Properties
        ...
        //GD0515        03 XFSPAL335 PIC 9(6)V9999.
        //GD0119* GG/MM SERVIZI ANNI UTILI(AGGIUNTI A XFSSUAN) CONUMI AI DUE
        //* FONDI FS E PT 
        //              03 XFSSUANMM PIC 9(2).      
        //              03 XFSSUANGG PIC 9(2).   
        //              03 XFSSETDIR PIC 9(4). 
        //              03 XFSSETMIS PIC 9(4).   
        //      ****CAMPI UTILIZZATI SOLO PER IL FONDO IPOST
        //GD0711* CAMPO PER RIPARTITA INPDAP IPOST
        //              03 XRIPINPDAP PIC 9(3)V9999.
        //GD0412* CAMPI PER LEGGE 4/60 IPOST
        //              03 XFSIMPC PIC S9(7)V9999.
        //              03 XFSPENS PIC 9(15) COMP-3.
        //              03 XFSMESIRIS PIC 9(3) COMP-3.
        //              03 XFSMESITOT PIC 9(3) COMP-3.  
        //GD0413        03 XFSONEREMEF PIC 9.
        //FSNEW      02 FILLER PIC X(08)
        ...
        public short XFSSUANMM { get; set; }

        /// <summary>
        /// XFSSUANGG 9(2).
        /// </summary>
        [HisFieldInfoMapping(51, 2, CobolType = CobolType.Unsigned)]
        public short XFSSUANGG { get; set; }

        /// <summary>
        /// XFSSETDIR 9(4).
        /// </summary>
        [HisFieldInfoMapping(52, 4, CobolType = CobolType.Unsigned)]
        public short XFSSETDIR { get; set; }

        /// <summary>
        /// XFSSETMIS 9(4).
        /// </summary>
        [HisFieldInfoMapping(53, 4, CobolType = CobolType.Unsigned)]
        public short XFSSETMIS { get; set; }
        
        /// <summary>
        /// XRIPINPDAP 9(3)V9999.
        /// </summary>
        [HisFieldInfoMapping(54, 7, Scale = 4, CobolType = CobolType.Unsigned)]
        public decimal XRIPINPDAP { get; set; }

        /// <summary>
        /// XFSIMPC S9(7)V9999.
        /// <summary>
        [HisFieldInfoMapping(55, 11, Scale = 4)]
        public decimal XFSIMPC { get; set; }

        /// <summary>
        //XFSPENS 9(15) COMP-3.
        /// <summary>
        [HisFieldInfoMapping(56, 8, CobolType = CobolType.Comp3Unsigned)]
        public long XFSPENS { get; set; }

        /// <summary>
        //XFSMESIRIS 9(3) COMP-3.
        /// <summary>
        [HisFieldInfoMapping(57, 2, CobolType = CobolType.Comp3Unsigned)]
        public long XFSMESIRIS { get; set; }
        /// <summary>
        //XFSMESITOT 9(3) COMP-3.
        /// <summary>
        [HisFieldInfoMapping(58, 2, CobolType = CobolType.Comp3Unsigned)]
