...
namespace INPS.Pensioni.LiquidazioneFs.Data.CMSGTRA.Ago
{
    public class GDP : ITransactionInfo
    {
        ...
        //              03 YFSTIPCALC X  
        //              03 YFSPAL214-FS-EURO             9(7)V9999
        //              03 YFSPROGR PIC 99.
        //              03 YFSDATA-RIVALSA PIC 9(8).
        //              03 YFSCOMPARTO PIC X(2)
        //              03 YFSSETTORE PIC X(3)
        //              03 YFSRUOLO PIC X(4)
        //FSNEW         03 YFSDISPO PIC X(91).
