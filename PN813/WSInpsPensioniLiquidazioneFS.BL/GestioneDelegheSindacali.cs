...
using INPS.Pensioni.LiquidazioneFs.ServiceReferences.DelegheSindacali;
using System;
...
namespace INPS.Pensioni.LiquidazioneFs
{
    public class GestioneDelegheSindacali
    {
        ...
        public static void GetElencoSindacatiPerCategoria(string IdCategoria, out List<Liquidazione.BLCommon.Entity.Sindacato> elencoSindacati, out string errori)
        {
            ...
            foreach (ServiceReferences.DelegheSindacali.Sindacato sindacatoWS in risposta.sindacato.ToList())
            {
                ...
                sindacatoBL.Stato = (Liquidazione.BLCommon.Utility.StatoSindacato)sindacatoWS.sStato;
