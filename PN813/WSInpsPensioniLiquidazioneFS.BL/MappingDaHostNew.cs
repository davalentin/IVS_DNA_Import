...
namespace INPS.Pensioni.LiquidazioneFs
{
    public class MappingDaHostNew
    {
        ...
        public static void ValorizzaDatiPensione(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, Utility.TipoFondo? tipologiaFondo, out GestionePensione.DatiPensione datiPensione)
        {
            datiPensione = null;
        ...
        public static void ValorizzaDatiLavorazione(Data.FSPRNew AreaPrelievo, out GestioneLavorazione.DatiLavorazione datiLavorazione)
        {
        ...
        public static void ValorizzaDatiEliminazione(Data.FSPRNew AreaPrelievo, out GestionePensione.DatiEliminazione datiEliminazione)
        {
        ...
        public static void ValorizzaDatiSindacato(Data.FSPRNew AreaPrelievo, out GestionePensione.DatiSindacato datiSindacato)
        {
            datiSindacato = null;
            if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
            {
        ...
        public static void ValorizzaDatiDetrazioni(Data.FSPRNew AreaPrelievo, out GestioneDetrazioniImposta.DatiDetrazioni datiDetrazioni)
        {
            datiDetrazioni = null;
            if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
            {
        ...
        public static void ValorizzaDatiPagamento(Data.FSPRNew AreaPrelievo, out GestionePagamento.DatiPagamento datiPagamento)
        {
            datiPagamento = null;
            if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
            {
        ...
        public static void ValorizzaDatiFamiliare(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<Entity.DatiFamiliari> ListaFamiliari,
                ...
                foreach (Data.CMSGTRA.Familiare familiare in AreaPrelievo.FinalResponse.ListaFamiliare)
                {
                    ...
                    if (familiare.LISTTRCCONTI != null && familiare.LISTTRCCONTI.Count > 0)
                    {
                        for (int i = 0; i < familiare.LISTTRCCONTI.Count; i++)
                        {
                            ...
                            if ((siglaCategoria.Trim().ToUpper().Equals("SFS") || siglaCategoria.Trim().ToUpper().Equals("SPT")) && tipoDomanda == GestionePrelievo.TipoDomanda.Ricostituzione)
                            {
                                codMagg.QuotaAF = familiare.LISTTRCCONTI[i].TRCQUOTA != null ? familiare.LISTTRCCONTI[i].TRCQUOTA : null;
                                codMagg.ContitolaritaFondo = familiare.LISTTRCCONTI[i].TRCCNFON != null ? familiare.LISTTRCCONTI[i].TRCCNFON : null;
                            }
        ...
        public static void ValorizzaDatiDetrazioniContitolare(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda,
        ...
        public static void ValorizzaRecordFondo(Data.FSPRNew AreaPrelievo, out List<GestioneRecordFondo.DatiRecordFondo> ListaRecordFondo)
        {
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPI != null && AreaPrelievo.FinalResponse.ListaFondoPI.Count > 0)
            {
                ...
                foreach (Data.CMSGTRA.Fondo.PI fondoPI in AreaPrelievo.FinalResponse.ListaFondoPI)
                {
                    ...
                    recordFondo.Id = fondoPI.XPIPROGR;
                    ListaRecordFondo.Add(recordFondo);
                }
            }
            else if (AreaPrelievo.FinalResponse.ListaFondoGAS != null && AreaPrelievo.FinalResponse.ListaFondoGAS.Count > 0)
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPM != null && AreaPrelievo.FinalResponse.ListaFondoPM.Count > 0)
            {
                ...
                foreach (Data.CMSGTRA.Fondo.PM fondoPM in AreaPrelievo.FinalResponse.ListaFondoPM)
                {
                    ...
                    recordFondo.Id = fondoPM.XPMPROGR;
                    ListaRecordFondo.Add(recordFondo);
                }
            }
            else if (AreaPrelievo.FinalResponse.ListaFondoGDP != null && AreaPrelievo.FinalResponse.ListaFondoGDP.Count > 0)
        ...
        public static void ValorizzaPensioneFondoDatiGenerici(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondo datiPensioneFondoDatiGenerici)
        {
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPI != null && AreaPrelievo.FinalResponse.ListaFondoPI.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(fondoPI.XPISPECI))
                {
                    ...
                    if (elencoCodiceSpecifico != null && elencoCodiceSpecifico.Count > 0)
                    {
                        //GestioneDecodifica.CodiceSpecifico codiceSpecifico = enteFondo != null ?
                        //    elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI" && x.EnteFondo == enteFondo)
                        //    : elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI");

                        GestioneDecodifica.CodiceSpecifico codiceSpecifico = enteFondo != null
                            ? (elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI" && x.EnteFondo == enteFondo) != null
                                ? elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI" && x.EnteFondo == enteFondo)
                                : elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI" && x.EnteFondo == null))
                            : elencoCodiceSpecifico.Find(x => x.TraduzioneGp == Utility.StringToNullableChar(fondoPI.XPISPECI) && x.Fondo == "PI" && x.EnteFondo == null);
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPM != null && AreaPrelievo.FinalResponse.ListaFondoPM.Count > 0)
            {
                ...
                datiPensioneFondoDatiGenerici.CodiceDirittoQuoteFisse = Utility.StringToNullableByte(fondoPM.XPMFISSE.ToString());
            }
            else if (AreaPrelievo.FinalResponse.ListaFondoGDP != null && AreaPrelievo.FinalResponse.ListaFondoGDP.Count > 0)
            {
                Data.CMSGTRA.Fondo.GDP fondoGDP = AreaPrelievo.FinalResponse.ListaFondoGDP[0];
            ...
            if (!datiPensioneFondoDatiGenerici.BypassDinamicoCodiceSpecifico.Value && !datiPensioneFondoDatiGenerici.CodiceSpecifico.HasValue)
            {
                if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
                {
                    bool isCategoriaINPDAP = IsCategoriaINPDAP(AreaPrelievo);
        ...
        public static void ValorizzaPensioneFondoDatiEL(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoEL datiPensioneFondoDatiEL)
        {
        ...
        public static void ValorizzaPensioneFondoDatiTT(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoTT datiPensioneFondoDatiTT)
        {
        ...
        public static void ValorizzaPensioneFondoDatiET(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoET datiPensioneFondoDatiET)
        {
        ...
        public static void ValorizzaDatiINAIL(Data.FSPRNew AreaPrelievo, out List<GestionePensioneInailInabilita.DatiPensioniINAIL> listaInail)
        {
            listaInail = null;
        ...
        public static void ValorizzaPensioneFondoDatiVL(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoVL datiPensioneFondoDatiVL)
        {
        ...
        public static void ValorizzaPensioneFondoDatiPT(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, ref GestioneFondo.DatiFondo datiFondo,
                    ...
                    foreach (Data.CMSGTRA.Fondo.PT_New fondoPT in AreaPrelievo.FinalResponse.ListaFondoPT_New)
                    {
                        ...
                        if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
                        {
                                ...
                                !String.IsNullOrEmpty(tipoReversibilita) && tipoReversibilita.Trim().ToUpperInvariant() == "R")
                            {
                                ...
                                datiPensioneFondoDatiPT.XFSFAAGO = fondoPT.XFSFAAGO;
                            }
                        }

                        if (fondoPT.XFSIISL != 0M)
                            datiPensioneFondoDatiPT.IndennitaIntegrativaSpecialeLorda = fondoPT.XFSIISL;
        ...
        public static void ValorizzaPensioneFondoDatiFS(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, ref GestioneFondo.DatiFondo datiFondo,
                    ...
                    foreach (Data.CMSGTRA.Fondo.FS_New fondoFS in AreaPrelievo.FinalResponse.ListaFondoFS_New)
                    {
                        ...
                        if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
                        {
                                 ...
                                 !String.IsNullOrEmpty(tipoReversibilita) && tipoReversibilita.Trim().ToUpperInvariant() == "R")
                            {
                                ...
                                //ENG - RIC/TRF REVERSIBILITA 024
                                datiPensioneFondoDatiFS.XFSFAAGO = fondoFS.XFSFAAGO;
                            }
                        }

                        if (fondoFS.XFSIISL != 0M)
                            datiPensioneFondoDatiFS.IndennitaIntegrativaSpecialeLorda = fondoFS.XFSIISL;
        ...
        public static void ValorizzaPensioneFondoDatiPI(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<GestioneFondo.DatiFondoPI> listaDatiPensioneFondoPI, out List<GestioneFondo.DatiAgoPI> lstDatiAgoPI, out List<GestioneFondo.DatiAgoTeoricoPI> lstDatiAgoTeoricoPI)
        {
            listaDatiPensioneFondoPI = null;
            lstDatiAgoPI = null;
            lstDatiAgoTeoricoPI = null;
            #region ListaFondoPI
            if (AreaPrelievo.FinalResponse.ListaFondoPI != null && AreaPrelievo.FinalResponse.ListaFondoPI.Count > 0)
            {
                #region DatiPensioneFondoPI
                listaDatiPensioneFondoPI = new List<GestioneFondo.DatiFondoPI>();
                string siglaCategoria = AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0 ? GetCategoriaFromTRACATEG(AreaPrelievo.FinalResponse.ListaAnagrafica[0].TRACATEG) : string.Empty;

                Utility.CategoriaFondoPI? categoriaFondoPI = Utility.GetCategoriaFondoPI(Utility.TipoAppartenenza.FS, siglaCategoria);

                foreach (Data.CMSGTRA.Fondo.PI fondoPI in AreaPrelievo.FinalResponse.ListaFondoPI)
                {
                    GestioneFondo.DatiFondoPI datiPensioneFondoDatiPI = new GestioneFondo.DatiFondoPI();
                    ...
                    try
                    {
                        if (categoriaFondoPI.HasValue && categoriaFondoPI.Value == Utility.CategoriaFondoPI.U)
                        {
                            ...
                            if (fondoPI.XPIDP346 != 0M)
                            {
                                ...
                                datiPensioneFondoDatiPI.Sede = short.Parse(xpidp346.Substring(9, 2));

                                datiPensioneFondoDatiPI.CodiceCategoria = xpidp346.Split('.', ',')[0][xpidp346.Split('.', ',')[0].Length - 1] + xpidp346.Split('.', ',')[1].PadRight(2, '0').Substring(0, 2);
                            }

                            // 3 byte CodiceCategoria
                            // 4 byte Sede (prime 2 XPISANIT da aggiungere alla parte già messa)
                            // 3 byte Certificato
                            if (fondoPI.XPISANIT != 0M)
                            {
                                string xpisanit = string.Format("{0:000000.0000}", fondoPI.XPISANIT);

                                datiPensioneFondoDatiPI.Sede = (short?)((datiPensioneFondoDatiPI.Sede * 100) + short.Parse(xpisanit.Substring(0, 2)));
                                var i = (int.Parse(xpisanit.Substring(0, 6)) * 1000);
                                var x = xpisanit.Substring(0, 6);

                                datiPensioneFondoDatiPI.Certificato = (int.Parse(xpisanit.Substring(0, 6)) * 10000) + int.Parse(xpisanit.Substring(7, 4));
                            }
                        }
                        else
                        {
                            datiPensioneFondoDatiPI.NumeroMatricola = ((int)(fondoPI.XPIONLEG * 100)).ToString();
                            datiPensioneFondoDatiPI.AssPers = fondoPI.XPISANIT;
                        }
                    }
                    catch (Exception)
                    {
                    ...
                    //if (categoriaFondoPI.HasValue && categoriaFondoPI.Value != Utility.CategoriaFondoPI.U && categoriaFondoPI.Value != Utility.CategoriaFondoPI.A)
                    ...
                    //Qui valorizzo eventualmente entrambi, più avanti faccio altra logica per decidere quale valore ha senso
                    datiPensioneFondoDatiPI.DecorrenzaPrescrizione = Utility.DataFromInt(fondoPI.XPICAPDE, fondoPI.XPICAPIN, 1);
                    datiPensioneFondoDatiPI.PercentualeCapitalizzazione = Utility.StringToNullableDecimal(fondoPI.XPICAPIN + "," + fondoPI.XPICAPDE);
                    ...
                    {
                        datiPensioneFondoDatiPI.Ass7_62 = fondoPI.XPIAS762;
                    }
                    ...
                    datiPensioneFondoDatiPI.TipoRegolamento = fondoPI.XPITIPRG;
                    datiPensioneFondoDatiPI.IncrementoDPR346 = fondoPI.XPIDP346;
                    datiPensioneFondoDatiPI.IdRecordFondo = fondoPI.XPIPROGR;

                    datiPensioneFondoDatiPI.Scatti = fondoPI.XPISCATT;
                    datiPensioneFondoDatiPI.SedeServ = fondoPI.XPIULTSE;
                    datiPensioneFondoDatiPI.Fisse = fondoPI.XPIFISSE;

                    listaDatiPensioneFondoPI.Add(datiPensioneFondoDatiPI);
                }
                #endregion

                if (AreaPrelievo.FinalResponse.ListaAgoPI != null && AreaPrelievo.FinalResponse.ListaAgoPI.Count > 0)
                {
                    lstDatiAgoPI = new List<GestioneFondo.DatiAgoPI>();
                    foreach (Data.CMSGTRA.Ago.PI agoPI in AreaPrelievo.FinalResponse.ListaAgoPI)
                    {
                        GestioneFondo.DatiAgoPI datiAgoPI = new GestioneFondo.DatiAgoPI();
                        if (agoPI.YPIDECAA > 0 && agoPI.YPIDECMM > 0)
                            datiAgoPI.DecorrenzaDatiAgo = new DateTime(agoPI.YPIDECAA, agoPI.YPIDECMM, 01);

                        datiAgoPI.CodiceSpecificoAgo = agoPI.YPISPECI;
                        datiAgoPI.TipoLiquidazione = agoPI.YPITPAGO;
                        if (agoPI.YPISOSAA > 0 && agoPI.YPISOSMM > 0)
                            datiAgoPI.SospensioneAgo = new DateTime(agoPI.YPISOSAA, agoPI.YPISOSMM, 01);
                        else
                            datiAgoPI.SospensioneAgo = null;

                        datiAgoPI.CodiceNatura = agoPI.YPIALTR1.ToString() + agoPI.YPIALTR2.ToString() + agoPI.YPIALTR3.ToString();
                        datiAgoPI.SettimaneVV = agoPI.YPISETVV;

                        datiAgoPI.RMSQuotaA = agoPI.YPIRTSET;
                        datiAgoPI.NSettimaneQuotaA = agoPI.YPISZTOT;
                        datiAgoPI.NSettimaneEsclusiveQuotaA = agoPI.YPISZESC;

                        datiAgoPI.RMSQuotaB = agoPI.YPIRSETB;
                        datiAgoPI.NSettimaneQuotaB = agoPI.YPISTOTB;
                        datiAgoPI.NSettimaneEsclusiveQuotaB = agoPI.YPINESCB;

                        datiAgoPI.Montante = agoPI.YPICTRTT;

                        datiAgoPI.CausaCarico = agoPI.YPICARIC;
                        datiAgoPI.RMSQuotaAOmogenea = agoPI.YPISZRET;
                        datiAgoPI.RMSQuotaBOmogenea = agoPI.YPISRETB;

                        datiAgoPI.Ctres = agoPI.YPICTRES;
                        datiAgoPI.DirittoQuoteFisse = agoPI.YPIQUOFI;
                        datiAgoPI.NSettimaneExCombattente = agoPI.YPINZTOT;
                        datiAgoPI.RMSRetributiva = agoPI.YPIS72RT;
                        lstDatiAgoPI.Add(datiAgoPI);
                    }
                }

                if (AreaPrelievo.FinalResponse.ListaAgoTeorico != null && AreaPrelievo.FinalResponse.ListaAgoTeorico.Count > 0)
                {
                    lstDatiAgoTeoricoPI = new List<GestioneFondo.DatiAgoTeoricoPI>();
                    foreach (Data.CMSGTRA.AgoTeorico agoTeorico in AreaPrelievo.FinalResponse.ListaAgoTeorico)
                    {
                        GestioneFondo.DatiAgoTeoricoPI datiAgoTeoricoPI = new GestioneFondo.DatiAgoTeoricoPI();

                        if (agoTeorico.TRNDECAA > 0 && agoTeorico.TRNDECMM > 0)
                            datiAgoTeoricoPI.DecorrenzaDatiAgoTeorico = new DateTime(agoTeorico.TRNDECAA, agoTeorico.TRNDECMM, 1);
                        else
                            datiAgoTeoricoPI.DecorrenzaDatiAgoTeorico = null;

                        datiAgoTeoricoPI.TipoLiquidazione = agoTeorico.TRNTIPLQ;

                        if (agoTeorico.TRNSOSAA > 0 && agoTeorico.TRNSOSMM > 0)
                            datiAgoTeoricoPI.SospensioneAGOTeorica = new DateTime(agoTeorico.TRNSOSAA, agoTeorico.TRNSOSMM, 1);
                        else
                            datiAgoTeoricoPI.SospensioneAGOTeorica = null;

                        datiAgoTeoricoPI.RMSQuotaA = agoTeorico.TRNRSETA;
                        datiAgoTeoricoPI.RMSQuotaB = agoTeorico.TRNRSETB;

                        datiAgoTeoricoPI.NSettimaneEsclusiveQuotaA = agoTeorico.TRNSESCA;
                        datiAgoTeoricoPI.NSettimaneEsclusiveQuotaB = agoTeorico.TRNSESCB;

                        datiAgoTeoricoPI.NSettimaneTotaliQuotaA = agoTeorico.TRNSTOTA;
                        datiAgoTeoricoPI.NSettimaneTotaliQuotaB = agoTeorico.TRNSTOTB;

                        datiAgoTeoricoPI.RMSOmogeneaQuotaA = agoTeorico.TRNTEORA;
                        datiAgoTeoricoPI.RMSOmogeneaQuotaB = agoTeorico.TRNTEORB;

                        lstDatiAgoTeoricoPI.Add(datiAgoTeoricoPI);
                    }
        ...
        public static void ValorizzaPensioneFondoDatiGAS(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoGAS datiPensioneFondoDatiGAS)
        {
        ...
        public static void ValorizzaPensioneFondoDatiES(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestioneFondo.DatiFondoES datiPensioneFondoDatiES)
        {
        ...
        public static void ValorizzaPensioneFondoDatiCL(Data.FSPRNew AreaPrelievo, out GestioneFondo.DatiFondoCL datiPensioneFondoDatiCL)
        {
        ...
        public static void ValorizzaPensioneFondoDatiDZ(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<GestioneFondo.DatiFondoDZ> listaDatiPensioneFondoDatiDZ)
        {
        ...
        public static void ValorizzaPensioneFondoDatiPM(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<GestioneFondo.DatiFondoPM> listaDatiFondoPM, out List<GestioneFondo.DatiAgoPM> lstDatiAgoPM)
        {
            ...
            if (AreaPrelievo.FinalResponse.ListaFondoPM != null && AreaPrelievo.FinalResponse.ListaFondoPM.Count > 0)
            {
                listaDatiFondoPM = new List<GestioneFondo.DatiFondoPM>();

                foreach (var pm in AreaPrelievo.FinalResponse.ListaFondoPM)
                {
                    GestioneFondo.DatiFondoPM datiPensioneFondoPM = new GestioneFondo.DatiFondoPM();
                    datiPensioneFondoPM.IdRecordFondo = pm.XPMPROGR;

                    if (!string.IsNullOrEmpty(pm.XPMCONVI))
                        datiPensioneFondoPM.ConvenzioneInternazionale = pm.XPMCONVI[0]; // string -> char?

                    if (!string.IsNullOrEmpty(pm.XPMATTIV) && pm.XPMATTIV.Length == 2)
                        datiPensioneFondoPM.AttivitaSvolta2 = char.Parse(pm.XPMATTIV.Substring(1, 1));

                    datiPensioneFondoPM.MesiNavigazioneEffettiva = pm.XPMEFFMM;
                    datiPensioneFondoPM.GiorniNavigazioneEffettiva = pm.XPMEFFGG;

                    datiPensioneFondoPM.MesiRadePilotaggio = pm.XPMRAPMM;
                    datiPensioneFondoPM.GiorniRadePilotaggio = pm.XPMRAPGG;

                    datiPensioneFondoPM.MesiTBCDS = pm.XPMTBCMM;
                    datiPensioneFondoPM.GiorniTBCDS = pm.XPMTBCGG;

                    datiPensioneFondoPM.MesiMalattia = pm.XPMMALMM;
                    datiPensioneFondoPM.GiorniMalattia = pm.XPMMALGG;

                    datiPensioneFondoPM.MesiNavigazioneEE = pm.XPMESTMM;
                    datiPensioneFondoPM.GiorniNavigazioneEE = pm.XPMESTGG;

                    datiPensioneFondoPM.MesiAltriServizi = pm.XPMALTMM;
                    datiPensioneFondoPM.GiorniAltriServizi = pm.XPMALTGG;

                    datiPensioneFondoPM.MesiNavigazioneMilitare = pm.XPMMILMM;
                    datiPensioneFondoPM.GiorniNavigazioneMilitare = pm.XPMMILGG;

                    datiPensioneFondoPM.MesiDoppioMilitare = pm.XPMMILDM;
                    datiPensioneFondoPM.GiorniDoppioMilitare = pm.XPMMILDG;

                    datiPensioneFondoPM.MesiDoppioMercantile = pm.XPMMERMM;
                    datiPensioneFondoPM.GiorniDoppioMercantile = pm.XPMMERGG;

                    datiPensioneFondoPM.MesiServizioMilitareATerra = pm.XPMTERMM;
                    datiPensioneFondoPM.GiorniServizioMilitareATerra = pm.XPMTERGG;

                    datiPensioneFondoPM.TelegrafistaServizioMacchinaAA = pm.XPMMACAA;
                    datiPensioneFondoPM.TelegrafistaServizioMacchinaMM = pm.XPMMACMM;

                    datiPensioneFondoPM.CodiceDifferimentoPrivilegiato = (byte?)pm.XPMCODIF; // short -> byte?

                    datiPensioneFondoPM.PeriodoDifferimento1 = pm.XPMDIFAA;
                    datiPensioneFondoPM.PeriodoDifferimento2 = pm.XPMDIFMM;

                    datiPensioneFondoPM.GestioneSpeciale1Supplemento = pm.XPMSUPP1.ToString(); // decimal -> string
                    datiPensioneFondoPM.GestioneSpeciale2Supplemento = pm.XPMSUPP2.ToString(); // decimal -> string

                    if (pm.XPMTILIQ != 0)
                        datiPensioneFondoPM.TipoLiquidazione = byte.Parse(pm.XPMTILIQ.ToString());

                    datiPensioneFondoPM.DirittoAgo = pm.XPMDIAGO == 1; // short -> bool? (1 = true)

                    datiPensioneFondoPM.AnnoUtileUltimoDecennio = pm.XPMANULT == 1; // short -> bool? (1 = true)

                    datiPensioneFondoPM.RMSDPCM161289 = pm.XPMDPCRT;
                    datiPensioneFondoPM.RMS7290 = pm.XPMS72RT;

                    //campi nuovi
                    datiPensioneFondoPM.CorresponsioneIP = pm.XPMCORIP;
                    datiPensioneFondoPM.MesiRiparametrazione = pm.XPMRIPMM;
                    datiPensioneFondoPM.AnniRiparametrazione = pm.XPMRIPAA;
                    datiPensioneFondoPM.CodiceEsclusione = pm.XPMESCLU;
                    datiPensioneFondoPM.Stato = pm.XPMSTATO;
                    datiPensioneFondoPM.Rendimento = pm.XPMRENDI;
                    datiPensioneFondoPM.CodiceDPCDC = pm.XPMDPCDC;
                    ...
                    if (AreaPrelievo.FinalResponse.ListaAnagrafica != null && AreaPrelievo.FinalResponse.ListaAnagrafica.Count > 0)
                    {
                        ...
                        if (tipoDomanda != GestionePrelievo.TipoDomanda.Reversibilità)
                        {
                            ...
                            {
                                if (datiPensioneFondoPM == null)
                                    datiPensioneFondoPM = new GestioneFondo.DatiFondoPM();

                                //datiPensioneFondoDatiPM.Requisiti247_243 = anagrafica.TRACODSI == "S" ? true : anagrafica.TRACODSI == "N" ? false : (bool?)null;
                                datiPensioneFondoPM.AnzianitaAnni = Utility.StringToNullableInt(anagrafica.TRAANZ247);
                                if (anagrafica.TRARECUP != 0)
                                {
                                    datiPensioneFondoPM.AnnoRequisiti = Utility.StringToNullableShort(anagrafica.TRARECUP.ToString().PadLeft(5, '0').Substring(0, 4));
                                    datiPensioneFondoPM.NumeroTriSemRequisiti = Utility.StringToNullableByte(anagrafica.TRARECUP.ToString().PadLeft(5, '0').Substring(4, 1));
                                }
                            }
                        }
                    }
                    ...
                    listaDatiFondoPM.Add(datiPensioneFondoPM);
                }
            }
            ...
            {
                lstDatiAgoPM = new List<GestioneFondo.DatiAgoPM>();
                foreach (var datiAgo in AreaPrelievo.FinalResponse.ListaAgoPM)
                {
                    GestioneFondo.DatiAgoPM datiAgoPM = new GestioneFondo.DatiAgoPM();

                    datiAgoPM.TipoLiquidazione = datiAgo.YPMTIPLQ;
                    datiAgoPM.DecorrenzaContributiva = (datiAgo.YPMDECAA != 0 && datiAgo.YPMDECMM != 0)
                        ? new DateTime(datiAgo.YPMDECAA, datiAgo.YPMDECMM, 1) : (DateTime?)null;
                    datiAgoPM.SospensionePensione = (datiAgo.YPMSCAAA != 0 && datiAgo.YPMSCAMM != 0)
                        ? new DateTime(datiAgo.YPMSCAAA, datiAgo.YPMSCAMM, 1) : (DateTime?)null;
                    datiAgoPM.DecorrenzaReversibileAgo = (datiAgo.YPMTEOAA != 0 && datiAgo.YPMTEOMM != 0)
                        ? new DateTime(datiAgo.YPMTEOAA, datiAgo.YPMTEOMM, 1) : (DateTime?)null;
                    datiAgoPM.RMSQuotaA = datiAgo.YPMRETPN;
                    datiAgoPM.NSettimaneQuotaA = datiAgo.YPMANZTO;
                    datiAgoPM.NsettimaneEsclusiveQuotaA = datiAgo.YPMANZES;
                    datiAgoPM.NSettimaneAnzianitaVV = datiAgo.YPMSETVV;
                    datiAgoPM.ImportoContrLegge3351995 = datiAgo.YPMCTRTO;
                    datiAgoPM.ImportoContrLegge3771958art24 = datiAgo.YPMCTRES;
                    datiAgoPM.ImportoContrSupLegge14321971art14 = datiAgo.YPMC14TO;
                    datiAgoPM.BaseAltraPensione = datiAgo.YPMC14ES;
                    datiAgoPM.ImportoDPR4881968art11 = datiAgo.YPMC11TO;
                    datiAgoPM.ImportoContEsclusiviSupDPR4881968art11 = datiAgo.YPMC11ES;
                    datiAgoPM.YPMANNIR = datiAgo.YPMANNIR.ToString();
                    datiAgoPM.DecDPCM16121989art2 = (datiAgo.YPMCDCAA != 0 && datiAgo.YPMCDCMM != 0)
                        ? new DateTime(datiAgo.YPMCDCAA, datiAgo.YPMCDCMM, 1) : (DateTime?)null;
                    datiAgoPM.RMSDPCM = datiAgo.YPMDPCRT;
                    datiAgoPM.EtaMaturazioneRequisiti = datiAgo.YPMETAMA;
                    datiAgoPM.CodiceSpecificoLiquidazioneAgo = datiAgo.YPMSPECI;
                    datiAgoPM.RMSQuotaB = datiAgo.YPMRETP1;
                    datiAgoPM.NSettimaneQuotaB = datiAgo.YPMANZT1;
                    datiAgoPM.NSettimaneEsclusiveQuotaB = datiAgo.YPMANZE1;
                    datiAgoPM.YPM503ET = datiAgo.YPM503ET;
                    datiAgoPM.YPM503AS = datiAgo.YPM503AS.ToString();
                    datiAgoPM.YPMTPCOD = datiAgo.YPMTPCOD;
                    datiAgoPM.YPMDECSS = datiAgo.YPMDECSS.ToString();
                    datiAgoPM.YPMSOSSS = datiAgo.YPMSOSSS.ToString();
                    datiAgoPM.YPMAUTON = datiAgo.YPMAUTON;
                    datiAgoPM.MontanteLegge3351995 = datiAgo.YPMMONTA;
                    datiAgoPM.NSettimaneContributive = (int?)datiAgo.YPMESCLU;
                    datiAgoPM.ImportoContrQuotaD = datiAgo.YPMIMPCRT;
                    datiAgoPM.MontanteQuotaD = datiAgo.YPMMONTA2012;
                    datiAgoPM.NSettimaneContributiveQuotaD = datiAgo.YPMSETT2012;
                    datiAgoPM.NSettimane707A = datiAgo.YPMSETA_707;
                    datiAgoPM.NSettimane707B = datiAgo.YPMSETB_707;
                    datiAgoPM.YPMCALC707 = datiAgo.YPMCALC707;
                    datiAgoPM.YPMPROGR = datiAgo.YPMPROGR.ToString();

                    lstDatiAgoPM.Add(datiAgoPM);
                }
        ...
        public static void ValorizzaDatiCalcoloContributivo(Data.FSPRNew AreaPrelievo, GestionePensione.DatiPensione datiPensione, out List<GestioneCalcolo.DatiCalcoloContributivo> listaDatiCalcoloContributivo)
        {
        ...
        public static void ValorizzaDatiCalcoloRetributivoDZ(Data.FSPRNew AreaPrelievo, out List<GestioneCalcolo.DatiCalcoloRetributivo> listaDatiCalcoloRetributivo)
        {
        ...
        public static void ValorizzaDatiCalcoloRetributivo(Data.FSPRNew AreaPrelievo, out GestioneCalcolo.DatiCalcoloRetributivo datiCalcoloRetributivo)
        {
        ...
        public static void ValorizzaDatiSupplementi(Data.FSPRNew AreaPrelievo, Utility.TipoFondo? tipoFondo, GestionePrelievo.TipoDomanda tipoDomanda, string prodotto, string tipo, out List<INPS.Pensioni.Liquidazione.BLCommon.Entity.DatiSupplementi> ListaSupplementi)
        {
        ...
        public static void ValorizzaDatiMaggiorazioni(Data.FSPRNew AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, GestionePrelievo.TipoDomanda tipoDomanda, Utility.TipoFondo? fondo, string prodotto, string tipo,
            out INPS.Pensioni.Liquidazione.BLCommon.GestioneMaggiorazioniBenefici.DatiMaggiorazioniBenefici datiMaggiorazioniBenefici)
        {
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPI != null && AreaPrelievo.FinalResponse.ListaFondoPI.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(fondoPI.XPIEXCBT) && fondoPI.XPIEXCBT.Trim() != string.Empty)
                {
                    List<GestioneDecodifica.CodiceMaggiorazioneExCombattenti> listaCodiciMaggExComb = null;
                    GestioneDecodifica.GetCodiciMaggiorazioneExCombattenti(out listaCodiciMaggExComb);
                    GestioneDecodifica.CodiceMaggiorazioneExCombattenti codiceExComb = listaCodiciMaggExComb.Find(x => x.TraduzioneSuGP == fondoPI.XPIEXCBT);
                    if (codiceExComb != null)
                        datiMaggiorazioniBenefici.ExCombattente = codiceExComb.Id;
                }
        ...
        public static void ValorizzaDatiPatronato(Data.FSPRNew AreaPrelievo, out GestionePensione.DatiPatronato datiPatronato)
        {
            datiPatronato = null;
            if (AreaPrelievo.FinalResponse.ListaDelegato != null && AreaPrelievo.FinalResponse.ListaDelegato.Count > 0)
            {
        ...
        public static void ValorizzaDatiDanteCausa(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, Utility.TipoFondo? tipoFondo, out DatiAnagDanteCausa datiAnagDanteCausa, out GestioneDanteCausa.DatiDanteCausa datiDanteCausa)
        {
        ...
        public static void ValorizzaDatiResidenzeEstere(Data.FSPRNew AreaPrelievo, out List<GestioneAnagrafica.DatiResidenzaEstero> ListaResidenzeEstere)
        {
        ...
        public static void ValorizzaDatiStatiCivili(Data.FSPRNew AreaPrelievo, out List<GestioneAnagrafica.DatiStatoCivile> ListaStatiCivili)
        {
        ...
        public static void ValorizzaDatiDelegato(Data.FSPRNew AreaPrelievo, out DatiDelegato datiDelegato)
        {
            datiDelegato = null;
        ...
        public static void ValorizzaDatiTutore(Data.FSPRNew AreaPrelievo, out DatiTutore datiTutore)
        {
            datiTutore = null;
            if (AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse != null && AreaPrelievo.FinalResponse.ListaDelegheTutele != null)
            {
        ...
        public static void ValorizzaDatiIstruttoria(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, ref GestionePensione.DatiPensione datiPensione, string gruppo, Utility.TipoFondo? tipoFondo, out GestioneIstruttoria.DatiIstruttoria datiIstruttoria)
        {
        ...
        public static void ValorizzaDatiDL407(Data.FSPRNew AreaPrelievo, DateTime? decorrenzaOriginaria, ref GestioneFondo.DatiFondo datiFondo, ref GestioneDanteCausa.DatiDanteCausa datiDanteCausa, out GestioneDL407.DatiDL407 datiDL407)
        {
            datiDL407 = null;
        ...
        public static void ValorizzaDatiOneriTerrorismo(Data.FSPRNew AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, out List<Entity.DatiBenefici.OneriTerrorismo> listaOneriTerrorismo)
        {
        ...
        public static void ValorizzaDatiOneri(Data.FSPRNew AreaPrelievo, out List<GestioneOneri.DatiOneri> ListaDatiOneri)
        {
            ListaDatiOneri = null;
            if (AreaPrelievo.FinalResponse.ListaResidenza != null && AreaPrelievo.FinalResponse.ListaResidenza.Count > 0)
            {
        ...
        public static void ValorizzaDatiBeneficiParticolari(Data.FSPRNew AreaPrelievo, out List<GestioneBeneficiParticolari.DatiBeneficiParticolari> ListaDatiBeneficiParticolari)
        {
        ...
        public static void ValorizzaDatiServizioUtile(Data.FSPRNew AreaPrelievo, out List<GestioneDatiServizioUtile.ServizioUtile> listaDatiServizioUtile)
        {
            ...
            else if (AreaPrelievo.FinalResponse.ListaFondoPM != null && AreaPrelievo.FinalResponse.ListaFondoPM.Count > 0)
            {
                ...
                GestioneDatiServizioUtile.ServizioUtile datiServizioUtile = null;
                if (fondoPM.XPMSERVA != 0 || fondoPM.XPMSERVM != 0)
                {
                    datiServizioUtile = new GestioneDatiServizioUtile.ServizioUtile();
                    datiServizioUtile.ServizioUtileAA = fondoPM.XPMSERVA;
                    datiServizioUtile.ServizioUtileMM = fondoPM.XPMSERVM;
                    datiServizioUtile.RetribuzionePensionabile = fondoPM.XPMRETPN;
                    //necessario per il salvataggio dei DatiServizioUtile 
                    datiServizioUtile.IdRecordFondo = fondoPM.XPMPROGR;
                    listaDatiServizioUtile.Add(datiServizioUtile);
                }
        ...
        public static void ValorizzaDatiServizioUtile707(Data.FSPRNew AreaPrelievo, out List<GestioneCalcolo.ServizioUtile707> listaDatiServizioUtile707)
        {
        ...
        public static void ValorizzaDatiServizioUtileINPDAP(Data.FSPRNew AreaPrelievo, out List<GestioneDatiServizioUtileINPDAP.ServizioUtile> listaDatiServizioUtileINPDAP)
        {
        ...
        public static void ValorizzaDatiServizioUtileINPDAP707(Data.FSPRNew AreaPrelievo, out List<GestioneCalcolo.ServizioUtileINPDAP707> listaDatiServizioUtileINPDAP707)
        {
        ...
        public static void ValorizzaDatiNonCalcolo(Data.FSPRNew AreaPrelievo, Dictionary<string, string> componentiFamiliari, out List<Entity.DatiNoCalcolo> listaDatiNoCalcolo)
        {
        ...
        public static void ValorizzaDatiPensioneINPDAP(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<GestionePensioneINPDAP.DatiPensioneINPDAP> listaDatiPensioneINPDAP)
        {
        ...
        public static void ValorizzaRecordDatiFondoINPDAP(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out List<GestioneRecordDatiFondoINPDAP.RecordDatiFondoINPDAP> listaRecordDatiFondoINPDAP)
        {
        ...
        public static void ValorizzaMinimo_PensInv(Data.FSPRNew AreaPrelievo, out GestionePensioneInailInabilita.DatiInabilita datiInabilita)
        {
            datiInabilita = null;
            if (AreaPrelievo.FinalResponse.ListaMinimo_PensInv != null && AreaPrelievo.FinalResponse.ListaMinimo_PensInv.Count > 0)
            {
                Data.CMSGTRA.Minimo_PensInv minimo_PensInv = new Data.CMSGTRA.Minimo_PensInv();
                minimo_PensInv = AreaPrelievo.FinalResponse.ListaMinimo_PensInv[0];

                if (minimo_PensInv != null)
                {
                    datiInabilita = new GestionePensioneInailInabilita.DatiInabilita();
                    datiInabilita.CessazioneDirittoIntegrazioneMinimo = Utility.DataFromInt(minimo_PensInv.TRGCEAA, minimo_PensInv.TRGCEMM, 1);
                    datiInabilita.DecorrenzaDirittoIntegrazioneMinimo = Utility.DataFromInt(minimo_PensInv.TRGDIAA, minimo_PensInv.TRGDIMM, 1);
                }
            }
        }
        ...
        private static bool IsCategoriaINPDAP(Data.FSPRNew AreaPrelievo)
        {
        ...
        public static void ValorizzaScadenzaRevisioneSanitaria(Data.FSPRNew AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, GestionePensione.DatiPensione datiPensione, string gruppo, string prodotto, Utility.TipoFondo? tipoFondo, GestioneFondo.DatiFondo datiPensioneFondoDatiGenerici, DateTime? dataDecorrenza, out DateTime? scadenzaRevisioneSanitaria)
        {
        ...
        public static void ValorizzaDatiQuoteMiglioramentiContrattuali(Data.FSPRNew AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, out List<GestioneMiglioramentiContrattuali.DatiQuoteMiglioramentiContrattuali> datiQuoteMiglioramentiContrattuali)
        {
            datiQuoteMiglioramentiContrattuali = null;
            if (AreaPrelievo.FinalResponse.ListaMiglioramentiContrattuali != null && AreaPrelievo.FinalResponse.ListaMiglioramentiContrattuali.Count > 0)
            {
                foreach (var lst in AreaPrelievo.FinalResponse.ListaMiglioramentiContrattuali)
                {
                    if (lst != null && lst.LISTWAUMENTICONTR.Count > 0)
                    {
                        datiQuoteMiglioramentiContrattuali = new List<GestioneMiglioramentiContrattuali.DatiQuoteMiglioramentiContrattuali>();
                        foreach (var quota in lst.LISTWAUMENTICONTR)
                        {
                            datiQuoteMiglioramentiContrattuali.Add(
                                   new GestioneMiglioramentiContrattuali.DatiQuoteMiglioramentiContrattuali
                                   {
                                       Codice = quota.WS_GP2BB05N,
                                       DataDecorrenza = quota.WS_GP2BB04DT.ToString(),
                                       Quota = quota.WS_GP2BB06E.ToString()
                                   });
                        }
                    }
                }
