...
{
    public class DatiAttivitaSvolta
    {
        public DatiAttivitaSvolta()
        {
        }

        internal DatiAttivitaSvolta(INPS.Pensioni.Liquidazione.BLCommon.GestioneDecodifica.AttivitaSvolta attivitaSvolta)
        {
