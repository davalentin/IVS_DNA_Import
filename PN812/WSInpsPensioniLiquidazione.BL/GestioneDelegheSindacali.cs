...
using INPS.Pensioni.Liquidazione.ServiceReferences.DelegheSindacali;
...
namespace INPS.Pensioni.Liquidazione
{
    public class GestioneDelegheSindacali
    {
        ...
        public static void GetElencoSindacatiPerCategoria(string IdCategoria, out List<BLCommon.Entity.Sindacato> elencoSindacati, out string errori)
        {
            errori = string.Empty;
            ...
            elencoSindacati = new List<BLCommon.Entity.Sindacato>();
            if (risposta != null && risposta.sindacato != null)
            {
                foreach (Sindacato sindacatoWS in risposta.sindacato.ToList())
                {
                    BLCommon.Entity.Sindacato sindacatoBL = new BLCommon.Entity.Sindacato();
        ...
        public static bool VerificaCompatibilita(string IdCategoria, int certificato, DateTime? decorrenzaPensione, string codiceSindacato, out string errori)
        {
            ...
            ServiceReferences.DelegheSindacali.ElencoSindacatiCompatibili risposta = null;
            ...
            {
                ServiceReferences.DelegheSindacali.SindacatoCompatibile s = risposta.SindacatiCompatibili.ToList().Find(x => x.CodiceSindacato == codiceSindacato);
                if (s != null)
        ...
        private static void GetElencoSindacatiPerCategoria(string categoria, out RispostaElencoSindacati risposta, out string errori)
        {
            ...
            using (new MethodExecutionTracer())
            {
                try
                {
                    ...
                    if (risposta != null && risposta.esito != null && risposta.esito.sCodiceEsito != "0")
                    {
        ...
        private static void DecodificaCodiceSindacato(string codice, out RispostaSindacato Sindacato, out string errori)
        {
            bool erroreTecnico = false;
            errori = string.Empty;
            Sindacato = null;
        ...
        private static void GetElencoSindacatiCompatibili(string categoria, int certificato, DateTime? decorrenzaPensione,
            out ElencoSindacatiCompatibili risposta, out string errori)
        {
            bool erroreTecnico = false;
            errori = string.Empty;
            risposta = null;
