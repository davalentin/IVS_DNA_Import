...
{
    public class GestioneAreaBancaFideiussioneESOPMI
    {
        public static void GetDecodificaBancaFideiussione(out List<GestioneBancheFideiussioneESOPMI.DecBancaFideiussione> elencoBancheFideiussione)
        {
            elencoBancheFideiussione = null;
            GestioneBancheFideiussioneESOPMI.GetDecodificaBancaFideiussione(out elencoBancheFideiussione);
        }

        public static void SalvaBancheFideiussione(GestioneBancheFideiussioneESOPMI.DecBancaFideiussione bancaFidToSave, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;
            if (!ControlliBancheFideiussione(bancaFidToSave, out messaggioVideo))
                return;
            else
                GestioneBancheFideiussioneESOPMI.SalvaBancaFideiussione(bancaFidToSave);
        }

        public static void DeleteBancheFideiussione(GestioneBancheFideiussioneESOPMI.DecBancaFideiussione bancaFidToDelete, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;

            GestioneBancheFideiussioneESOPMI.DeleteBancaFideiussione(bancaFidToDelete);
        }
        ...
        public static void SalvaAziendeScadAssegnoGGmmAAAA(GestioneAziendeScadenzaAssegnoGGmmAAAA.DecAziendeScadenzaAssegnoGGmmAAAA aziendaGGmmAAAAtoSave, out string messaggioVideo)
        {
            ...
            GestioneAziendeScadenzaAssegnoGGmmAAAA.SalvaAziendeScadenzaAssegnoGGmmAAAA(aziendaGGmmAAAAtoSave, "ESOPMI");
        }
        ...
        {
            messaggioVideo = string.Empty;
            GestioneAziendeScadenzaAssegnoGGmmAAAA.DeleteAziendeScadenzaAssegnoGGmmAAAA(aziendaGGmmAAAAtoDelete, "ESOPMI");
        }
        ...
        /// <param name="messaggioVideo"></param>
        /// <returns></returns>
        private static bool ControlliBancheFideiussione(GestioneBancheFideiussioneESOPMI.DecBancaFideiussione bancaFideiussione, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;
            ...
            List<GestioneBancheFideiussioneESOPMI.DecBancaFideiussione> elencoBancheFideiussioneDB = null;
            GestioneAreaBancaFideiussioneESOPMI.GetDecodificaBancaFideiussione(out elencoBancheFideiussioneDB);
            ...
            GestioneDecodificaAzienda.GetElencoAziendaBySiglaCategoria("ESOPMI", null, out elencoAziendeDB);
