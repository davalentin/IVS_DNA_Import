...
{
    public class GestioneAreaBancaFideiussioneESPA
    {
        public static void GetDecodificaBancaFideiussione(out List<GestioneBancheFideiussioneESPA.DecBancaFideiussione> elencoBancheFideiussione)
        {
            elencoBancheFideiussione = null;
            GestioneBancheFideiussioneESPA.GetDecodificaBancaFideiussione(out elencoBancheFideiussione);
        }

        public static void SalvaBancheFideiussione(GestioneBancheFideiussioneESPA.DecBancaFideiussione bancaFidToSave, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;
            if (!ControlliBancheFideiussione(bancaFidToSave, out messaggioVideo))
                return;
            else
                GestioneBancheFideiussioneESPA.SalvaBancaFideiussione(bancaFidToSave);
        }

        public static void DeleteBancheFideiussione(GestioneBancheFideiussioneESPA.DecBancaFideiussione bancaFidToDelete, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;

            GestioneBancheFideiussioneESPA.DeleteBancaFideiussione(bancaFidToDelete);
        }
        ...
        public static void SalvaAziendeScadAssegnoGGmmAAAA(GestioneAziendeScadenzaAssegnoGGmmAAAA.DecAziendeScadenzaAssegnoGGmmAAAA aziendaGGmmAAAAtoSave, out string messaggioVideo)
        {
            ...
            GestioneAziendeScadenzaAssegnoGGmmAAAA.SalvaAziendeScadenzaAssegnoGGmmAAAA(aziendaGGmmAAAAtoSave, "ESPA");
        }
        ...
        {
            messaggioVideo = string.Empty;
            GestioneAziendeScadenzaAssegnoGGmmAAAA.DeleteAziendeScadenzaAssegnoGGmmAAAA(aziendaGGmmAAAAtoDelete, "ESPA");
        }
        ...
        /// <param name="messaggioVideo"></param>
        /// <returns></returns>
        private static bool ControlliBancheFideiussione(GestioneBancheFideiussioneESPA.DecBancaFideiussione bancaFideiussione, out string messaggioVideo)
        {
            messaggioVideo = string.Empty;
            ...
            List<GestioneBancheFideiussioneESPA.DecBancaFideiussione> elencoBancheFideiussioneDB = null;
            GestioneAreaBancaFideiussioneESPA.GetDecodificaBancaFideiussione(out elencoBancheFideiussioneDB);
            ...
            GestioneDecodificaAzienda.GetElencoAziendaBySiglaCategoria("ESPA", null, out elencoAziendeDB);
