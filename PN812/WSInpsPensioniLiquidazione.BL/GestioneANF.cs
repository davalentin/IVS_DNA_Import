...
using INPS.Pensioni.Liquidazione.ServiceReferences.ANF;
using System;
            ...
            using (new MethodExecutionTracer())
            {
                ...
                finally
                {
                    if (!string.IsNullOrEmpty(errori) && erroreTecnico)
                    {
                        ...
                        errori = "Errore tecnico durante il recupero delle informazioni relative alla consultazione unificata ANF";
