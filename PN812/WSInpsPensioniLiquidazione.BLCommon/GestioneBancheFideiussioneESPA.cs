...
{
    public class GestioneBancheFideiussioneESPA
    {
        public static void GetDecodificaBancaFideiussione(out List<DecBancaFideiussione> elencoBancaFideiussione)
        {
            ...
            List<DecodificaBancaFideiussoriaESPA> elencoDecodificaBancaFideiussioneDB = null;
            DAGestioneBancheFideiussioneESPA.GetDecodificaBancaFideiussione(out elencoDecodificaBancaFideiussioneDB);
            if (elencoDecodificaBancaFideiussioneDB != null && elencoDecodificaBancaFideiussioneDB.Count > 0)
            {
                ...
                foreach (DecodificaBancaFideiussoriaESPA decodificaBancaFideiussioneDB in elencoDecodificaBancaFideiussioneDB)
                {
        ...
        public static void SalvaBancaFideiussione(DecBancaFideiussione decBancaFideiussione) /*oggetto del blcommon*/
        {
            ...
            {
                DecodificaBancaFideiussoriaESPA decodificaBancaFideiussoria = new DecodificaBancaFideiussoriaESPA(); /*oggetto del datacommon*/

                Utility.ValorizzaOggetti(decBancaFideiussione, decodificaBancaFideiussoria);
                DAGestioneBancheFideiussioneESPA.SalvaBancaFideiussoria(decodificaBancaFideiussoria);/*salva oggetto del blcommon nell'oggetto del datacommon*/
        ...
        public static void DeleteBancaFideiussione(DecBancaFideiussione decBancaFideiussione)/*oggetto del blcommon*/
        {
                           ...
                           new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted }))
            {
                ...
                Utility.ValorizzaOggetti(decBancaFideiussione, decodificaBancaFideiussoria);
                DAGestioneBancheFideiussioneESPA.DeleteBancaFideiussoria(decodificaBancaFideiussoria);/*salva oggetto del blcommon nell'oggetto del datacommon*/
                transactionScope.Complete();
            }
        }
