...
{
    public class GestioneAnagraficaAccordi
    {
        public static void GetDecAnagraficaAccordi(out List<DecodAnagraficaAccordi> elencoAnagraficaAccordi)
        {
            elencoAnagraficaAccordi = null;
            List<DecAnagraficaAccordi> elencoDecAnagraficaAccordiDB = null;
            DAGestioneAnagraficaAccordi.GetDecAnagraficaAccordi(out elencoDecAnagraficaAccordiDB);
            if (elencoDecAnagraficaAccordiDB != null && elencoDecAnagraficaAccordiDB.Count > 0)
            {
                elencoAnagraficaAccordi = new List<DecodAnagraficaAccordi>();
                foreach (DecAnagraficaAccordi decodificaAnagraficaAccordiDB in elencoDecAnagraficaAccordiDB)
                {
                    DecodAnagraficaAccordi anagraficaAccordi = new DecodAnagraficaAccordi();
        ...
        public static void SalvaAnagraficaAccordi(DecodAnagraficaAccordi decodAnagraficaAccordi) /*oggetto del blcommon*/
        {
            using (TransactionScope transactionScope = TransactionScopeFactory.Create(TransactionScopeOption.Required,
                new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted }))
            {
                DecAnagraficaAccordi decAnagraficaAccordi = new DecAnagraficaAccordi(); /*oggetto del datacommon*/

                Utility.ValorizzaOggetti(decodAnagraficaAccordi, decAnagraficaAccordi);
                DAGestioneAnagraficaAccordi.SalvaAnagraficaAccordi(decAnagraficaAccordi);/*salva oggetto del blcommon nell'oggetto del datacommon*/
                transactionScope.Complete();
            }
        }

        public static int DeleteAnagraficaAccordi(DecodAnagraficaAccordi decodAnagraficaAccordi)/*oggetto del blcommon*/
        {
            using (TransactionScope transactionScope = TransactionScopeFactory.Create(TransactionScopeOption.Required,
                new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted }))
            {
                ...
                Utility.ValorizzaOggetti(decodAnagraficaAccordi, decAnagraficaAccordi);
                int result = DAGestioneAnagraficaAccordi.DeleteAnagraficaAccordi(decAnagraficaAccordi);/*delete oggetto del blcommon dall'oggetto del datacommon*/
                transactionScope.Complete();
                return result;
            }
        }
        ...
        public static void UpdateCountLiquidate_AnagraficaAccordi(short? codiceAziendaEditoria) /*oggetto del blcommon*/
        {
            using (TransactionScope transactionScope = TransactionScopeFactory.Create(TransactionScopeOption.Required,
                new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted }))
            {
                DAGestioneAnagraficaAccordi.UpdateCountLiquidate_AnagraficaAccordi(codiceAziendaEditoria);
                transactionScope.Complete();
            }
        }

        #region nested class
        #region class DecodAnagraficaAccordi
        /// <summary>
        /// nested class del BLcommon "gemella" della tabella DB
        /// </summary>
        public class DecodAnagraficaAccordi
        {
            ...
            {
                DecodAnagraficaAccordi anagraficaAccordiDB = (DecodAnagraficaAccordi)obj;
                try
                {
        ...
        #endregion class DecodAnagraficaAccordi
