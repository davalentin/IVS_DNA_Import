...
{
    public class GestioneBancheFideiussione
    {
        public static void GetDecodificaBancaFideiussione(out List<DecBancaFideiussione> elencoBancaFideiussione)
        {
            ...
            List<DecodificaBancaFideiussoria> elencoDecodificaBancaFideiussioneDB = null;
            DAGestioneBancheFideiussione.GetDecodificaBancaFideiussione(out elencoDecodificaBancaFideiussioneDB);
            if (elencoDecodificaBancaFideiussioneDB != null && elencoDecodificaBancaFideiussioneDB.Count > 0)
            {
                ...
                foreach (DecodificaBancaFideiussoria decodificaBancaFideiussioneDB in elencoDecodificaBancaFideiussioneDB)
                {
        ...
        public static void SalvaBancaFideiussione(DecBancaFideiussione decBancaFideiussione) /*oggetto del blcommon*/
        {
            ...
            {
                DecodificaBancaFideiussoria decodificaBancaFideiussoria = new DecodificaBancaFideiussoria(); /*oggetto del datacommon*/

                Utility.ValorizzaOggetti(decBancaFideiussione, decodificaBancaFideiussoria);
                DAGestioneBancheFideiussione.SalvaBancaFideiussoria(decodificaBancaFideiussoria);/*salva oggetto del blcommon nell'oggetto del datacommon*/
        ...
        public static void DeleteBancaFideiussione(DecBancaFideiussione decBancaFideiussione)/*oggetto del blcommon*/
        {
                           ...
                           new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted }))
            {
                ...
                Utility.ValorizzaOggetti(decBancaFideiussione, decodificaBancaFideiussoria);
                DAGestioneBancheFideiussione.DeleteBancaFideiussoria(decodificaBancaFideiussoria);/*salva oggetto del blcommon nell'oggetto del datacommon*/
                transactionScope.Complete();
            }
        }
