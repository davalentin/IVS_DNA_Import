...
{
    /// <summary>
    /// Summary description for DBSComuniTest
    /// </summary>
    [TestClass]
    public class DBSComuniTest
    {
        public DBSComuniTest()
        {
        }
        ...
        [TestMethod]
        public void TestGetCodInpsComunePerCodiceCatastale()
        {
            int codInpsComune = 0;
            GestioneDBSComuni.GetCodInpsComuneByCodCatastale("H601", null, 0, false, out codInpsComune);
            Assert.IsTrue(codInpsComune == 0, "Controllo 1: Dati non congrui");

            codInpsComune = 0;
            GestioneDBSComuni.GetCodInpsComuneByCodCatastale("L414", null, 0, false, out codInpsComune);
            Assert.IsTrue(codInpsComune != 0, "Controllo 2: Dati non congrui");
        }
    }
}
