...
namespace INPS.Pensioni.Liquidazione.UnitTest
{
    ...
    public class ArcaManTest
    {
        ...
        [TestMethod]
        public void TestArcaMan()
        {
            string errori = string.Empty;
            int codiceSoggetto = 0;
            string numeroDomanda = string.Empty;
            GestioneArcaMan.GetCodiceSoggettoByArcaMan("CZZPQL83R02C495X", numeroDomanda, out codiceSoggetto, out errori);
        }
    }
}
