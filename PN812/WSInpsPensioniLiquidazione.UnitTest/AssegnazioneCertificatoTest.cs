...
{
    /// <summary>
    /// Summary description for AssegnazioneCertificatoTest
    /// </summary>
    [TestClass]
    public class AssegnazioneCertificatoTest
    {
        public AssegnazioneCertificatoTest()
        {
        }
        ...
        [TestMethod]
        public void TestAssegnazioneCertificato()
        {
            short sede = 4955;
            string siglaCat = "VO";
            string errori = string.Empty;
            int certificato = 0;
            long numeroDomanda = 2222222222222;
            GestioneAssegnazioneCertificato.RichiestaCertificato rich = new GestioneAssegnazioneCertificato.RichiestaCertificato();
            rich.CodiceSede = sede;
            rich.SiglaCategoria = siglaCat;
            GestioneAssegnazioneCertificato.GetCertificato(numeroDomanda, rich, out certificato, out errori);
        }
    }
}
