...
{
    /// <summary>
    /// Summary description for VittimeTerrorismoTest
    /// </summary>
    [TestClass]
    public class VittimeTerrorismoTest
    {
        public VittimeTerrorismoTest()
        {
            //
        ...
        {
            BLCommon.GestioneVittimeTerrorismo.DatiVittimeTerrorismo oggettoA = new BLCommon.GestioneVittimeTerrorismo.DatiVittimeTerrorismo();
            BLCommon.GestioneVittimeTerrorismo.DatiVittimeTerrorismo oggettoB = new BLCommon.GestioneVittimeTerrorismo.DatiVittimeTerrorismo();

            bool a = oggettoA.GetHashCode() == oggettoB.GetHashCode();
        }
    }
}
