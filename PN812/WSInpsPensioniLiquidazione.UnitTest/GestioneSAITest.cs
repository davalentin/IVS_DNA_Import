...
{
    /// <summary>
    /// Summary description for GestioneSAITest
    /// </summary>
    [TestClass]
    public class GestioneSAITest
    {
        public GestioneSAITest()
        {
        ...
        [TestMethod]
        public void TestGetDatiSAI()
        {
            long numeroDomanda = 2146683200001;
            string errori = string.Empty;
            string codfisc = "MRNLTT51M60C812J";
            Entity.SAI datiSAI = null;
            Assert.IsTrue(GestioneSAI.GetDatiSAI(numeroDomanda, codfisc, TipoRichiesta.GET.GETSAR, ref datiSAI, out errori));
        }
    }
}
