...
namespace INPS.Pensioni.Liquidazione.UnitTest
{
    ...
    /// <summary>
    ///This is a test class for SoggettiTest and is intended
    ///to contain all GestioneSoggettiTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SoggettiTest
    {
        ...
        /// <summary>
        ///A test for GetSoggettoPerCodiceFiscale
        ///</summary>
        [TestMethod()]
        public void TestGetNumCertificato()
        {
