<%@ Page Language="C#" MasterPageFile="~/ProcedureOperatore.Master" AutoEventWireup="true"
    CodeBehind="Unicarpe.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.Unicarpe" %>
            ...
            <tr>
                <td align="center" style="width: 720px">
                    <label style="color: #336699; font-weight: bold; font-size: larger; width: 720px">
                        Gestione ricerca da Unicarpe</label>
                    <br />
                    <br />
                </td>
            </tr>
                            ...
                            <table class="tabellaFormattazione">
                                <tr align="center">
                                    <td class="Row1" align="center" style="width: 100%;" colspan="2">
                                        <asp:Label ID="lblMsg" runat="server" ForeColor="Black" Font-Bold="true" Text="Di seguito sono riportate le informazioni richieste attraverso l'applicazione Unicarpe"></asp:Label>
                                    </td>
                                </tr>
                            </table>
