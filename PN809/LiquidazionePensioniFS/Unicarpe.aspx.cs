...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class Unicarpe : BasePage, ISedi, IRicercaPosizione
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (Session["Ruolo"] == null)
                    {
                        ...
                        {
                            Session.Add("UrlUnicarpe", HttpContext.Current.Request.Url.PathAndQuery);
                ...
                if (ConfigurationManager.AppSettings["UNICARPE-CLIENT"] != null &&
                    ConfigurationManager.AppSettings["UNICARPE-CLIENT"] == "1")
                {
                ...
                else if (ConfigurationManager.AppSettings["UNICARPE-CLIENT"] != null &&
                    ConfigurationManager.AppSettings["UNICARPE-CLIENT"] == "2")
                {
                    ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "OpenModalDialog", "<script type='text/javascript'>document.getElementById('" + btnRicercaNDomus.ClientID + "').click() ;</script>", false);
                    btnRicercaNDomus.Style.Add("display", "none");
        ...
        private void RicercaNDomus(string numeroDomanda)
        {
            ...
            else
            {
                ...
                {
                    throw new INPS.DNA.DnaApplicationException("Unicarpe, Errore  in btnRicercaNDomus_Click" + ex);
                }
