...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneAbilitazioneUniDetra : CustomBasePage
    {
        ...
        {
            UserControls.AltreFunzioni.GestioneAbilitazioneUniDetra.UCAbilitazioneUniDetra tabAbilitazioneUniDetra = (UserControls.AltreFunzioni.GestioneAbilitazioneUniDetra.UCAbilitazioneUniDetra)sender;

            if (tabAbilitazioneUniDetra.HasError)
                ucAvviso.Tipo = TipoAvviso.Warning;
            else
                ucAvviso.Tipo = TipoAvviso.Ok;

            ucAvviso.Visible = true;
            ucAvviso.Messaggio = tabAbilitazioneUniDetra.ErrorMessage;
        }
