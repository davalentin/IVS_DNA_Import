...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneAziendeESOTRA : CustomBasePage
    {
        ...
        {
            IViewUI tabAzESOTRA = (IViewUI)sender;

            if (tabAzESOTRA.HasError)
            {
            ...
            ucAvviso.Messaggio = tabAzESOTRA.ErrorMessage;
        }
