...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneAziendeEditorialiLetteraB : CustomBasePage
    {
        ...
        {
            IViewUI tabBancheFideiuss = (IViewUI)sender;

            if (tabBancheFideiuss.HasError)
            {
            ...
            ucAvviso.Messaggio = tabBancheFideiuss.ErrorMessage;
        }
