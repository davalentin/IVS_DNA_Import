...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneAziendeVESO33 : CustomBasePage
    {
        ...
        {
            IViewUI tabAzVESO33 = (IViewUI)sender;

            if (tabAzVESO33.HasError)
            {
            ...
            ucAvviso.Messaggio = tabAzVESO33.ErrorMessage;
        }
