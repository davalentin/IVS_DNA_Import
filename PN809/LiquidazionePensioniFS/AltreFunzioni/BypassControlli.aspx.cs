...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class BypassControlli : CustomBasePage
    {
        ...
        {
            UserControls.AltreFunzioni.BypassControlli.UCBypassControlli tabBypassControlli = (UserControls.AltreFunzioni.BypassControlli.UCBypassControlli)sender;

            if (tabBypassControlli.HasError)
                ucAvviso.Tipo = TipoAvviso.Warning;
            else
                ucAvviso.Tipo = TipoAvviso.Ok;

            ucAvviso.Visible = true;
            ucAvviso.Messaggio = tabBypassControlli.ErrorMessage;
        }
