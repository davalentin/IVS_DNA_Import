...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneAbilitazioneServizi : CustomBasePage
    {
        ...
        {
            IViewUI tabAbilitazione = (IViewUI)sender;

            if (tabAbilitazione.HasError)
                ucAvviso.Tipo = TipoAvviso.Warning;
            else
                ucAvviso.Tipo = TipoAvviso.Ok;

            ucAvviso.Visible = true;
            ucAvviso.Messaggio = tabAbilitazione.ErrorMessage;
        }
