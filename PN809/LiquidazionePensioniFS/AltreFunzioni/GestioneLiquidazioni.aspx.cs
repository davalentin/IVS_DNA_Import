...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class GestioneLiquidazioni : CustomBasePage
    {
        ...
        {
            UserControls.AltreFunzioni.GestioneLiquidazioni.UCLiquidazioni tabLiquidazioni = (UserControls.AltreFunzioni.GestioneLiquidazioni.UCLiquidazioni)sender;

            if (tabLiquidazioni.HasError)
            {
                ucAvviso.Tipo = TipoAvviso.Warning;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = tabLiquidazioni.ErrorMessage;
            }
        }
