<%@ Page Language="C#" MasterPageFile="~/ProcedureOperatore.Master" AutoEventWireup="true"
    CodeBehind="Scriwo.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.Scriwo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlWelcome" runat="server" CssClass="iframe-dnone">
        <table style="width: 720px;" class="none">
            <tr>
                <td align="center" style="width: 720px">
                    <label style="color: #336699; font-weight: bold; font-size: larger; width: 720px">
                        Gestione ricerca da Sistema Pensioni</label>
                    <br />
                    <br />
                </td>
            </tr>
                            ...
                            <table class="tabellaFormattazione">
                                <tr align="center">
                                    <td class="Row1" align="center" style="width: 100%;" colspan="2">
                                        <asp:Label ID="lblMsg" runat="server" ForeColor="Black" Font-Bold="true" Text="Di seguito sono riportate le informazioni richieste attraverso l'applicazione Sistema Pensioni"></asp:Label>
                                    </td>
                                </tr>
                            </table>
    ...
    <div class="iframe-initial-loading_container">
        <div class="iframe-initial-loading" style="display: none">
            <div class="loading-text"><div class="font-bold">Elaborazione in corso...</div><div>Si prega di non chiudere questa schermata fino a quando l'operazione non verrà conclusa</div>
        </div>
    </div>
    </div>
    ...
    <asp:HiddenField ID="hdnProgStorico" runat="server" Value=""/>
</asp:Content>
