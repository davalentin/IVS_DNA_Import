...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class WebDom : BasePage, ISedi, IRicercaPosizione
    {
        ...
        private void RicercaNDomus(string numeroDomanda)
        {
            ...
            else
            {
                ...
                {
                    throw new INPS.DNA.DnaApplicationException("WebDom, Errore  in btnRicercaNDomus_Click" + ex);
                }
