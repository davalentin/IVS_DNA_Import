<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPrecedentePensione.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.LiquidazionePensioneAgo.UCPrecedentePensione" %>
    ...
    <table class="tabellaFormattazione">
        <tr>
            ...
            <td class="field" style="width: 25%;">
                <asp:DropDownList runat="server" ID="ddlCodiceP18" Width="75px" CssClass="tb8 txtUppercase" TabIndex="1" Enabled="false">
        ...
        <tr>
            ...
            <td class="field">
                <asp:TextBox Style="text-align: left" runat="server" ID="txtSede" Width="140px" CssClass="txtUppercase tb8"
                    MaxLength="4" TabIndex="2" Enabled="false"></asp:TextBox>
            ...
            <td class="field">
                <asp:TextBox Style="text-align: left" runat="server" ID="txtCertificato" Width="140px"
                    ...
                    onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" Enabled="false"></asp:TextBox>
        ...
        <tr id="TrDecOrig" runat="server">
            ...
            <td class="field full-grid" colspan="3">
                <asp:TextBox Style="text-align: left" runat="server" ID="txtDecOriginaria"
                    Width="95px" CssClass="txtUppercase tb8 dateMMaaaa" TabIndex="4" Text="mm/aaaa"
        ...
        <tr runat="server" id="TrDecCarico">
            ...
            <td class="field full-grid" colspan="3">
               <asp:TextBox Style="text-align: left" runat="server" ID="txtDecCarico"
                    Width="95px" CssClass="txtUppercase tb8 dateMMaaaa" TabIndex="5" Text="mm/aaaa"
                    MaxLength="7" Enabled="false"></asp:TextBox>
        ...
        <table width="100%" class=" tab-actions-group">
            <tr>
                ...
                <%--  <td style="text-align: left">
                  <asp:Button ID="btnEliminaPrecedentePensione" runat="server" SkinID="btnAzione1" Enabled="true" Text="Elimina Pens. Prov." Width="150px"
                        CausesValidation="false" OnClick="EliminaPrecedentePensione_Click" OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare i Dati Precedente Pensione?')) return false; else BlockUI();"/>
                </td>--%>
            </tr>
        </table>
    </div>
