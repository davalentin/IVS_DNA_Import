<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCOneri.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCOneri" %>
                ...
                <div class="bckGridViewElenco" style="width: 700px; margin: 7px;">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SottoGruppo" HeaderStyle-CssClass="intestazioneTabella Row1"
                                ItemStyle-CssClass="TblRecordset3">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblSottoGruppo" Text='<%#Bind("IdCodeSottoGruppo")%>' Width="100px"> 
                                    </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList CssClass="tb8 txtUppercase" ID="ddlSottoGruppo" runat="server" Width="100px">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Dec. Ben." HeaderStyle-CssClass="intestazioneTabella Row1"
                                ItemStyle-CssClass="TblRecordset3">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblDecorrenza" 
                                    CssClass="txtUppercase" Width="70px"/>  
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:Label runat="server" ID="lblDecorrenza_Edit" 
                                    CssClass="txtUppercase" Width="75px"/>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Cess. Ben." HeaderStyle-CssClass="intestazioneTabella Row1"
                                ItemStyle-CssClass="TblRecordset3">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblCessazione" 
                                    CssClass="txtUppercase" Width="75px"/>  
                                </ItemTemplate>
                                <EditItemTemplate>
                                    ...
                                    <asp:Panel runat="server" ID="pnlCessazioneFS_PT" Visible="false">
                                        <asp:TextBox CssClass="tb8 date-picker-base txtUppercase" runat="server" ID="txtCessazioneFS_PT"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldtxtCessazioneFS_PT" runat="server" ErrorMessage="Cessazione: Campo obbligatorio"
                                            Text="*" ControlToValidate="txtCessazioneFS_PT" ValidationGroup="UCTabOneri" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator runat="server" ID="validatetxtCessazioneFS_PT" Display="Dynamic"
                                            ...
                                            Text="*" ValidationGroup="UCTabOneri" ValidationExpression="^[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{4}|GG/MM/AAAA|gg/mm/aaaa$" />
