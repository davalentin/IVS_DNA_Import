...
{
    public partial class UCVittimeFS : CustomBaseUserControl, IMaggiorazioneBenefici, ITitolarePensione
    {
        #region IViewUI
        ...
        protected void SalvaVittime_Click(Object sender, EventArgs e)
        {
            ...
            presenterMaggiorazioneBenefici.SalvaVittimeFs(this);
        ...
        protected void EliminaVittime_Click(Object sender, EventArgs e)
        {
            ...
            PresenterMaggiorazioneBenefici presenterMaggiorazioneBenefici = new PresenterMaggiorazioneBenefici();
            presenterMaggiorazioneBenefici.EliminaVittimeFs(this);
        ...
        internal void ValorizzaEtichette(IMaggiorazioneBenefici maggiorazioneBenefici)
        {
        ...
        internal Presenter.SvrLiquidazioneFs.DatiBeneficioVittimeTerrorismo RecuperCampi()
        {
            Presenter.SvrLiquidazioneFs.DatiBeneficioVittimeTerrorismo datiBeneficioVittimeTerrorismo = new Presenter.SvrLiquidazioneFs.DatiBeneficioVittimeTerrorismo();
        ...
        private void LoadDdl(IMaggiorazioneBenefici maggiorazioneBenefici)
        {
            ...
            if (maggiorazioneBenefici != null && maggiorazioneBenefici.areaMaggiorazioneBenefici != null)
            {
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneFs.SoggettoBeneficiario soggettoBeneficiario in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario)
                ...
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneFs.TipologiaPrestazione tipologiaPrestazione in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione)
                    {
                ...
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneFs.TipologiaBeneficioTerrorismo tipologiaBeneficioTerrorismo in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo)
