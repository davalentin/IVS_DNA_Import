<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPrepensionamento.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.Oneri.UCPrepensionamento" %>
...
<table class="tabellaFormattazione grid grid-size-25">
    <tr>
        ...
        <td class="field" style="width: 25%">
            ...
            <asp:RequiredFieldValidator runat="server" ID="RFVtxtCodiceLegge" ControlToValidate="txtCodiceLegge" ErrorMessage="Codice Legge obbligatorio" 
                Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento" />
            <asp:RegularExpressionValidator runat="server" ID="REVtxtCodiceLegge" ControlToValidate="txtCodiceLegge" ErrorMessage="Codice Legge in formato non valido" 
                ValidationExpression="^[0-9]{4}$" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento" />
        </td>
    </tr>
    <tr>
        <td class="Row1" style="width: 25%">
        ...
        <td class="field" style="width: 25%">
            ...
            <asp:RegularExpressionValidator runat="server" ID="REVtxtSettimaneUtiliDiritto" ControlToValidate="txtSettimaneUtiliDiritto" ErrorMessage="Settimane utili diritto in formato non valido" 
                ValidationExpression="^[0-9]+$" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento" />
        </td>
        <td class="Row1" style="width: 25%">
            <label>
    ...
    <tr>
        ...
        <td class="field" style="width: 25%">
            ...
            <asp:RegularExpressionValidator runat="server" ID="REVtxtOnereMancataContribuzione" ControlToValidate="txtOnereMancataContribuzione" ErrorMessage="Onere mancata contribuzione in formato non valido" 
                ValidationExpression="\d{1,8}(,\d{1,4})?$" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento" />
        </td>
    </tr>
    <tr>
        <td class="Row1" style="width: 25%">
        ...
        <td class="field" style="width: 25%">
            ...
            <asp:RegularExpressionValidator runat="server" ID="REVtxtCodiceAzienda" ControlToValidate="txtCodiceAzienda" ErrorMessage="Codice Azienda in formato non valido" 
                ValidationExpression="^[0-9]+$" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento" />
        </td>
    </tr>
    <tr>
        ...
        <td class="field" style="width: 25%">
            <asp:TextBox runat="server" ID="txtCessazioneBeneficioPrepensionamento" Width="80px" CssClass="tb8 txtUppercase date-picker dateMMaaaa" MaxLength="7" ></asp:TextBox>
            <asp:RegularExpressionValidator ID="REVtxtCessazioneBeneficioPrepensionamento" ControlToValidate="txtCessazioneBeneficioPrepensionamento"
                    ...
                    runat="server" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabPrepensionamento"
                    Enabled="true" />
            <asp:CustomValidator runat="server" ControlToValidate="txtCessazioneBeneficioPrepensionamento" Display="Dynamic"
                    ErrorMessage="Cessazione beneficio prepensionamento: data illogica" Text="*" CssClass="field-is-required" ValidationGroup="UCTabPrepensionamento"
    ...
    <tr>
        <asp:Panel runat="server" ID="pnlAmianto" Visible="false">
            ...
            <td class="field" style="width: 25%">
                <asp:TextBox runat="server" ID="txtCessazioneAmianto" Width="80px" CssClass="tb8 txtUppercase date-picker dateMMaaaa" MaxLength="7" ></asp:TextBox>
                ...
                <asp:CustomValidator runat="server" ControlToValidate="txtCessazioneAmianto" Display="Dynamic"
                    ErrorMessage="Cessazione Amianto: data illogica" Text="*" CssClass="field-is-required" ValidationGroup="UCTabPrepensionamento"
        ...
        <tr>
            <td style="text-align: right" class="tab-actions-group__first">
                <asp:Button ID="btnPrepensionamento" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Salva Prepensionamento" 
                    Width="160px" OnClick="SalvaPrepensionamento_Click" OnClientClick="if(Page_ClientValidate('UCTabPrepensionamento')){aspnetForm.target ='_self'; BlockUI();}" CssClass="primary"/>
            </td>
            <td style="text-align: left">
                <asp:Button ID="btnEliminaPrepensionamento" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Elimina Prepensionamento" 
                    Width="160px" OnClick="EliminaPrepensionamento_Click" OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare Prepensionamento?')) return false; else BlockUI();" style="padding-left:0;padding-right:0" CssClass="ghost-delete"/>
            </td>
        </tr>
    </table>
</div>