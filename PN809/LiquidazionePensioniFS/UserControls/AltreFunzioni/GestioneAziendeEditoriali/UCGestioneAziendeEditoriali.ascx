<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCGestioneAziendeEditoriali.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeEditoriali.UCGestioneAziendeEditoriali" %>
...
<table class="intestazioneTabella intestazioneTabella__with-pagination no-border no-border-td">
    <!--filtro ricerca-->
    <tr>
        <td style="width: 720px" colspan="9" class="pb-24">
            ...
            <asp:Panel ID="panFiltro" runat="server" Style="border-style: solid; border-color: #000080;
                ...
                <table class="tabellaFormattazione" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <asp:DropDownList runat="server" ID="ddlFiltroOneri" CssClass="tb8 txtUppercase"
                                Width="100px">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem Text="SINGOLO" Value="SINGOLO"></asp:ListItem>
                                <asp:ListItem Text="DOPPIO" Value="DOPPIO"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
        ...
        <td class="pb-24">
            ...
            <center>
                <asp:GridView runat="server" ID="gvAnagraficaAccordi" SkinID="grdElenco1" AutoGenerateColumns="false"
                    CssClass="intestazioneTabella no-border" BorderWidth="1" BorderColor="Black" AutoGenerateEditButton="True"
                    ...
                    OnRowDeleting="gvAnagraficaAccordi_onRowDeleting" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="default-pagination-tables">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Decreto" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ItemStyle-CssClass="TblRecordset3" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblDecreto" Text='<%# Bind("Decreto")%>' CssClass="txtUppercase">      
                                </asp:Label>
                            </ItemTemplate>
                             <EditItemTemplate>
                                <asp:TextBox CssClass="tb8 txtUppercase" ID="txtDecreto" runat="server"
                                    MaxLength="20" Text=' <%# Bind("Decreto")%>' Width="50px">
                                </asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
        ...
        <td class="pb-24">
            ...
            <center>
                <asp:GridView runat="server" ID="gvAnagraficaAziende" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    OnRowDeleting="gvAnagraficaAziende_onRowDeleting" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="default-pagination-tables">
                    <Columns>
                        <asp:TemplateField HeaderText="Denominazione Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ItemStyle-CssClass="TblRecordset3" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70%">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sottogruppo onere" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ItemStyle-CssClass="TblRecordset3" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblSottogruppoOnere" Text='<%#Bind("SottogruppoOnere")%>' CssClass="txtUppercase"> 
                                </asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox CssClass="tb8 txtUppercase" runat="server" ID="txtSottogruppoOnere" MaxLength="4" Width="100px" Text='<%#Bind("SottogruppoOnere")%>'>
                                </asp:TextBox>
                                <asp:RegularExpressionValidator runat="server" ID="REV_txtSottogruppoOnere" ControlToValidate="txtSottogruppoOnere"
