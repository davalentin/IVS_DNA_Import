<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAziendeVESO29.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeVESO29.UCAziendeVESO29" %>
                    ...
                    <tr>
                        ...
                        <td class="field" style="width: 30%">
                            ...
                            <asp:RegularExpressionValidator runat="server" ID="validateDataUltimaDecorrenzaAmmessaDa" ControlToValidate="txtUltimaDecorrenzaAmmessaDa"
                                ...
                                ValidationGroup="GrigliaAziendeVESO29" />
                            <asp:CustomValidator runat="server" ControlToValidate="txtUltimaDecorrenzaAmmessaDa" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeVESO29"
    ...
    <tr>
        <td>
            ...
            <label style="color: #336699; font-weight: normal; font-style: italic; font-size: larger" class="section-label mt-32">
                Aziende VESO29</label>
            <center>
                <asp:GridView runat="server" ID="gvAziendeVESO29" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    OnRowEditing="gvAziendeVESO29_RowEditing" Width="1000px" PageSize="10" AllowPaging="true"
                    OnRowCommand="gvAziendeVESO29_RowCommand" OnRowCancelingEdit="gvAziendeVESO29_RowCancelingEdit"
                    OnRowDataBound="gvAziendeVESO29_RowDataBound" OnPageIndexChanging="gvAziendeVESO29_onPageIndexChanging"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Codice Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RegularExpressionValidator runat="server" ID="regulartxtCodiceAzienda" ControlToValidate="txtCodiceAzienda"
                                    ...
                                    Text="*" CssClass="field-is-required" ValidationExpression="^[0-9]{4}$" ValidationGroup="GrigliaAziendeVESO29" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:CustomValidator runat="server" ControlToValidate="txtDataUltimaDecorrenzaIVS" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeVESO29"
                                ID="customCheckDataUltimaDecorrenzaVESO29" ClientValidationFunction="checkCorrettezzaData" />
                        </EditItemTemplate>
                    </asp:TemplateField>
