<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCGestioneAziendeEditorialiLetteraB.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeEditorialiLetteraB.UCGestioneAziendeEditorialiLetteraB" %>
                        ...
                        <asp:TemplateField HeaderText="Domande Liquidate" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="tb8 txtUppercase" runat="server" ID="txtDomandeLiquidate" MaxLength="7"
                                    Text=' <%# Bind("DomandeLiquidate")%>' Width="50px" Enabled="false">
                                </asp:TextBox>
