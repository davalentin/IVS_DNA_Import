<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCGestioneAziendeESPA.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeESPA.UCGestioneAziendeESPA" %>
