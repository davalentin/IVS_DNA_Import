<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAziendeESOAMB.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeESOAMB.UCAziendeESOAMB" %>
...
<table class="tabellaFormattazione">
                    ...
                    <tr>
                        ...
                        <td class="field" style="width: 30%">
                            ...
                            <asp:RegularExpressionValidator runat="server" ID="validateDataUltimaDecorrenzaAmmessaDa" ControlToValidate="txtUltimaDecorrenzaAmmessaDa"
                                ...
                                ValidationGroup="GrigliaAziendeESOAMB" />
                            <asp:CustomValidator runat="server" ControlToValidate="txtUltimaDecorrenzaAmmessaDa" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeESOAMB"
    ...
    <tr>
        <td>
            ...
            <label style="color: #336699; font-weight: normal; font-style: italic; font-size: larger" class="section-label mt-32">
                Aziende ESOAMB</label>
            <center>
                <asp:GridView runat="server" ID="gvAziendeESOAMB" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    OnRowEditing="gvAziendeESOAMB_RowEditing" Width="1000px" PageSize="10" AllowPaging="true"
                    OnRowCommand="gvAziendeESOAMB_RowCommand" OnRowCancelingEdit="gvAziendeESOAMB_RowCancelingEdit"
                    OnRowDataBound="gvAziendeESOAMB_RowDataBound" OnPageIndexChanging="gvAziendeESOAMB_onPageIndexChanging"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Codice Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RegularExpressionValidator runat="server" ID="regulartxtCodiceAzienda" ControlToValidate="txtCodiceAzienda"
                                    ...
                                    Text="*" CssClass="field-is-required" ValidationExpression="^[0-9]{4}$" ValidationGroup="GrigliaAziendeESOAMB" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:CustomValidator runat="server" ControlToValidate="txtDataUltimaDecorrenzaIVS" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeESOAMB"
                                ID="customCheckDataUltimaDecorrenzaESOAMB" ClientValidationFunction="checkCorrettezzaData" />
                        </EditItemTemplate>
                    </asp:TemplateField>
    ...
    <tr>
        <td>
            <br />
            <label style="color: #336699; font-weight: normal; font-style: italic; font-size: larger" class="section-label mt-32">
                Aziende ESOAMB con scadenza assegno in formato Giorno/Mese/Anno</label>
            <center>
