...
{
    public partial class UCGestioneAziendeESOPMI : CustomBaseUserControl, IBancheFideiussioneESOPMI
    {
        /// <summary>
        ...
        /// <summary>
        /// proprietà ereditate da IBancheFideiussioneESOPMI
        /// </summary>
        #region IBancheFideiussioneESOPMI

        public AreaBancaFideiussioneESOPMI AziendeESOPMI { get; set; }

        #endregion IBancheFideiussioneESOPMI
        ...
        protected void gvBancheFideiussione_onPageIndexChanging(Object sender, GridViewPageEventArgs e)
        {
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneBancheFideiussioneESOPMI, Errore nel metodo gvBancheFideiussione_onPageIndexChanging" + ex);
            }
        }
        ...
        protected void gvBancheFideiussione_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            try
            {
                ...
                if (((List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()]).Count() < 2)
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneAziendeESOPMI, Errore nel metodo gvBancheFideiussione_RowCancelingEdit " + ex);
            }
        ...
        protected void gvBancheFideiussione_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneAziendeESOPMI, Errore nel metodo gvBancheFideiussione_RowEditing " + ex);
            }
        }
        ...
        protected void gvBancheFideiussione_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Delete")
            {
                ...
                PresenterAziendeESOPMI presenterAziendaESOPMI = new PresenterAziendeESOPMI();
                ValorizzaBancheFideiussionePerDelete(r.DataItemIndex);
                presenterAziendaESOPMI.EliminaBancheFideiussione(this);
                ...
                {
                    this.ErrorMessage = "Banca Fideiussione ESOPMI eliminata correttamente";
                    RaiseShowAvviso(this, null);
                }
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                PresenterAziendeESOPMI presenterAziendeESOPMI = new PresenterAziendeESOPMI();
                ValorizzaBancheFideiussionePerSave(r);
                if (this.HasError)
                    return;

                presenterAziendeESOPMI.InserisciBancheFideiussione(this);
                ...
                {
                    this.ErrorMessage = "Banca Fideiussione ESOPMI inserita correttamente";
                    RaiseShowAvviso(this, null);
                    gvBancheFideiussione.EditIndex = -1;
                }
        ...
        protected void gvBancheFideiussione_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione> elencoBancheFideiussione = (List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
        ...
        protected void gvAziende_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                presenterAziendeESOPMI.InserisciAziende(this);
                ...
                {
                    this.ErrorMessage = "Azienda ESOPMI inserita correttamente";
                    RaiseShowAvviso(this, null);
                    gvAziende.EditIndex = -1;
                }
        ...
        protected void gvAziendeGGmmAAAA_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Elimina")
            {
                ...
                presenterAziendeESOPMI.EliminaAziendeGGmmAAAA(this);
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                presenterAziendeESOPMI.InserisciAziendeGGmmAAAA(this);
        ...
        {
            PresenterAziendeESOPMI presenterAziendaESOPMI = new PresenterAziendeESOPMI();
            presenterAziendaESOPMI.CaricaAreaBancheAziende(this);
        ...
        {
            int count = 0;
            List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione> elencoBancheFideiussioneWS = (List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
            ...
            if (count > 0)
            {
                ...
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneESOPMIDecBancaFideiussione());
                DisabilitaFiltro();
            }
        }
        ...
        private void ValorizzaGrigliaGvBancheFideiussione()
        {
            ...
            if ((List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()] != null)
                gvBancheFideiussione.PageIndex = ((List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()]).Count / gvBancheFideiussione.PageSize;
        ...
        {
            List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione> elencoBancheFideiussioneWS = new List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>();
            if (this.AziendeESOPMI.ElencoBancheFideiussione == null || this.AziendeESOPMI.ElencoBancheFideiussione.Count() == 0)
            {
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneESOPMIDecBancaFideiussione());
            }
            else
            {
                elencoBancheFideiussioneWS = this.AziendeESOPMI.ElencoBancheFideiussione.ToList();
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneESOPMIDecBancaFideiussione());
            }
        ...
        private void gvBancheFideiussione_Load()
        {
            try
            {
                gvBancheFideiussione.DataSource = (List<GestioneBancheFideiussioneESOPMIDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
        ...
        private void ValorizzaBancheFideiussionePerSave(GridViewRow row)
        {
            ...
            GestioneBancheFideiussioneESOPMIDecBancaFideiussione bncApp = new GestioneBancheFideiussioneESOPMIDecBancaFideiussione();
        ...
        private void ValorizzaBancheFideiussionePerDelete(int index)
        {
            ...
            GestioneBancheFideiussioneESOPMIDecBancaFideiussione bncApp = elencoBancheFideiussione[index];
            ValorizzaBancheFideiussione(bncApp);
        }

        private void ValorizzaBancheFideiussione(GestioneBancheFideiussioneESOPMIDecBancaFideiussione bancheFideiussione)
        {
            if (this.AziendeESOPMI == null)

                this.AziendeESOPMI = new AreaBancaFideiussioneESOPMI();
            this.AziendeESOPMI.BancaFideiussione = new GestioneBancheFideiussioneESOPMIDecBancaFideiussione();

            AziendeESOPMI.BancaFideiussione.Id = bancheFideiussione.Id;
            AziendeESOPMI.BancaFideiussione.CodiceAzienda = bancheFideiussione.CodiceAzienda;
            AziendeESOPMI.BancaFideiussione.Matricola = bancheFideiussione.Matricola;
            AziendeESOPMI.BancaFideiussione.BancaFideiussione = bancheFideiussione.BancaFideiussione;
            AziendeESOPMI.BancaFideiussione.Progressivo = bancheFideiussione.Progressivo;
            AziendeESOPMI.BancaFideiussione.Anno = bancheFideiussione.Anno;
            AziendeESOPMI.BancaFideiussione.InizioEsodo = bancheFideiussione.InizioEsodo;
            AziendeESOPMI.BancaFideiussione.FineEsodo = bancheFideiussione.FineEsodo;
            AziendeESOPMI.BancaFideiussione.ABI = bancheFideiussione.ABI;
            AziendeESOPMI.BancaFideiussione.CAB = bancheFideiussione.CAB;
        }
        ...
        private void FormattaElencoAziende()
        {
            ...
            if (this.AziendeESOPMI.ElencoAziende == null || this.AziendeESOPMI.ElencoAziende.Count() == 0)
            {
                elencoAziende.Add(new GestioneDecodificaAziendaDecAzienda());
            }
            else
            {
                elencoAziende = this.AziendeESOPMI.ElencoAziende.ToList();
                elencoAziende.Add(new GestioneDecodificaAziendaDecAzienda());
            }
        ...
        private void ValorizzaAziende(GestioneDecodificaAziendaDecAzienda aziende)
        {
            if (this.AziendeESOPMI == null)
                ...
                this.AziendeESOPMI = new AreaBancaFideiussioneESOPMI();
            this.AziendeESOPMI.Azienda = new GestioneDecodificaAziendaDecAzienda();

            AziendeESOPMI.Azienda.Id = aziende.Id;
            AziendeESOPMI.Azienda.TraduzioneSuGP = aziende.TraduzioneSuGP;
            AziendeESOPMI.Azienda.Descrizione = aziende.Descrizione;
            AziendeESOPMI.Azienda.SiglaCategoria = Keys.ESOPMI;
        }
        ...
        private void FormattaElencoAziendeGGmmAAAA()
        {
            ...
            if (this.AziendeESOPMI.ElencoAziendeAssegnoGGmmAAAA == null || this.AziendeESOPMI.ElencoAziendeAssegnoGGmmAAAA.Count() == 0)
            {
                elencoAziendeGGmmAAAA.Add(new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA());
            }
            else
            {
                elencoAziendeGGmmAAAA = this.AziendeESOPMI.ElencoAziendeAssegnoGGmmAAAA.ToList();
                elencoAziendeGGmmAAAA.Add(new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA());
            }
        ...
        private void ValorizzaAziendeGGmmAAAA(GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA aziendeGGmmAAAA)
        {
            if (this.AziendeESOPMI == null)
                this.AziendeESOPMI = new AreaBancaFideiussioneESOPMI();
            this.AziendeESOPMI.AziendaGGmmAAAA = new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA();

            AziendeESOPMI.AziendaGGmmAAAA.Id = aziendeGGmmAAAA.Id;
            AziendeESOPMI.AziendaGGmmAAAA.TraduzioneSuGP = aziendeGGmmAAAA.TraduzioneSuGP;
            AziendeESOPMI.AziendaGGmmAAAA.ProgressivoRichiesto = aziendeGGmmAAAA.ProgressivoRichiesto;
        }
        ...
        private class Keys
        {
            ...
            public const string ESOPMI = "ESOPMI";
        }
