<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCGestioneAziendeESOPMI.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeESOPMI.UCGestioneAziendeESOPMI" %>
<table class="tabellaFormattazione">
    ...
    <tr>
        <td>
            <br />
            <label style="color: #336699; font-weight: normal; font-style: italic; font-size: larger; display:none;" class="section-label mt-32">
                Aziende per filtro L26 con scadenza assegno in formato Giorno/Mese/Anno</label>
            <center>
                <asp:GridView runat="server" ID="gvAziendeGGmmAAAA" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="default-pagination-tables" visible ="false">
                    <Columns>
                        <asp:TemplateField HeaderText="Codice Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
