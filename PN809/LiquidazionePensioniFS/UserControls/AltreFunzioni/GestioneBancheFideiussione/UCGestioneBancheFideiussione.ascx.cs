...
namespace INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneBancheFideiussione
{
    public partial class UCGestioneBancheFideiussione : CustomBaseUserControl, IBancheFideiussione
    {
        /// <summary>
        ...
        /// <summary>
        /// proprietà ereditate da IBancheFideiussione
        /// </summary>
        #region IBancheFideiussione

        public AreaBancaFideiussione BancheFideiussione { get; set; }

        #endregion IBancheFideiussione
        ...
        protected void gvBancheFideiussione_onPageIndexChanging(Object sender, GridViewPageEventArgs e)
        {
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneBancheFideiussione, Errore nel metodo gvBancheFideiussione_onPageIndexChanging" + ex);
            }
        }
        ...
        protected void gvBancheFideiussione_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            try
            {
                ...
                if (((List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()]).Count() < 2)
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneBancheFideiussione, Errore nel metodo gvBancheFideiussione_RowCancelingEdit " + ex);
            }
        ...
        protected void gvBancheFideiussione_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            {
                throw new INPS.DNA.DnaApplicationException("UCGestioneBancheFideiussione, Errore nel metodo gvBancheFideiussione_RowEditing " + ex);
            }
        }
        ...
        protected void gvBancheFideiussione_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Delete")
            {
                ...
                PresenterBancaFideiussione presenterBancaFideiussione = new PresenterBancaFideiussione();
                ValorizzaBancheFideiussionePerDelete(r.DataItemIndex);
                presenterBancaFideiussione.EliminaBancheFideiussione(this);
                ...
                {
                    this.ErrorMessage = "Banca Fideiussione eliminata correttamente";
                    RaiseShowAvviso(this, null);
                }
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                presenterBancaFideiussione.InserisciBancheFideiussione(this);
                ...
                {
                    this.ErrorMessage = "Banca Fideiussione inserita correttamente";
                    RaiseShowAvviso(this, null);
                    gvBancheFideiussione.EditIndex = -1;
                }
        ...
        protected void gvBancheFideiussione_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    List<GestioneBancheFideiussioneDecBancaFideiussione> elencoBancheFideiussione = (List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
        ...
        protected void gvAziende_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                presenterBancaFideiussione.InserisciAziende(this);
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (e.Row.Cells[0].Controls.Count == 3)
                    {
                        ...
                        //ENG - Permessa solo la modifica della Descrizione
                        TextBox codiceAzienda = ((TextBox)e.Row.FindControl("txtCodiceAzienda"));
                        if (codiceAzienda != null && !String.IsNullOrEmpty(codiceAzienda.Text) && !String.IsNullOrEmpty(codiceAzienda.Text.Trim()))
                            codiceAzienda.Enabled = false;
                    }
        ...
        protected void gvAziendeGGmmAAAA_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Elimina")
            {
                ...
                presenterBancaFideiussione.EliminaAziendeGGmmAAAA(this);
            ...
            else if (e.CommandName == "Salva")
            {
                ...
                presenterBancaFideiussione.InserisciAziendeGGmmAAAA(this);
        ...
        {
            PresenterBancaFideiussione presenterBancaFideiussione = new PresenterBancaFideiussione();
            presenterBancaFideiussione.CaricaAreaBancheAziende(this);
        ...
        {
            int count = 0;
            List<GestioneBancheFideiussioneDecBancaFideiussione> elencoBancheFideiussioneWS = (List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
            ...
            if (count > 0)
            {
                ...
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneDecBancaFideiussione());
                DisabilitaFiltro();
            }
        }
        ...
        private void ValorizzaGrigliaGvBancheFideiussione()
        {
            ...
            if ((List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()] != null)
                gvBancheFideiussione.PageIndex = ((List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()]).Count / gvBancheFideiussione.PageSize;
        ...
        {
            List<GestioneBancheFideiussioneDecBancaFideiussione> elencoBancheFideiussioneWS = new List<GestioneBancheFideiussioneDecBancaFideiussione>();
            if (this.BancheFideiussione.ElencoBancheFideiussione == null || this.BancheFideiussione.ElencoBancheFideiussione.Count() == 0)
            {
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneDecBancaFideiussione());
            }
            else
            {
                elencoBancheFideiussioneWS = this.BancheFideiussione.ElencoBancheFideiussione.ToList();
                elencoBancheFideiussioneWS.Add(new GestioneBancheFideiussioneDecBancaFideiussione());
            }
        ...
        private void gvBancheFideiussione_Load()
        {
            try
            {
                gvBancheFideiussione.DataSource = (List<GestioneBancheFideiussioneDecBancaFideiussione>)ViewState[EnumViewState.BancheFideiussione.ToString()];
        ...
        private void ValorizzaBancheFideiussionePerSave(GridViewRow row)
        {
            ...
            GestioneBancheFideiussioneDecBancaFideiussione bncApp = new GestioneBancheFideiussioneDecBancaFideiussione();
        ...
        private void ValorizzaBancheFideiussionePerDelete(int index)
        {
            ...
            GestioneBancheFideiussioneDecBancaFideiussione bncApp = elencoBancheFideiussione[index];
            ValorizzaBancheFideiussione(bncApp);
        }

        private void ValorizzaBancheFideiussione(GestioneBancheFideiussioneDecBancaFideiussione bancheFideiussione)
        {
            if (this.BancheFideiussione == null)

                this.BancheFideiussione = new AreaBancaFideiussione();
            this.BancheFideiussione.BancaFideiussione = new GestioneBancheFideiussioneDecBancaFideiussione();

            BancheFideiussione.BancaFideiussione.Id = bancheFideiussione.Id;
            BancheFideiussione.BancaFideiussione.CodiceAzienda = bancheFideiussione.CodiceAzienda;
            BancheFideiussione.BancaFideiussione.Matricola = bancheFideiussione.Matricola;
            BancheFideiussione.BancaFideiussione.BancaFideiussione = bancheFideiussione.BancaFideiussione;
            BancheFideiussione.BancaFideiussione.Progressivo = bancheFideiussione.Progressivo;
            BancheFideiussione.BancaFideiussione.Anno = bancheFideiussione.Anno;
            BancheFideiussione.BancaFideiussione.InizioEsodo = bancheFideiussione.InizioEsodo;
            BancheFideiussione.BancaFideiussione.FineEsodo = bancheFideiussione.FineEsodo;
            BancheFideiussione.BancaFideiussione.ABI = bancheFideiussione.ABI;
            BancheFideiussione.BancaFideiussione.CAB = bancheFideiussione.CAB;
        }
        ...
        private void FormattaElencoAziende()
        {
            ...
            if (this.BancheFideiussione.ElencoAziende == null || this.BancheFideiussione.ElencoAziende.Count() == 0)
            {
                elencoAziende.Add(new GestioneDecodificaAziendaDecAzienda());
            }
            else
            {
                elencoAziende = this.BancheFideiussione.ElencoAziende.ToList();
                elencoAziende.Add(new GestioneDecodificaAziendaDecAzienda());
            }
        ...
        private void ValorizzaAziende(GestioneDecodificaAziendaDecAzienda aziende)
        {
            if (this.BancheFideiussione == null)
                ...
                this.BancheFideiussione = new AreaBancaFideiussione();
            this.BancheFideiussione.Azienda = new GestioneDecodificaAziendaDecAzienda();

            BancheFideiussione.Azienda.Id = aziende.Id;
            BancheFideiussione.Azienda.TraduzioneSuGP = aziende.TraduzioneSuGP;
            BancheFideiussione.Azienda.Descrizione = aziende.Descrizione;
            BancheFideiussione.Azienda.SiglaCategoria = Keys.VESO92;
        }
        ...
        private void FormattaElencoAziendeGGmmAAAA()
        {
            ...
            if (this.BancheFideiussione.ElencoAziendeAssegnoGGmmAAAA == null || this.BancheFideiussione.ElencoAziendeAssegnoGGmmAAAA.Count() == 0)
            {
                elencoAziendeGGmmAAAA.Add(new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA());
            }
            else
            {
                elencoAziendeGGmmAAAA = this.BancheFideiussione.ElencoAziendeAssegnoGGmmAAAA.ToList();
                elencoAziendeGGmmAAAA.Add(new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA());
            }
        ...
        private void ValorizzaAziendeGGmmAAAA(GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA aziendeGGmmAAAA)
        {
            if (this.BancheFideiussione == null)
                this.BancheFideiussione = new AreaBancaFideiussione();
            this.BancheFideiussione.AziendaGGmmAAAA = new GestioneAziendeScadenzaAssegnoGGmmAAAADecAziendeScadenzaAssegnoGGmmAAAA();

            BancheFideiussione.AziendaGGmmAAAA.Id = aziendeGGmmAAAA.Id;
            BancheFideiussione.AziendaGGmmAAAA.TraduzioneSuGP = aziendeGGmmAAAA.TraduzioneSuGP;
            BancheFideiussione.AziendaGGmmAAAA.ProgressivoRichiesto = aziendeGGmmAAAA.ProgressivoRichiesto;
        }
        ...
        private class Keys
        {
            ...
            public const string VESO92 = "VESO92";
        }
