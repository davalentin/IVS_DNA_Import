<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAziendeCredito.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeCredito.UCAziendeCredito" %>
...
<table class="tabellaFormattazione">
    ...
    <tr>
        <td>
            <br />
            <asp:Panel runat="server" ID="pnlScelta" DefaultButton="btnSceltaAzienda" CssClass="form-container background-light-blue">
                <div class="single-line-container">
                    <label class="input-label">Selezionare Azienda</label>
            ...
            <asp:Label runat="server" style="color: #336699; font-weight: normal; font-style: italic; font-size: larger" ID="lblScelta" Text="" class="section-label mt-32"/>
            <center>
                
                <br />
                <asp:GridView runat="server" ID="gvAziendeCredito" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    OnRowEditing="gvAziendeCredito_RowEditing" Width="1000px" PageSize="10" AllowPaging="true"
                    OnRowCommand="gvAziendeCredito_RowCommand" OnRowCancelingEdit="gvAziendeCredito_RowCancelingEdit"
                    OnRowDataBound="gvAziendeCredito_RowDataBound" OnPageIndexChanging="gvAziendeCredito_onPageIndexChanging"
                    OnRowDeleting="gvAziendeCredito_onRowDeleting" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="default-pagination-tables"
                    Visible="false">
                    <Columns>
                        <asp:TemplateField HeaderText="Codice Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RegularExpressionValidator runat="server" ID="regulartxtCodiceAzienda" ControlToValidate="txtCodiceAzienda"
                                    ...
                                    Text="*" CssClass="field-is-required" ValidationExpression="^[0-9]+$" ValidationGroup="GrigliaAziendeCredito" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:CustomValidator runat="server" ControlToValidate="txtDataUltimaDecorrenzaIVS" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeCredito"
