<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAziendeESOTEL.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.AltreFunzioni.GestioneAziendeESOTEL.UCAziendeESOTEL" %>
                    ...
                    <tr>
                        ...
                        <td class="field" style="width: 30%">
                            ...
                            <asp:RegularExpressionValidator runat="server" ID="validateDataUltimaDecorrenzaAmmessaDa" ControlToValidate="txtUltimaDecorrenzaAmmessaDa"
                                ...
                                ValidationGroup="GrigliaAziendeESOTEL" />
                            <asp:CustomValidator runat="server" ControlToValidate="txtUltimaDecorrenzaAmmessaDa" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeESOTEL"
    ...
    <tr>
        <td>
            ...
            <label style="color: #336699; font-weight: normal; font-style: italic; font-size: larger" class="section-label mt-32">
                Aziende ESOTEL</label>
            <center>
                <asp:GridView runat="server" ID="gvAziendeESOTEL" SkinID="grdElenco1" AutoGenerateColumns="false"
                    ...
                    OnRowEditing="gvAziendeESOTEL_RowEditing" Width="1000px" PageSize="10" AllowPaging="true"
                    OnRowCommand="gvAziendeESOTEL_RowCommand" OnRowCancelingEdit="gvAziendeESOTEL_RowCancelingEdit"
                    OnRowDataBound="gvAziendeESOTEL_RowDataBound" OnPageIndexChanging="gvAziendeESOTEL_onPageIndexChanging"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Codice Azienda" HeaderStyle-CssClass="intestazioneTabella Row1"
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RegularExpressionValidator runat="server" ID="regulartxtCodiceAzienda" ControlToValidate="txtCodiceAzienda"
                                    ...
                                    Text="*" CssClass="field-is-required" ValidationExpression="^[0-9]{4}$" ValidationGroup="GrigliaAziendeESOTEL" />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:CustomValidator runat="server" ControlToValidate="txtDataUltimaDecorrenzaIVS" Display="Dynamic"
                                ErrorMessage="La data inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="GrigliaAziendeESOTEL"
                                ID="customCheckDataUltimaDecorrenzaESOTEL" ClientValidationFunction="checkCorrettezzaData" />
                        </EditItemTemplate>
                    </asp:TemplateField>
