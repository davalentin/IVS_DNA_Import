<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAltrePensioniCi.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.Bititolarita.UCAltrePensioniCi" %>
            ...
            <td class="Row1">
                <div class="bckGridViewElenco mt-16" style="overflow-x:auto; width: 700px;">
                    <asp:GridView runat="server" ID="gvAltrePensioni" SkinID="grdElenco1" AutoGenerateColumns="false"
                        ...
                        OnRowEditing="gvAltrePensioni_RowEditing" OnRowUpdating="gvAltrePensioni_RowUpdating" OnPageIndexChanging="gvAltrePensioni_onPageIndexChanging"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Codice Categoria" HeaderStyle-CssClass="intestazioneTabella Row1" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" ID="txtCodiceCategoria" Width="70%" CssClass="txtUppercase tb8" MaxLength="3" Text='<%#Bind("CodiceCategoria") %>'>                                       
                                    </asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldtxtCodiceCategoria" runat="server" ErrorMessage="Codice Categoria: campo obbligatorio"
                                        Text="*" CssClass="field-is-required" ControlToValidate="txtCodiceCategoria" ValidationGroup="UCTabAltrePensioni" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator runat="server" ID="regularTxtCodiceCategoria"
                                        ControlToValidate="txtCodiceCategoria" Display="Dynamic" ErrorMessage="Codice Categoria: inserire la categoria in un formato valido"
                            ...
                            <asp:TemplateField HeaderText="Certificato" HeaderStyle-CssClass="intestazioneTabella Row1"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RegularExpressionValidator runat="server" ID="regularTxtCertificato"
                                        ControlToValidate="txtCertificato" Display="Dynamic" ErrorMessage="Certificato: inserire il numero di Certificato in un formato valido"
                            ...
                            <asp:TemplateField HeaderText="Decorrenza" HeaderStyle-CssClass="intestazioneTabella Row1" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" ID="txtDecorrenza" CssClass="txtUppercase tb8 date-picker-range70 dateMMaaaa" MaxLength="7" Text='<%# Bind("Decorrenza", "{0:MM/yyyy}")%>'/>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldtxtDecorrenza" runat="server" ErrorMessage="Decorrenza: Campo obbligatorio"
                                        Text="*" CssClass="field-is-required" ControlToValidate="txtDecorrenza" ValidationGroup="UCTabAltrePensioni" Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateField HeaderText="Cessazione" HeaderStyle-CssClass="intestazioneTabella Row1" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" ID="txtCessazione" CssClass="txtUppercase tb8 date-picker-range70 dateMMaaaa" MaxLength="7" Text='<%# Bind("Cessazione", "{0:MM/yyyy}")%>'/>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="intestazioneTabella" HeaderText="&nbsp;&nbsp;&nbsp;" HeaderStyle-Width="3%">
                                <ItemTemplate>
    ...
    <table width="100%" style="min-height:100px;" class="tab-actions-group">
        <tr valign="bottom">
            <td style="text-align: right" class="tab-actions-group__first">
                <asp:Button ID="btnSalvaAltrePensioni" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Salva Altre Pensioni" 
                    Width="150px" OnClick="SalvaAltrePensioni_Click" OnClientClick="BlockUI();" CssClass="primary"/>
            </td>
            <td style="text-align: left">
                <asp:Button ID="btnEliminaAltrePensioni" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Elimina Altre Pensioni" 
                    Width="150px" OnClick="EliminaAltrePensioni_Click" OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare i dati Altre Pensioni?')) return false; else BlockUI();" CssClass="ghost-delete" />
            </td>
        </tr>
    </table>
</div>