<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCExCombattente.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCExCombattente" %>
...
<asp:Panel ID="pnlExCombattente" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlENPALS" Visible="false">
        <div id="Div1" style="border-style: solid; border-color: #000080; border-collapse:collapse; border-width:1px; 
            width: 710px; margin-left:4px; margin-top:4px; margin-bottom:4px" runat="server">
            <table class="tabellaFormattazione grid grid-size-20" cellpadding="3" cellspacing="1" border="0" width="100%">
            <tr>
                <td class="Row1" style="width:30%">
                    <label>
                        Numero Contributi NL non vedenti:</label>
                </td>
                <td>
                    <asp:TextBox runat="server" ID="txtNumeroContributiNLNonVedenti" CssClass="tb8 txtUppercase" Width="70px" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            </table>
        </div>
        ...
        <tr>
            <td style="text-align: right" class="tab-actions-group__first">
                <asp:Button ID="btnSalvaExCombattente" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Salva Ex Combattente" 
                    Width="160px" OnClick="SalvaExCombattente_Click" OnClientClick="if(Page_ClientValidate('UCTabExCombattente')){aspnetForm.target ='_self'; BlockUI();}" CssClass="primary"/>
            </td>
            <td style="text-align: left">
                <asp:Button ID="btnEliminaExCombattente" runat="server" SkinID="btnAzione1" CausesValidation="false" Enabled="true" Text="Elimina Ex Combattente" 
                    Width="160px" OnClick="EliminaExCombattente_Click" OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare Ex Combattente?')) return false; else BlockUI();" CssClass="ghost-delete"/>
            </td>
        </tr>
    </table>
</div>