...
{
    public partial class UCVittime : CustomBaseUserControl, IMaggiorazioneBeneficiAgo, ITitolarePensione
    {
        #region IViewUI
        ...
        protected void SalvaVittime_Click(Object sender, EventArgs e)
        {
            ...
            presenterMaggiorazioneBenefici.SalvaVittime(this);
        ...
        protected void EliminaVittime_Click(Object sender, EventArgs e)
        {
            ...
            PresenterMaggiorazioneBenefici presenterMaggiorazioneBenefici = new PresenterMaggiorazioneBenefici();
            presenterMaggiorazioneBenefici.EliminaVittime(this);
        ...
        internal void ValorizzaEtichette(IMaggiorazioneBeneficiAgo maggiorazioneBenefici)
        {
        ...
        internal Presenter.SvrLiquidazioneAgo.DatiBeneficioVittimeTerrorismo RecuperCampi()
        {
            Presenter.SvrLiquidazioneAgo.DatiBeneficioVittimeTerrorismo datiBeneficioVittimeTerrorismo = new Presenter.SvrLiquidazioneAgo.DatiBeneficioVittimeTerrorismo();
        ...
        private void LoadDdl(IMaggiorazioneBeneficiAgo maggiorazioneBenefici)
        {
            ...
            if (maggiorazioneBenefici != null && maggiorazioneBenefici.areaMaggiorazioneBenefici != null)
            {
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneAgo.SoggettoBeneficiario soggettoBeneficiario in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaSoggettoBeneficiario)
                ...
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneAgo.TipologiaPrestazione tipologiaPrestazione in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaPrestazione)
                    {
                ...
                if (maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo != null && maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo.Count() > 0)
                {
                    ...
                    foreach (Presenter.SvrLiquidazioneAgo.TipologiaBeneficioTerrorismo tipologiaBeneficioTerrorismo in maggiorazioneBenefici.areaMaggiorazioneBenefici.ListaTipologiaBeneficioTerrorismo)
