<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVittime.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCVittime" %>
