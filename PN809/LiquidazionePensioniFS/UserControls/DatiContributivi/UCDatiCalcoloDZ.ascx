<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCDatiCalcoloDZ.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.DatiContributivi.UCDatiCalcoloDZ" %>
    ...
    <div id="pdivHeader" style="border-style: solid; border-color: #000080; border-collapse: collapse;
        ...
        <table class="tabellaFormattazione  grid grid-size-20">
            ...
            <tr>
                ...
                <td class="field" style="width: 25%">
                    <asp:Label Style="text-align: left" runat="server" ID="lblDecorrenza" Width="60%"></asp:Label>
                </td>
                <td class="Row1" style="width: 25%">
                    <label>
                        Sospensione:</label>
    ...
    <div id="divServizioUtile_DZ" style="border-style: solid; border-color: #000080;
        ...
        <table class="tabellaFormattazione grid grid-size-20">
            <tr>
                ...
                <td class="field fileds-date-input fileds-date-input--col-2" style="width: 17%">
                    <asp:TextBox ID="txtServizioUtileAA_QuotaA" runat="server" CssClass="tb8 txtUppercase" Width="30px"
                    ...
                    <asp:RegularExpressionValidator ID="REVtxtServizioUtileAA_QuotaA" ControlToValidate="txtServizioUtileAA_QuotaA"
                        ...
                        runat="server" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabDatiCalcoloDZ" />
                    <asp:TextBox ID="txtServizioUtileMM_QuotaA" runat="server" CssClass="tb8 txtUppercase" Width="30px"
                        MaxLength="2"></asp:TextBox>
                    <label>
                        MM</label>
        ...
        <table class="tabellaFormattazione grid grid-size-20">
            <tr>
                ...
                <td class="field fileds-date-input fileds-date-input--col-2" style="width: 17%">
                    <asp:TextBox ID="txtServizioUtileAA_QuotaB" runat="server" CssClass="tb8 txtUppercase" Width="30px"
                        MaxLength="2"></asp:TextBox>
                    <label>
                        AA</label>
                    <asp:RegularExpressionValidator ID="REVtxtServizioUtileAA_QuotaB" ControlToValidate="txtServizioUtileAA_QuotaB"
                        ...
                        runat="server" Text="*" CssClass="field-is-required" Display="Dynamic" ValidationGroup="UCTabDatiCalcoloDZ" />
                    <asp:TextBox ID="txtServizioUtileMM_QuotaB" runat="server" CssClass="tb8 txtUppercase" Width="30px"
                        MaxLength="2"></asp:TextBox>
                    <label>
                        MM</label>
    ...
    <div id="divRetributivi_DZ" style="border-style: solid; border-color: #000080; border-collapse: collapse;
        ...
        <table class="tabellaFormattazione grid grid-size-20">
            <tr>
                ...
                <td class="field" style="width: 25%">
                    <asp:TextBox ID="txtNSettimaneQuotaA" runat="server" CssClass="tb8 txtUppercase" Width="70%"
            ...
            <tr>
                ...
                <td class="field" style="width: 25%">
                    <asp:TextBox ID="txtNSettimaneQuotaB" runat="server" CssClass="tb8 txtUppercase" Width="70%"
                        MaxLength="4"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="field" style="width: 25%">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="txtImportoContribTotaleQuotaDL214RF" ControlToValidate="txtImportoContribTotaleQuotaDL214"
                        Display="Dynamic" Enabled="true" ErrorMessage="Importo Contributivo Totale L. 214: campo obbligatorio" ValidationGroup="UCTabDatiCalcoloDZ"
                ...
                <td class="field" style="width: 25%">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="RFVtxtNSettimaneQuotaDL214" ControlToValidate="txtNSettimaneQuotaDL214"
                        Display="Dynamic" Enabled="true" ErrorMessage="Numero Settimane L. 214: campo obbligatorio" ValidationGroup="UCTabDatiCalcoloDZ"
                        Text="*" CssClass="field-is-required"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td class="field" style="width: 25%">
                    ...
                    <asp:RequiredFieldValidator runat="server" ID="RFVtxtMontanteQuotaDL214" ControlToValidate="txtMontanteQuotaDL214"
                        Display="Dynamic" Enabled="true" ErrorMessage="Montante L. 214: campo obbligatorio" ValidationGroup="UCTabDatiCalcoloDZ"
                        Text="*" CssClass="field-is-required"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
    ...
    <table class="tabellaFormattazione  grid grid-size-20" width="100%">
        <tr style="min-height: 50px; vertical-align: bottom">
            ...
            <td class="Row1" style="width: 30%">
                <asp:DropDownList ID="ddlRiduzioneRetributiva" CssClass="tb8 txtUppercase xxs" Width="25%" runat="server">
        ...
        <tr>
            <td style="text-align: right; vertical-align: bottom;" class="tab-actions-group__first">
                <asp:Button ID="btnPopUp" runat="server" SkinID="btnAzione1" CausesValidation="false"
                    Visible="false" Text="Salva Dati Calcolo" Width="150px" OnClientClick="if(Page_ClientValidate('UCTabDatiCalcoloDZ')){return Confirm();}" CssClass="primary" />
                <asp:Button ID="btnSalvaDatiCalcolo" runat="server" CausesValidation="false" Style="display: none"
                    ...
                    Text="Salva Dati Calcolo" Visible="false" OnClientClick="if(Page_ClientValidate('UCTabDatiCalcoloDZ')){aspnetForm.target ='_self'; BlockUI();}" CssClass="primary" />
                <asp:Button ID="btnSalvaDatiCalcoloNoRiduzione" runat="server" CausesValidation="false"
                    ValidationGroup="UCTabDatiCalcoloDZ" SkinID="btnAzione1" Width="150px" OnClick="btnSalvaDatiCalcolo_Click"
                    Text="Salva Dati Calcolo" Visible="true" OnClientClick="if(Page_ClientValidate('UCTabDatiCalcoloDZ')){aspnetForm.target ='_self'; BlockUI();}" CssClass="primary" />
            </td>
