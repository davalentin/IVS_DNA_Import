<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCVittimeCi.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiCi.UCVittimeCi" %>
