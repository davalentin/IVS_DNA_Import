...
{
    public partial class UCOneri : CustomBaseUserControl, IMaggiorazioneBeneficiCi, ITitolarePensione
    {
        ...
        internal void ValorizzaEtichetteOneri(IMaggiorazioneBeneficiCi maggiorazioneBenefici)
        {
        ...
        protected void btnSalvaDatiOneri_Click(object sender, EventArgs e)
        {
            ...
            presenterMaggiorazioneBenefici.SalvaOneriBeneficiParticolariCi(this);
