<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCOneri.ascx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiCi.UCOneri" %>
