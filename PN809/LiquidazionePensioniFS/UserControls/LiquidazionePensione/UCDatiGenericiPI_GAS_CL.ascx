<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCDatiGenericiPI_GAS_CL.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.LiquidazionePensione.UCDatiGenericiPI_GAS_CL" %>
<script type="text/javascript">
    ...
    function getDDLCodNatura2Value() {
        ...
        if (SelectedVal == "Y") {
            if (document.getElementById('<%= tipoFondo.ClientID %>').value != "CL") {
...
<asp:Panel runat="server" ID="pnlDatiGenericiCommon">
    <table class="tabellaFormattazione grid grid-size-25">
        ...
        <asp:Panel ID="pnlTipoCalcolo" runat="server" Visible="false">
            <tr>
                <td class="Row1">
                    <label>
                        Tipo Calcolo:</label>
                            ...
                            <tr>
                                ...
                                <td class="field" style="width: 150px; padding-left: 2px;">
                                    ...
                                    <asp:CustomValidator runat="server" ControlToValidate="txtDataInizioBonus" Display="Dynamic"
                                        ...
                                        ID="custoCheckDataDataInizioBonus" ClientValidationFunction="checkCorrettezzaData" />
                                </td>
        ...
        <asp:Panel ID="pnlCheckMaggiorazioniBenefici" runat="server" Visible="false">
            <tr>
                <asp:Panel ID="pnlCheckTrasformazioneAOI" runat="server" Visible="true">
                    <td class="Row1">
                        <label>
                            Ripristino:</label>
                    </td>
                    <td class="chkField" runat="server" id="tdChkCheckTrasformazioneAOI">
                        <asp:CheckBox runat="server" ID="chkTrasfAOI" CssClass="tb8 offClass onClassTrasfAOI"
                            TabIndex="21" />
                    </td>
                </asp:Panel>
                <asp:Panel ID="pnlCheckBenefici" runat="server" Visible="true">
                    <td class="Row1">
                        <label>
                            Benefici:</label>
                    </td>
        ...
        <asp:Panel ID="pnlCheckExCombattente" runat="server" Visible="false">
            <tr>
                <td class="Row1">
                    <label>
...
<asp:HiddenField runat="server" ID="enteFondo" Value="" />
<asp:HiddenField runat="server" ID="hdnIsTipoCalcoloEnabled" Value="SI" />
