<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCDatiGenericiDZ_ES_PM.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.LiquidazionePensione.UCDatiGenericiDZ_ES_PM" %>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if ($("#<%= hdnTipoFondo.ClientID %>").val() == 'PM') {
            $("#<%= ddlTipoCalcolo.ClientID %>").change(OnChangeTipoCalcolo);
            OnChangeTipoCalcolo();
        }
    ...
    function OnChangeTipoCalcolo() {
        var valueDdlTipoCalcolo = $("#<%=ddlTipoCalcolo.ClientID %>").val();
        var ddlCodiceTipoLiquidazione = $('#<%=ddlCodiceTipoLiquidazione.ClientID%>');
        switch (valueDdlTipoCalcolo) {
            //retibutivo e retributivo monti    
            case '18':
            case '25':
                ddlCodiceTipoLiquidazione.val('1');
                break;
            //contributivo   
            case '19':
                ddlCodiceTipoLiquidazione.val('4');
                break;
            //misto 
            case '20':
                var decorrenzaPensione = convertString2Date('01/' + $('#<%= lblDecorrenzaPensioneDatiGenerici.ClientID%>').text());
                if (decorrenzaPensione <= new Date(1981, 6, 1))
                    ddlCodiceTipoLiquidazione.val('3');
                else
                    ddlCodiceTipoLiquidazione.val('1');
                break;
            default:
                ddlCodiceTipoLiquidazione.val('');
                break;
        }
        $('#<%=hdnCodiceTipoLiquidazione.ClientID%>').val(ddlCodiceTipoLiquidazione.val());
    }
...
<asp:Panel runat="server" ID="pnlDatiGenericiCommon">
    <table class="tabellaFormattazione grid grid-size-20">
        ...
        <tr runat="server" id="TrScadenzaRevisioneSanitaria" visible="false">
            <td class="Row1">
                <asp:Label runat="server" ID="lblRevisioneSanitaria"></asp:Label>
            </td>
            <td class="field">
                ...
                <asp:CustomValidator runat="server" ControlToValidate="txtScadRevSanitaria" Display="Dynamic"
                    ErrorMessage="Revisione Sanitaria: data illogica" Text="*" CssClass="field-is-required" ValidationGroup="UCTabDatiGenerici"
                    ID="customCheckDataRevisioneSanitaria" ClientValidationFunction="checkCorrettezzaData" />
            </td>
            <td>
            </td>
            <td>
        ...
        <asp:Panel runat="server" ID="pnlTipoLiquidazione" Visible="false">
            <tr>
                <td class="Row1">
                    <label>
                        Codice Tipo Liquidazione:</label>
                </td>
                <td class="field full-grid" colspan="3">
                    <asp:DropDownList runat="server" ID="ddlCodiceTipoLiquidazione" CssClass="tb8 txtUppercase"
        ...
        <tr>
            <asp:Panel runat="server" ID="pnlTrasfAOI">
                <td class="Row1">
                    <label>
                        Ripristino:</label>
                </td>
            ...
            <asp:Panel runat="server" ID="pnlDL407" Visible="false">
                <td class="Row1">
                        ...
                        <tr>
                            ...
                            <td class="field" style="width: 150px; padding-left: 2px;">
                                ...
                                <asp:CustomValidator runat="server" ControlToValidate="txtElContDecorrenza" Display="Dynamic"
                                    ...
                                    ID="customCheckDecorrenzaEliminazione" ClientValidationFunction="checkCorrettezzaData" />
                            </td>
                            ...
                            <td class="field" style="width: 160px; padding-left: 13px;">
                                ...
                                <asp:CustomValidator runat="server" ControlToValidate="txtElContDataEvento" Display="Dynamic"
                                    ...
                                    ID="customCheckDataDataEvento" ClientValidationFunction="checkCorrettezzaData" />
                            </td>
                        </tr>
                    </table>
                </div>
...
<asp:HiddenField runat="server" ID="hdnTipoFondo" />
<asp:HiddenField runat="server" ID="hdnCodiceTipoLiquidazione" />
