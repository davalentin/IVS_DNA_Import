<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCIstruttoria.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.LiquidazionePensione.Istruttoria" %>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:Panel ID="pnlRiduzioneRetributiva" runat="server">
                    <table width="100%" class="tabellaFormattazione grid grid-size-25">
            ...
            <tr>
                <td style="text-align: right; vertical-align: bottom;" class="tab-actions-group__first">
                    <asp:Button ID="btnPopUp" runat="server" SkinID="btnAzione1" CausesValidation="false"
                        Visible="false" Text="Salva Istruttoria" Width="180px" OnClientClick="if(Page_ClientValidate('UCTabIstruttoria')){return Confirm();}" CssClass="primary" />
                    <asp:Button ID="btnSalvaIstruttoria" runat="server" CausesValidation="false" Style="display: none"
                        ValidationGroup="UCTabIstruttoria" SkinID="btnAzione1" Width="180px" OnClick="SalvaIstruttoria_Click"
                ...
                <td style="text-align: left">
                    <asp:Button ID="btnEliminaIstruttoria" runat="server" SkinID="btnAzione1" CausesValidation="false"
                        Enabled="true" Text="Elimina Istruttoria" Width="180px" OnClick="EliminaIstruttoria_Click"
