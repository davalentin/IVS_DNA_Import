<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCmiglioramenticontrattualiFS.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.DatiFondo.UCmiglioramenticontrattualiFS" %>
<asp:Panel runat="server" ID="pnlmiglioramenticontrattualiFS">
    <div id="divmiglioramenticontrattualiFS" runat="server" style="margin-left: 10px; margin-right: 10px;">
        <br />
        <table class="tabellaFormattazione" style="padding-left: 10px; padding-bottom: 10px;
            width: 99%">
            <tr>
                <td>
                    <asp:Label runat="server" ID="lblmiglioramenticontrattualiFS"> Miglioramenti Contrattuali:</asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="text-align: center;">
                    <asp:GridView runat="server" ID="gvmiglioramenticontrattualiFS" SkinID="grdElenco1" AutoGenerateColumns="false"
                        CssClass="intestazioneTabella" BorderWidth="1" Width="100%" BorderColor="Black"
                        OnRowCommand="gvmiglioramenticontrattualiFS_RowCommand" OnRowDataBound="gvmiglioramenticontrattualiFS_RowDataBound"
                        OnRowCancelingEdit="gvmiglioramenticontrattualiFS_RowCancelingEdit" OnRowEditing="gvmiglioramenticontrattualiFS_RowEditing"
                        OnDataBound="gvmiglioramenticontrattualiFS_DataBound" OnDataBinding="gvmiglioramenticontrattualiFS_DataBinding"
                        OnRowUpdating="gvmiglioramenticontrattualiFS_RowUpdating" OnRowDeleting="gvmiglioramenticontrattualiFS_RowDeleting"
                            ...
                            <asp:TemplateField HeaderText="Codice Gestione" HeaderStyle-CssClass="intestazioneTabella Row1"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFVddlEnteGestioneFondo" runat="server" ErrorMessage="Codice Gestione : campo obbligatorio"
                                        Display="Dynamic" Text="*" CssClass="field-is-required" ControlToValidate="ddlEnteGestioneFondo" ValidationGroup="UCGvmiglioramenticontrattualiFS"></asp:RequiredFieldValidator>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Decorrenza" HeaderStyle-CssClass="intestazioneTabella Row1"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:CustomValidator runat="server" ControlToValidate="txtDecorrenzaQuota" Display="Dynamic"
                                        ErrorMessage="La Decorrenza Quota inserita non è corretta" Text="*" CssClass="field-is-required" ValidationGroup="UCGvmiglioramenticontrattualiFS"
                            ...
                            <asp:TemplateField HeaderText="Importo" HeaderStyle-CssClass="intestazioneTabella Row1"
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RegularExpressionValidator runat="server" ID="REVtxtImportoQuota" ControlToValidate="txtImportoQuota"
                                        ...
                                        Text="*" CssClass="field-is-required" ValidationExpression="\d{1,8}(,\d{1,7})?" ValidationGroup="UCGvmiglioramenticontrattualiFS" />
                                    <asp:RequiredFieldValidator ID="RFVtxtImportoQuota" runat="server" ErrorMessage="Importo Quota: Campo obbligatorio"
                                        Display="Dynamic" Text="*" CssClass="field-is-required" ControlToValidate="txtImportoQuota" ValidationGroup="UCGvmiglioramenticontrattualiFS"></asp:RequiredFieldValidator>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="intestazioneTabella Row1" ItemStyle-CssClass="TblRecordset3"
                                ...
                                <ItemTemplate>
                                    <asp:Image ID="imgVisualizzaTrattenute" alt="Visualizza dati trattenute" title="Visualizza dati trattenute"
                                        Style="cursor: pointer" src="../App_Themes/BlueINPS1/Images/plus.png" runat="server" />
        ...
        <table width="100%">
            <tr>
                <td style="text-align: right">
                    <asp:Button ID="btnSalvamiglioramenticontrattualiFS" runat="server" SkinID="btnAzione1" CausesValidation="false"
                        Enabled="true" Text="Salva Adeguamenti" Width="200px" OnClientClick="BlockUI()"
                        OnClick="btnSalvamiglioramenticontrattualiFS_Click" />
                </td>
                <td style="text-align: left">
                    <asp:Button ID="btnEliminamiglioramenticontrattualiFS" Style="text-align: center; padding-left: 0px;
                        padding-right: 0px" runat="server" SkinID="btnAzione1" CausesValidation="false"
                        Enabled="false" Text="Elimina Adeguamenti" Width="200px" OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare i Dati Calcolo?')) return false; else BlockUI();"
                        OnClick="btnEliminamiglioramenticontrattualiFS_Click" />
                </td>
            </tr>
        </table>
    </div>
