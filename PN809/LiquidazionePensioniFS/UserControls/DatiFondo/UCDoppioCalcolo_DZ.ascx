<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCDoppioCalcolo_DZ.ascx.cs"
    Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.DatiFondo.UCDoppioCalcolo_DZ" %>
