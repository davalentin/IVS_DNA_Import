<%@ Page Title="" Language="C#" MasterPageFile="~/ElaborazionePosizione/Liquidazione.Master"
    AutoEventWireup="true" CodeBehind="ModalitaPagamento.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.ModalitaPagamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {            
            ...
            $('#dialog-changeSedePensione').text("La pensione verr� liquidata sulla sede " + sedeDomanda + " in quanto si � indicato un ufficio pagatore estero. Confermare?");
            ...
            <div style="margin: 0 auto; margin-top: 5px; float: left;" class="containerWidth xs">
                <ul class="tabsLine2 tabs">
                    <li><a href="#pagamento">Pagamento
                        <asp:Image ID="imgPagamento" ImageAlign="Top" runat="server" ImageUrl="~/App_Themes/<%= Page.Theme %>/Images/rosso_tab.png" /></a></li>
                </ul>
                ...
                <table width="100%" class="footer-actions-group footer-actions-group--no-top footer-actions-group--right footer-actions-group--pagamenti">
                    <tr>
                        <td style="text-align: right;" class="footer-actions-group__last">
                            <asp:Button ID="btnPopUpPage" runat="server" SkinID="btnAzione1" CausesValidation="false"
                                Style="display: none" Text="Salva" Width="150px" OnClientClick="savePagamento(); return false;" CssClass="primary" />
                            <asp:Button ID="btnSalvaPagamento" runat="server" Text="Salva" SkinID="btnAzione1"
                                Width="150px" CausesValidation="false" OnClick="SalvaPagamento_Click" OnClientClick="mainValidate()" CssClass="primary" />
                        </td>
                        <td style="text-align: center;">
                            <asp:Button ID="btnEliminaPagamento" runat="server" Text="Elimina" SkinID="btnAzione1"
                                ...
                                OnClientClick="if(!window.confirm('Sei sicuro di voler eliminare la Modalit� di Pagamento?')) return false; else {aspnetForm.target ='_self'; BlockUI();}" CssClass="ghost-delete" />
                        </td>
