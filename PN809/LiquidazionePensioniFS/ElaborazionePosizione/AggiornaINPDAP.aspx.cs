...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaINPDAP : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggINPDAP_Click(object sender, EventArgs e)
        {
            ...
            InvioCalcolo.AggiornaINPDAP(this);
