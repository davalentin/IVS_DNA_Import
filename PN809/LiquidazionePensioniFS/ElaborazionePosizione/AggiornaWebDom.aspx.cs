...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaWebDom : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggWebDom_Click(object sender, EventArgs e)
        {
            ...
            InvioCalcolo.AggiornaWebDom(this);
