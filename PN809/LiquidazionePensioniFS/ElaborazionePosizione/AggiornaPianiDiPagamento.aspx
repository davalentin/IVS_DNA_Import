<%@ Page Title="" Language="C#" MasterPageFile="~/ElaborazionePosizione/Liquidazione.Master"
    AutoEventWireup="true" CodeBehind="AggiornaPianiDiPagamento.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.AggiornaPianiDiPagamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <input type="hidden" name="hdnSelected" id="hdnSelected" value="#aggiornaPianiDiPagamento"
        runat="server" />
    <asp:ValidationSummary runat="server" ID="validSummary" ValidationGroup="UCAggiornaPianiDiPagamento"
        Font-Size="Small" CssClass="errorBox" />
    <asp:Panel runat="server" ID="pnlAggiornaPianiDiPagamento">
        ...
        <div style="margin: 0 auto; margin-top: 5px; float: left;" id="divWait"
            ...
            <ul class="tabsLine2 tabs">
                <asp:Panel runat="server" ID="pnlTabAggPianiDiPagamento">
                    <li><a href="">Aggiornamento Piani Di Pagamento</a></li>
                </asp:Panel>
            </ul>
            <div>
                            ...
                            <tr>
                                ...
                                <td align="justify" class="Row1">
                                    <label>
                                        ...
                                        finale Piani Di Pagamento.</label>
                                </td>
                                <td style="width: 10%">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="2" class="Row1" style="width: 30%">
                                    <label style="color: #336699; font-weight: bold; font-size: larger">
                                        Risultato dell' aggiornamento Piani Di Pagamento</label>
                                </td>
                                <td style="width: 10%">
                                </td>
                            </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="btnAggPianiDiPagamento" CausesValidation="false" runat="server" Text="Aggiorna"
                                    SkinID="btnAzione1" Width="150px" OnClick="btnAggPianiDiPagamento_Click" OnClientClick="BlockUI()"  CssClass="ghost-update"/>
                            </td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
