...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaPianiDiPagamento : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggPianiDiPagamento_Click(object sender, EventArgs e)
        {
            ...
            InvioCalcolo.AggiornaPianiDiPagamento(this);
        ...
        private void setReturnData()
        {
            ...
            {
                btnAggPianiDiPagamento.Enabled = false;
            }
