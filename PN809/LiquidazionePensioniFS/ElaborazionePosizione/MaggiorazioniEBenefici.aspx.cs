...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class MaggiorazioniEBenefici : CustomBasePage, IInfoLiquidazione, IMaggiorazioneBenefici, IQuadriSemafori
    {
        ...
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCExCombattente tabExCombattente = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCExCombattente)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
        ...
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCBenefici tabBenefici = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCBenefici)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
        ...
        protected void event_ucShowAvvisoDL407(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCLegge407 tabDL407 = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCLegge407)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            if (tabDL407.HasError)
            {
                ucAvviso.Tipo = TipoAvviso.Warning;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = tabDL407.ErrorMessage;
            }
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Legge 407 salvati correttamente";
            }
        }

        protected void event_ucShowAvvisoEliminaDL407(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCLegge407 tabDL407 = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCLegge407)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Legge 407 eliminati correttamente";
            }
        }

        protected void event_ucShowAvvisoPrivilegiate(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCPrivilegiate tabPrivilegiate = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCPrivilegiate)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            if (tabPrivilegiate.HasError)
            {
                ucAvviso.Tipo = TipoAvviso.Warning;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = tabPrivilegiate.ErrorMessage;
            }
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Privilegiate salvati correttamente";
            }
        }

        protected void event_ucShowAvvisoEliminaPrivilegiate(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCPrivilegiate tabPrivilegiate = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCPrivilegiate)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Privilegiate eliminati correttamente";
            }
        }

        protected void event_ucShowAvvisoArticolo2(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCArticolo2 tabArt2 = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCArticolo2)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            if (tabArt2.HasError)
            {
                ucAvviso.Tipo = TipoAvviso.Warning;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = tabArt2.ErrorMessage;
            }
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Articolo 2 salvati correttamente";
            }
        }

        protected void event_ucShowAvvisoEliminaArticolo2(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCArticolo2 tabArt2 = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCArticolo2)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
            ...
            else
            {
                ucAvviso.Tipo = TipoAvviso.Ok;
                ucAvviso.Visible = true;
                ucAvviso.Messaggio = "Dati Articolo 2 eliminati correttamente";
            }
        }

        protected void event_ucShowAvvisoVittime(object sender, EventArgs e)
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCVittimeFS tabVittime = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBenefici.UCVittimeFS)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
        ...
        private void CaricaDatiMaggiorazioneBenefici()
        {
            ...
            presenterMaggiorazioneBenefici.GetMaggiorazioneBenefici(this);
            if (HasError)
            {
                ucAvviso.Visible = true;
                ucAvviso.Tipo = TipoAvviso.Ko;
                ucAvviso.Messaggio = ErrorMessage;
                pnlMaggiorazioniEBenefici.Enabled = false;
                return;
            }
            ...
            if (this.domanda.Tipofondo.HasValue)
            {
                switch (this.domanda.Tipofondo.Value)
                {
                    ...
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.ET:
                        ucLegge407.RenderControls(this);
                        ucLegge407.ValorizzaEtichetteDL407(this);
                        break;
                    ...
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.PT:
                        ucArticolo2.ValorizzaEtichetteArticolo2(this);
                        ucPrivilegiate.ValorizzaEtichettePrivilegiate(this);
                        break;
            ...
            ucVittimeFS.ValorizzaEtichette(this);
        }
        ...
        private void RenderSemafori()
        {
            if ((AreaQuadri)Session["Semaforo"] != null)
            {
                ...
                else if (this.areaQuadri.QuadroMaggiorazioniBenefici.TabDL407 != AreaQuadri.Semaforo.Rosso_NonAbilitato)
                    hdnSelected.Value = "#dl407";
                else if (this.areaQuadri.QuadroMaggiorazioniBenefici.TabPrivilegiate != AreaQuadri.Semaforo.Rosso_NonAbilitato)
                    hdnSelected.Value = "#privilegiate";
                else if (this.areaQuadri.QuadroMaggiorazioniBenefici.TabArticolo2 != AreaQuadri.Semaforo.Rosso_NonAbilitato)
                    hdnSelected.Value = "#articolo2";
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            if ((AreaQuadri)Session["Semaforo"] != null)
            {
                ...
                ValorizzaSemaforiTab(imgLegge407, this.areaQuadri.QuadroMaggiorazioniBenefici.TabDL407, pnlTabLegge407);
                ValorizzaSemaforiTab(imgPrivilegiate, this.areaQuadri.QuadroMaggiorazioniBenefici.TabPrivilegiate, pnlTabPrivilegiate);
                ValorizzaSemaforiTab(imgArt2, this.areaQuadri.QuadroMaggiorazioniBenefici.TabArticolo2, pnlTabArt2);
        ...
        protected void SalvaMaggiorazioniEBenefici_Click(object sender, EventArgs e)
        {
            ...
            if (this.domanda.Tipofondo.HasValue)
            {
                switch (this.domanda.Tipofondo.Value)
                {
                    ...
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.GAS:
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.PM:
                        areaMaggiorazioneBenefici.DatiDL407 = ucLegge407.GetValoriDL407();
                        break;
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.PT:
                    case AreaRispostaRiepilogo.DatiRiepilogoDomanda.TipoFondo.FS:
                        areaMaggiorazioneBenefici.DatiArticolo2 = ucArticolo2.GetValoriDatiArticolo2();
                        areaMaggiorazioneBenefici.DatiPrivilegiate = ucPrivilegiate.GetValoriPrivilegiate();
                        break;
                }
            }

            presenterMaggiorazioneBenefici.SalvaMaggiorazioniBenefici(this);
