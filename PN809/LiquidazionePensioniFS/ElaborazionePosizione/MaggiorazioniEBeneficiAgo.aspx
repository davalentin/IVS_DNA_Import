<%@ Page Title="" Language="C#" MasterPageFile="~/ElaborazionePosizione/Liquidazione.Master"
    AutoEventWireup="true" CodeBehind="MaggiorazioniEBeneficiAgo.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.MaggiorazioniEBeneficiAgo" %>

<%@ Register Src="~/UserControls/UCAvviso.ascx" TagName="UCAvviso" TagPrefix="UCA" %>
<%@ Register Src="~/UserControls/UCInfo.ascx" TagName="UCInfo" TagPrefix="UCI" %>
<%@ Register Src="~/UserControls/MaggiorazioniEBeneficiAgo/UCExCombattente.ascx"
    TagName="UCExCombattente" TagPrefix="UCEC" %>
<%@ Register Src="~/UserControls/MaggiorazioniEBeneficiAgo/UCBenefici.ascx" TagName="UCBenefici"
    TagPrefix="UCBen" %>
<%@ Register Src="~/UserControls/MaggiorazioniEBeneficiAgo/UCMaggiorazioni.ascx"
    TagName="UCMaggiorazioni" TagPrefix="UCMagg" %>
<%@ Register Src="~/UserControls/MaggiorazioniEBeneficiAgo/UCVittime.ascx" TagName="UCVittime"
    TagPrefix="UCVit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ValidationSummary runat="server" ID="tabMaggiorazioni" ValidationGroup="UCTabMaggiorazioni"
        Font-Size="Small" CssClass="errorBox" />
    <asp:ValidationSummary runat="server" ID="tabVittime" ValidationGroup="UCTabVittime"
        Font-Size="Small" CssClass="errorBox" />
    <asp:Panel runat="server" ID="pnlMaggiorazioniEBeneficiAgo">
        ...
        <div style="margin: 0 auto; margin-top: 5px; float: left;" class="containerWidth xs">
            ...
            <div class="tab_container" style="min-height: 150px;">
                ...
                <div id="vittime" class="tab_content">
                    <UCVit:UCVittime runat="server" ID="ucVittime" OnShowAvviso="event_ucShowAvvisoVittime"
            ...
            <table width="100%" class="footer-actions-group">
                <tr>
                    <td style="text-align: right;">
                        <asp:Button ID="btnSalvaMaggiorazioniEBenefici" runat="server" Text="Salva"
                            SkinID="btnAzione1" CausesValidation="false" Width="160px" OnClick="SalvaMaggiorazioniEBenefici_Click"
