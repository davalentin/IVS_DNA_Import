...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaNoteDebito : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggNoteDebito_Click(object sender, EventArgs e)
        {
            ...
            InvioCalcolo.AggiornaNoteDebito(this);
        ...
        private void setReturnData()
        {
            ...
            {
                btnAggNoteDebito.Enabled = false;
            }
