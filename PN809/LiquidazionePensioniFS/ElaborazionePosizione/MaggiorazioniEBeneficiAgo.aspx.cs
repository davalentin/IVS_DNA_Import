...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class MaggiorazioniEBeneficiAgo : CustomBasePage, IInfoLiquidazione, IMaggiorazioneBeneficiAgo, IQuadriSemafori
    {
        ...
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCMaggiorazioni tabMaggiorazioni = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCMaggiorazioni)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
        ...
        {
            INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCVittime tabVittime = (INPS.Pensioni.LiquidazionePensione.View.Web.UserControls.MaggiorazioniEBeneficiAgo.UCVittime)sender;
            if (this.domanda == null)
                this.domanda = (AreaRispostaRiepilogo.DatiRiepilogoDomanda)Session["Domanda"];
        ...
        private void CaricaDatiMaggiorazioneBenefici()
        {
            ...
            presenterMaggiorazioneBenefici.GetMaggiorazioneBeneficiAgo(this);
            if (HasError)
            {
                ucAvviso.Visible = true;
                ucAvviso.Tipo = TipoAvviso.Ko;
                ucAvviso.Messaggio = ErrorMessage;
                pnlMaggiorazioniEBeneficiAgo.Enabled = false;
                return;
            }
            ...
            ucVittime.ValorizzaEtichette(this);
        }
        ...
        protected void SalvaMaggiorazioniEBenefici_Click(object sender, EventArgs e)
        {
            ...
            areaMaggiorazioneBenefici.DatiBeneficioVittimeTerrorismo = ucVittime.RecuperCampi();

            presenterMaggiorazioneBenefici.SalvaMaggiorazioniBeneficiAgo(this);
