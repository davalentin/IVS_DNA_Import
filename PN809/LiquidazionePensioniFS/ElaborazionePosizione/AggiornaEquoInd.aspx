<%@ Page Title="" Language="C#" MasterPageFile="~/ElaborazionePosizione/Liquidazione.Master"
    AutoEventWireup="true" CodeBehind="AggiornaEquoInd.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.AggiornaEquoInd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <input type="hidden" name="hdnSelected" id="hdnSelected" value="#AggiornaEquoInd"
        runat="server" />
    <asp:ValidationSummary runat="server" ID="validSummary" ValidationGroup="UCAggiornaEquoInd"
        Font-Size="Small" CssClass="errorBox" />
    <asp:Panel runat="server" ID="pnlAggiornaEquoInd">
        ...
        <div style="margin: 0 auto; margin-top: 5px; float: left;" id="divWait"
            ...
            <ul class="tabsLine2 tabs">
                <asp:Panel runat="server" ID="pnlTabAggEquoInd">
                    <li><a href="">Aggiornamento Equo Indennizzo</a></li>
                </asp:Panel>
            </ul>
            <div>
                            ...
                            <tr>
                                ...
                                <td align="justify" class="Row1">
                                    <label>
                                        ...
                                        finale per Equo Indenizzo.</label>
                                </td>
                                <td style="width: 10%">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="2" class="Row1" style="width: 30%">
                                    <label style="color: #336699; font-weight: bold; font-size: larger">
                                        Risultato dell' aggiornamento Equo Indennizzo</label>
                                </td>
                                <td style="width: 10%">
                                </td>
                            </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="btnAggEquoInd" CausesValidation="false" runat="server" Text="Aggiorna"
                                    SkinID="btnAzione1" Width="150px" OnClick="btnAggEquoInd_Click" OnClientClick="BlockUI()"  CssClass="ghost-update"/>
                            </td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
