<%@ Page Title="" Language="C#" MasterPageFile="~/ElaborazionePosizione/Liquidazione.Master"
    AutoEventWireup="true" CodeBehind="AggiornaTotal.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.AggiornaTotal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlAggiornaTotal">
        ...
        <div style="margin: 0 auto; margin-top: 5px; float: left;" id="divWait"
            ...
            <ul class="tabsLine2 tabs">
                <asp:Panel runat="server" ID="pnlTabAggTotal">
                    <li><a href="">Aggiornamento TOTAL</a></li>
                </asp:Panel>
            </ul>
            <div>
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="2" class="Row1" style="width: 30%">
                                    <label style="color: #336699; font-weight: bold; font-size: larger">
                                        Risultato dell' aggiornamento TOTAL (Cumulo)</label>
                                </td>
                                <td style="width: 10%">
                                </td>
                            </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="btnAggTotal" CausesValidation="false" runat="server" Text="Aggiorna"
                                    SkinID="btnAzione1" Width="150px" OnClick="btnAggTotal_Click" OnClientClick="BlockUI()"  CssClass="ghost-update"/>
                            </td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
