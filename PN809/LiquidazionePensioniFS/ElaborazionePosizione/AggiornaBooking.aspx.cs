...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaBooking : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggBooking_Click(object sender, EventArgs e)
        {
            List<GestioneAnniRichiestaBonusDatiPrenotazioneElaborazioni> listaPrenotazioneElaborazioni = null;
            ...
            InvioCalcolo.AggiornaBooking(this, out listaPrenotazioneElaborazioni);
            this.ListaPrenotazioneElaborazioni = listaPrenotazioneElaborazioni;
            setReturnData();
        ...
        {
            if (this.ListaPrenotazioneElaborazioni != null && this.ListaPrenotazioneElaborazioni.Count() > 0)
            {
