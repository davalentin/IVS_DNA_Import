...
namespace INPS.Pensioni.LiquidazionePensione.View.Web
{
    ...
    public partial class AggiornaIndennSpec : CustomBasePage, IInfoPostCalcolo
    {
        #region IViewUI
        ...
        protected void btnAggIndennSpec_Click(object sender, EventArgs e)
        {
            ...
            InvioCalcolo.AggiornaIndennitaSpeciale(this);
        ...
        private void setReturnData()
        {
            ...
            {
                btnAggIndennSpec.Enabled = false;
            }
