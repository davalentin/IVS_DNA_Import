<%@ Page Language="C#" MasterPageFile="~/ProcedureOperatore.Master" AutoEventWireup="true"
    CodeBehind="WebDom.aspx.cs" Inherits="INPS.Pensioni.LiquidazionePensione.View.Web.WebDom" %>
            ...
            <tr>
                <td align="center" style="width: 720px">
                    <label style="color: #336699; font-weight: bold; font-size: larger; width: 720px">
                        Gestione ricerca da WebDom</label>
                    <br />
                    <br />
                </td>
            </tr>
                            ...
                            <table class="tabellaFormattazione">
                                <tr align="center">
                                    <td class="Row1" align="center" style="width: 100%;" colspan="2">
                                        <asp:Label ID="lblMsg" runat="server" ForeColor="Black" Font-Bold="true" Text="Di seguito sono riportate le informazioni richieste attraverso l'applicazione WebDom"></asp:Label>
                                    </td>
                                </tr>
                            </table>
