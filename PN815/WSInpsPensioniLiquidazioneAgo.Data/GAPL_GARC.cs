...
namespace INPS.Pensioni.LiquidazioneAgo.Data
{
    ...
    /// </summary>
    public class GAPL_GARC : ITransactionInfo
    {
        ...
        public GAPL_GARC(string transazione)
        {
            this.Request = new HostRequest.GAPL_GARCRequest();
        ...
        public HostRequest.GAPL_GARCRequest Request { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<GAPL_GARC>(this);
                ...
                HostTransactionManager.AreaFromHost<GAPL_GARC>(this, output);
        ...
        public string CallMiddleware(GestionePensione.DatiPensione datiPensione, string descComuneNazione, List<GestioneAnagrafica.DatiAnagrafici> ListaAnagraficaFamiliari, out string jsonStringRequest, out string errori, out string codiciErrore, out string eccezioni, out string jsonStringResponse)
        {
            ...
            try
            {
                swaggerMiddlewareClient client = new swaggerMiddlewareClient(SetApiIdentity(this.Request.DatiGenerici.T_TP1MATRICOLA.ToString(), ""));
                ...
                Utility.ValorizzaOggettiBis(this.Request.Bititolarieta, requestDTO.Request.Bititolarieta);
                if (this.Request.Bititolarieta.LISTT_GP2A15 != null)
                {
                    foreach (var req in this.Request.Bititolarieta.LISTT_GP2A15)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Coda, requestDTO.Request.Coda);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2006, requestDTO.Request.Coda.Dati2006);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2007, requestDTO.Request.Coda.Dati2007);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2008, requestDTO.Request.Coda.Dati2008);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2009, requestDTO.Request.Coda.Dati2009);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2010, requestDTO.Request.Coda.Dati2010);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2011, requestDTO.Request.Coda.Dati2011);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2012, requestDTO.Request.Coda.Dati2012);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2013, requestDTO.Request.Coda.Dati2013);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2014, requestDTO.Request.Coda.Dati2014);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2015, requestDTO.Request.Coda.Dati2015);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2016, requestDTO.Request.Coda.Dati2016);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2017, requestDTO.Request.Coda.Dati2017);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2018, requestDTO.Request.Coda.Dati2018);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2019, requestDTO.Request.Coda.Dati2019);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2020, requestDTO.Request.Coda.Dati2020);
                Utility.ValorizzaOggettiBis(this.Request.Coda.AreaDati2021, requestDTO.Request.Coda.Dati2021);
                //TODO mappare novi dati 2024

                if (this.Request.Coda != null)
                {
                    if (this.Request.Coda.AreaDati2007 != null)
                    {
                        if (this.Request.Coda.AreaDati2007.LISTT_ELTAB_GP7LC != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2007.LISTT_ELTAB_GP7LC)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2008 != null)
                    {
                        if (this.Request.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2008.LISTT_ELTAB_GP2PB)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2012 != null)
                    {
                        if (this.Request.Coda.AreaDati2012.LISTT_GP2BM10 != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2012.LISTT_GP2BM10)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2013 != null)
                    {
                        if (this.Request.Coda.AreaDati2013.LISTT_GP2IC30 != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2013.LISTT_GP2IC30)
                            {
                        ...
                        if (this.Request.Coda.AreaDati2013.LISTT_GP2IC40 != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2013.LISTT_GP2IC40)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2014 != null)
                    {
                        if (this.Request.Coda.AreaDati2014.LISTT_TABTRATTOT != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2014.LISTT_TABTRATTOT)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2015 != null)
                    {
                        if (this.Request.Coda.AreaDati2015.LISTT_TABINGR != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2015.LISTT_TABINGR)
                            {
                    ...
                    if (this.Request.Coda.AreaDati2016 != null)
                    {
                        if (this.Request.Coda.AreaDati2016.LISTGP1FLAGS != null)
                        {
                            foreach (var req in this.Request.Coda.AreaDati2016.LISTGP1FLAGS)
                            {
                ...
                Utility.ValorizzaOggettiBis(this.Request.DanteCausa, requestDTO.Request.DanteCausa);
                Utility.ValorizzaOggettiBis(this.Request.DatiGenerici, requestDTO.Request.DatiGenerici);
                Utility.ValorizzaOggettiBis(this.Request.DatiNuovi, requestDTO.Request.DatiNuovi);

                //Utility.ValorizzaOggettiBis(this.Request.DatiRetributivi_Contributivi, requestDTO.Request.DatiRetributivi_Contributivi);
                if (this.Request.DatiRetributivi_Contributivi.LISTT_GP2BC00 != null)
                {
                    foreach (var req in this.Request.DatiRetributivi_Contributivi.LISTT_GP2BC00)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Delegato, requestDTO.Request.Delegato);
                Utility.ValorizzaOggettiBis(this.Request.Errori, requestDTO.Request.Errori);

                //Utility.ValorizzaOggettiBis(this.Request.Familiari, requestDTO.Request.Familiari);
                if (this.Request.Familiari.LISTT_GP3 != null)
                {
                    foreach (var req in this.Request.Familiari.LISTT_GP3)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.INAIL_Accompagnamento, requestDTO.Request.INAIL_Accompagnamento);
                if (this.Request.INAIL_Accompagnamento.LISTT_GP2BINA != null)
                {
                    foreach (var req in this.Request.INAIL_Accompagnamento.LISTT_GP2BINA)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.IntegrazioneArticolo11, requestDTO.Request.IntegrazioneArticolo11);
                if (this.Request.IntegrazioneArticolo11.LISTGPINTAR11 != null)
                {
                    foreach (var req in this.Request.IntegrazioneArticolo11.LISTGPINTAR11)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Intestazione, requestDTO.Request.Intestazione);

                Utility.ValorizzaOggettiBis(this.Request.Invciv, requestDTO.Request.Invciv);
                if (this.Request.Invciv.LISTT_GP2IC10 != null)
                {
                    foreach (var req in this.Request.Invciv.LISTT_GP2IC10)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Istruttoria, requestDTO.Request.Istruttoria);
                if (this.Request.Istruttoria.LISTT_GP2BG10 != null)
                {
                    foreach (var req in this.Request.Istruttoria.LISTT_GP2BG10)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Pagamento, requestDTO.Request.Pagamento);

                Utility.ValorizzaOggettiBis(this.Request.PannelloContributivo, requestDTO.Request.PannelloContributivo);
                if (this.Request.PannelloContributivo.LISTT_GP2BB03 != null)
                {
                    foreach (var req in this.Request.PannelloContributivo.LISTT_GP2BB03)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Pensionato, requestDTO.Request.Pensionato);
                requestDTO.Request.Pensionato.GP3STATONASCITA = descComuneNazione;              

                Utility.ValorizzaOggettiBis(this.Request.PensioniAbbinate, requestDTO.Request.PensioniAbbinate);

                Utility.ValorizzaOggettiBis(this.Request.Redditi.RedditiMaggiorazione, requestDTO.Request.Redditi.RedditiMaggiorazione);
                if (this.Request.Redditi.RedditiMaggiorazione.LISTT_GP2KM50 != null)
                {
                    foreach (var req in this.Request.Redditi.RedditiMaggiorazione.LISTT_GP2KM50)
                    {
                ...
                if (this.Request.Redditi.RedditiSentenza495_93.LISTT_GP7LKE0Z != null)
                {
                    foreach (var req in this.Request.Redditi.RedditiSentenza495_93.LISTT_GP7LKE0Z)
                    {
                ...
                if (this.Request.Redditi.RedditiSentenza240_94.LISTT_GP2RS00 != null)
                {
                    foreach (var req in this.Request.Redditi.RedditiSentenza240_94.LISTT_GP2RS00)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.ResidenzeEstero, requestDTO.Request.ResidenzeEstero);
                if (this.Request.ResidenzeEstero.LISTT_GP2BS00 != null)
                {
                    foreach (var req in this.Request.ResidenzeEstero.LISTT_GP2BS00)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Ricoveri, requestDTO.Request.Ricoveri);
                if (this.Request.Ricoveri.LISTT_GP2IC20 != null)
                {
                    foreach (var req in this.Request.Ricoveri.LISTT_GP2IC20)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Sentenze, requestDTO.Request.Sentenze);
                if (this.Request.Sentenze.LISTT_GP2SEN0 != null)
                {
                    foreach (var req in this.Request.Sentenze.LISTT_GP2SEN0)
                    {
                ...
                if (this.Request.StatoCivile.LISTT_GP2KM7A != null)
                {
                    foreach (var req in this.Request.StatoCivile.LISTT_GP2KM7A)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Supplementi, requestDTO.Request.Supplementi);
                if (this.Request.Supplementi.LISTT_GP2BE00 != null)
                {
                    foreach (var req in this.Request.Supplementi.LISTT_GP2BE00)
                    {
                ...
                Utility.ValorizzaOggettiBis(this.Request.Tutore, requestDTO.Request.Tutore);

                Utility.ValorizzaOggettiBis(this.Request.SPRDSC21, requestDTO.Request.SPRDSC21);
                if (this.Request.SPRDSC21 != null && this.Request.SPRDSC21.LISTT_GP4DB00 != null)
                {
                    requestDTO.Request.SPRDSC21.LISTT_GP4DB00 = new List<swaggerMiddlewareClient.Gp4db00RequestDTO>();
                    foreach (var req in this.Request.SPRDSC21.LISTT_GP4DB00)
                    {
                ...
                if (this.Request.DatiRetributiviBIS.LISTT_GP2BC00_BIS != null)
                {
                    foreach (var req in this.Request.DatiRetributiviBIS.LISTT_GP2BC00_BIS)
                    {
                ...
                requestDTO.User = this.Request.DatiGenerici.T_TP1MATRICOLA.ToString();
                ...
                GestioneLogSoap.SalvaLogSoap(requestDTO, Utility.Servizio.SrvLiquidazioneAgo, Utility.MetodoServizio.IvsInvocation, Utility.SOAPLogDirection.IN, this.Request.DatiGenerici.T_NDOMUS.ToString(), guid);

                //var response = client.IvsInvocation(requestDTO);

                Dictionary<string, string> headers = SetApiIdentityBis(this.Request.DatiGenerici.T_TP1MATRICOLA.ToString(), "");

                HttpStatusCode statusCode;
                swaggerMiddlewareClient.ResponseDTO response = client.IvsInvocation(requestDTO, headers, out statusCode);

                GestioneLogSoap.SalvaLogSoap(response, Utility.Servizio.SrvLiquidazioneAgo, Utility.MetodoServizio.IvsInvocation, Utility.SOAPLogDirection.OUT, this.Request.DatiGenerici.T_NDOMUS.ToString(), guid);
                ...
                {
                    GestioneNuovoCalcolo.UpdateScadutoEsistoNuovoCalcolo(this.Request.DatiGenerici.T_NDOMUS);
                    ...
                    dati.NDomus = this.Request.DatiGenerici.T_NDOMUS;
            ...
            {
                GestioneLogGenerico.SalvaLogGenerico(this.Request.DatiGenerici.T_NDOMUS, Utility.MetodoServizio.IvsInvocation.ToString(), Utility.TipoLogGenerico.ErroreApplicativo, ex.Message + "-" + (ex.InnerException != null ? ex.InnerException.Message : string.Empty), null, ex.StackTrace);
            }
        ...
        public string CallMainframe(GestionePensione.DatiPensione datiPensione, GestioneAnagrafica.DatiAnagrafici datiAnagrafici, string transactionId, string jsonString, string codErrore, string descrError, DateTimeOffset dataInizio, DateTimeOffset dataFine, DateTimeOffset dataNuovo, bool esito, GestioneNuovoCalcolo.FlowConf confFiltrata)
        {
            try
            {
                msCCQualityDataCheckerClient client = new msCCQualityDataCheckerClient(SetApiIdentity(this.Request.DatiGenerici.T_TP1MATRICOLA.ToString(), "QualityDataChecker"));
                ...
                new msCCQualityDataCheckerClient.OutcomeRequestDTO
                {
                    ...
                    CodUtente = this.Request.DatiGenerici.T_TP1MATRICOLA.ToString(),
                ...
                Guid guid = Guid.NewGuid();
                GestioneLogSoap.SalvaLogSoap(requestDTO, Utility.Servizio.SrvLiquidazioneAgo, Utility.MetodoServizio.Mainframe, Utility.SOAPLogDirection.IN, this.Request.DatiGenerici.T_NDOMUS.ToString(), guid);
                
                Dictionary<string, string> headers = SetApiIdentityBis(this.Request.DatiGenerici.T_TP1MATRICOLA.ToString(), "QualityDataChecker");
            ...
            {
                GestioneLogGenerico.SalvaLogGenerico(this.Request.DatiGenerici.T_NDOMUS, Utility.MetodoServizio.Mainframe.ToString(), Utility.TipoLogGenerico.ErroreApplicativo, ex.Message + "-" + (ex.InnerException != null ? ex.InnerException.Message : string.Empty), null, ex.StackTrace);
            }
        ...
        public string CallAbaco(GestionePensione.DatiPensione datiPensione, GestioneAnagrafica.DatiAnagrafici datiAnagrafici, string transactionId, string jsonStringRequest, string codErrore, string descrError, DateTimeOffset dataInizio, DateTimeOffset dataFine, DateTimeOffset dataNuovo, bool esito, string errori, string codiciErrore, GestioneNuovoCalcolo.FlowConf confFiltrata, string eccezioni, string jsonStringResponse)
        {
            try
            {
                ...
                Guid guid = Guid.NewGuid();
                GestioneLogSoap.SalvaLogSoap(requestDTO, Utility.Servizio.SrvLiquidazioneAgo, Utility.MetodoServizio.Abaco, Utility.SOAPLogDirection.IN, this.Request.DatiGenerici.T_NDOMUS.ToString(), guid);
            ...
            {
                GestioneLogGenerico.SalvaLogGenerico(this.Request.DatiGenerici.T_NDOMUS, Utility.MetodoServizio.Abaco.ToString(), Utility.TipoLogGenerico.ErroreApplicativo, ex.Message + "-" + (ex.InnerException != null ? ex.InnerException.Message : string.Empty), null, ex.StackTrace);
            }
