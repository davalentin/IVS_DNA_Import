...
{
    public class GAPL_GARCRequestNew : ITransactionInfo
    {
        #region Constructor
        public GAPL_GARCRequestNew()
        {
            this.Bititolarieta = new CAREPET.Bititolarieta();
            this.Coda = new CAREPET.Coda();
            this.DanteCausa = new CAREPET.DanteCausa();
            this.DatiGenerici = new CAREPET.DatiGenericiNew();
        ...
        public CAREPET.DatiGenericiNew DatiGenerici { get; set; }
        ...
        public CAREPET.SPRDSC21New SPRDSC21 { get; set; }
