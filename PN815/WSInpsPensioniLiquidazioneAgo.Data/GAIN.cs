...
namespace INPS.Pensioni.LiquidazioneAgo.Data
{
    ...
    /// </summary>
    [Serializable]
    public class GAIN : ITransactionInfo
    {
        ...
        public GAIN(string tipoRichiesta, string codiceCategoria, short sede , int certificato, int annoCompetenza)
        {
        ...
        public HostResponse.GAINResponse Response { get; set; }
        ...
        public void Invoke()
        {
            try
            {
                ...
                byte[] inputData = HostTransactionManager.AreaToHost<GAIN>(this);
                ...
                HostTransactionManager.AreaFromHost<GAIN>(this, output);
        ...
        {
            switch (this.Response.Controllo.COD_RIT)
            {
                case "00":
                    Messaggio = "";
                    break;
