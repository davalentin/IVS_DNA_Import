...
namespace INPS.Pensioni.LiquidazioneAgo.Data.HostResponse.AreaStampa
{
    public class Decorrenze
    {
        ...
        public List<DataDecorrenza> LISTDataDecorrenza { get; internal set; }

        [HisComplexAreaInfoMapping(3, ListCount = 32)]
        public List<ImportoCalcolo> LISTImportoCalcolo { get; internal set; }

        [HisComplexAreaInfoMapping(4, ListCount = 32)]
        public List<ImportoCalcoloOld> LISTImportoCalcoloOld { get; internal set; }

        [HisComplexAreaInfoMapping(5, ListCount = 32)]
        public List<ImportoMinimo> LISTImportoMinimo { get; internal set; }

        [HisComplexAreaInfoMapping(6, ListCount = 32)]
        public List<ImportoMinimoOld> LISTImportoMinimoOld { get; internal set; }

        [HisComplexAreaInfoMapping(7, ListCount = 32)]
        public List<ImportoAccompagno> LISTImportoAccompagno { get; internal set; }

        [HisComplexAreaInfoMapping(8, ListCount = 32)]
        public List<ImportoAccompagnoOld> LISTImportoAccompagnoOld { get; internal set; }

        [HisComplexAreaInfoMapping(9, ListCount = 32)]
        public List<ImportoTrattFamiglia> LISTImportoTrattFamiglia { get; internal set; }

        [HisComplexAreaInfoMapping(10, ListCount = 32)]
        public List<ImportoTrattFamigliaOld> LISTImportoTrattFamigliaOld { get; internal set; }
