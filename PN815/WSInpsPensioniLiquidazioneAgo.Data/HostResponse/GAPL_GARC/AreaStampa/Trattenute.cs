...
namespace INPS.Pensioni.LiquidazioneAgo.Data.HostResponse.AreaStampa
{
    public class Trattenute
    {
        ...
        public List<ONPI> LISTONPI { get; internal set; }

        [HisComplexAreaInfoMapping(1, ListCount = 32)]
        public List<ONPI_Old> LISTONPI_Old { get; internal set; }

        [HisComplexAreaInfoMapping(2, ListCount = 32)]
        public List<TrattenutaQuotaSindacale> LISTTrattenutaQuotaSindacale { get; internal set; }

        [HisComplexAreaInfoMapping(3, ListCount = 32)]
        public List<TrattenutaQuotaSindacaleOld> LISTTrattenutaQuotaSindacaleOld { get; internal set; }

        [HisComplexAreaInfoMapping(4, ListCount = 32)]
        public List<TrattenutaDipendente> LISTTrattenutaDipendente { get; internal set; }

        [HisComplexAreaInfoMapping(5, ListCount = 32)]
        public List<TrattenutaDipendenteOld> LISTTrattenutaDipendenteOld { get; internal set; }

        [HisComplexAreaInfoMapping(6, ListCount = 32)]
        public List<TrattenutaInfortuni> LISTTrattenutaInfortuni { get; internal set; }

        [HisComplexAreaInfoMapping(7, ListCount = 32)]
        public List<TrattenutaInfortuniOld> LISTTrattenutaInfortuniOld { get; internal set; }

        [HisComplexAreaInfoMapping(8, ListCount = 32)]
        public List<TrattenutaAutonomo> LISTTrattenutaAutonomo { get; internal set; }

        [HisComplexAreaInfoMapping(9, ListCount = 32)]
        public List<TrattenutaAutonomoOld> LISTTrattenutaAutonomoOld{ get; internal set; }

        [HisComplexAreaInfoMapping(10, ListCount = 32)]
        public List<TrattenutaSolidarieta> LISTTrattenutaSolidarieta { get; internal set; }

        [HisComplexAreaInfoMapping(11, ListCount = 32)]
        public List<TrattenutaSolidarietaOld> LISTTrattenutaSolidarietaOld { get; internal set; }

        [HisComplexAreaInfoMapping(12, ListCount = 32)]
        public List<TrattenutaSolidarietaPI> LISTTrattenutaSolidarietaPI { get; internal set; }

        [HisComplexAreaInfoMapping(13, ListCount = 32)]
        public List<TrattenutaSolidarietaOldPI> LISTTrattenutaSolidarietaOldPI { get; internal set; }

        [HisComplexAreaInfoMapping(14, ListCount = 32)]
        public List<TrattenutaEstero> LISTTrattenutaEstero { get; internal set; }

        [HisComplexAreaInfoMapping(15, ListCount = 32)]
        public List<TrattenutaEsteroOld> LISTTrattenutaEsteroOld { get; internal set; }
