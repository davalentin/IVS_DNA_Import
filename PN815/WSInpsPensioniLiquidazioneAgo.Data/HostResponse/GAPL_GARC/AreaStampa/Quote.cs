...
namespace INPS.Pensioni.LiquidazioneAgo.Data.HostResponse.AreaStampa
{
    public class Quote
    {
        ...
        public List<TipoQuota> LISTTipoQuota { get; internal set; }

        [HisComplexAreaInfoMapping(1, ListCount = 8)]
        public List<AnniQuota> LISTAnniQuota { get; internal set; }

        [HisComplexAreaInfoMapping(2, ListCount = 8)]
        public List<MesiQuota> LISTMesiQuota { get; internal set; }

        [HisComplexAreaInfoMapping(3, ListCount = 8)]
        public List<GiorniQuota> LISTGiorniQuota { get; internal set; }

        [HisComplexAreaInfoMapping(4, ListCount = 8)]
        public List<SettimaneQuota> LISTSettimaneQuota { get; internal set; }

        [HisComplexAreaInfoMapping(5, ListCount = 8)]
        public List<SettimaneEsclusiveQuota> LISTSettimaneEsclusiveQuota { get; internal set; }

        [HisComplexAreaInfoMapping(6, ListCount = 8)]
        public List<Articolo24> LISTArticolo24 { get; internal set; }
        ...
        public List<RetribuzioneAnnua> LISTRetribuzioneAnnua { get; internal set; }

        [HisComplexAreaInfoMapping(9, ListCount = 8)]
        public List<RetribuzioneMedia> LISTRetribuzioneMedia { get; internal set; }
