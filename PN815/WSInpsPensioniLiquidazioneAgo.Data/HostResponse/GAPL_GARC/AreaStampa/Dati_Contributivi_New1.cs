...
namespace INPS.Pensioni.LiquidazioneAgo.Data.HostResponse.AreaStampa
{
    public class Dati_Contributivi_New1
    {
        ...
        public List<Montante> LISTMontante { get; internal set; }

        [HisComplexAreaInfoMapping(4, ListCount = 10)]
        public List<MontanteEsclusivo> LISTMontanteEsclusivo { get; internal set; }

        [HisComplexAreaInfoMapping(5, ListCount = 10)]
        public List<Importo> LISTImporto { get; internal set; }

        [HisComplexAreaInfoMapping(6, ListCount = 10)]
        public List<ImportoEsclusivo> LISTImportoEsclusivo { get; internal set; }

        [HisComplexAreaInfoMapping(7, ListCount = 10)]
        public List<Commisurazione> LISTCommisurazione { get; internal set; }
