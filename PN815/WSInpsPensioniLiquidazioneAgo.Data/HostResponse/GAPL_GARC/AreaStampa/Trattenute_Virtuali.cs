...
namespace INPS.Pensioni.LiquidazioneAgo.Data.HostResponse.AreaStampa
{
    public class Trattenute_Virtuali
    {
        ...
        public List<LavoroDipendente> LISTLavoroDipendente { get; internal set; }

        [HisComplexAreaInfoMapping(1, ListCount = 32)]
        public List<LavoroDipendenteOld> LISTLavoroDipendenteOld { get; internal set; }

        [HisComplexAreaInfoMapping(2, ListCount = 32)]
        public List<LavoroAutonomo> LISTLavoroAutonomo { get; internal set; }

        [HisComplexAreaInfoMapping(3, ListCount = 32)]
        public List<LavoroAutonomoOld> LISTLavoroAutonomoOld { get; internal set; }
