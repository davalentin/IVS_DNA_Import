...
using INPS.Pensioni.LiquidazioneAgo.ServiceReferences.DelegheSindacali;
using System;
...
namespace INPS.Pensioni.LiquidazioneAgo
{
    public class GestioneDelegheSindacali
    {
        ...
        public static void DecodificaCodiceSindacato(string codeSindacato, out Liquidazione.BLCommon.Entity.Sindacato sindacatoBL, out string errori)
        {
            errori = string.Empty;
            sindacatoBL = null;
            RispostaSindacato sindacatoWS = null;
            ...
            sindacatoBL.Stato = (Utility.StatoSindacato)sindacatoWS.sindacato.sStato;
