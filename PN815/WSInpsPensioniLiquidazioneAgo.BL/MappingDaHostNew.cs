...
namespace INPS.Pensioni.LiquidazioneAgo
{
    public class MappingDaHostNew
    {
        ...
        private static string GetCodiceCategoriaFromAreaPrelievo(Data.GAIN_New AreaPrelievo)
        {
            string categoriaFromHost = null;
            if (AreaPrelievo.ResponseNew.DatiGenerici != null && !string.IsNullOrEmpty(AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB01_V))
                categoriaFromHost = AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB01_V.Trim().ToUpperInvariant().PadLeft(4, '0');
            return categoriaFromHost;
        }

        private static long? GetGestioneFromQuotaDecorrenza(Data.GAIN_New AreaPrelievo, string codiceCategoria, int mese, char? quota,
            List<GestioneDecodifica.CodeGestioneCalcoloRetributivo> elencoCodeGestioneCalcoloRetributivo, int anno)
        {
            ...
            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null)
            {
                if (AreaPrelievo.ResponseNew.Istruttoria != null)
                {
                    var istruttoria = AreaPrelievo.ResponseNew.Istruttoria;
                    meseDecorrenzaOpzione = istruttoria.T_GP1AG03M;
                    meseDecorrenzaOriginaria = istruttoria.T_GP1AD01_OM_V;
                }
                if (AreaPrelievo.ResponseNew.DanteCausa != null)
                {
                    var areaDanteCausa = AreaPrelievo.ResponseNew.DanteCausa;
        ...
        public static void ValorizzaDatiPensione(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, List<string> categorieSpacchettamentoENPALS, List<string> categorieENPALS, out GestionePensione.DatiPensione datiPensione, out bool? enteIstruttoreExInpdap)
        {
            datiPensione = null;
            ...
            if (AreaPrelievo.ResponseNew != null &&
                (AreaPrelievo.ResponseNew.Istruttoria != null || AreaPrelievo.ResponseNew.Coda != null))
            {
                datiPensione = new GestionePensione.DatiPensione();
                Data.CAREPET.Istruttoria istruttoria = AreaPrelievo.ResponseNew.Istruttoria;
                Data.CAREPET.Coda coda = AreaPrelievo.ResponseNew.Coda;
                Data.CAREPET.Pagamento pagamento = AreaPrelievo.ResponseNew.Pagamento;
                bool isPensioneEliminata = AreaPrelievo.ResponseNew.Pagamento != null && !string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Pagamento.T_GP1AM01_V) && AreaPrelievo.ResponseNew.Pagamento.T_GP1AM01_V != 0.ToString();
                ...
                if (istruttoria != null)
                {
                    ...
                    else if (istruttoria.T_GP1CENTCRD_V != 0 && AreaPrelievo.ResponseNew.DatiGenerici != null && (categoriaFromHost == "0032" || categoriaFromHost == "0033" || categoriaFromHost == "0034"))
                    {
                        ...
                        {
                            var bancaPerSede = elencoBanchePerSede.Find(x => x.CodiceSede == AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB02_V.ToString().PadLeft(4, '0') && x.TraduzioneSuGP == istruttoria.T_GP1CENTCRD_V.ToString().PadLeft(4, '0'));
                    ...
                    if (categorieENPALS.Contains(categoriaFromHost) || (AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB02_V.ToString() == "9933" && (codiceCategoria.Trim() == "0801" || codiceCategoria.Trim() == "0802")))
                    {
                ...
                if (coda != null)
                {
                        ...
                        !string.IsNullOrEmpty(coda.AreaDati2012.T_GP1ALZ6) && coda.AreaDati2012.T_GP1ALZ6.Length == 6)
                    {
                        ...
                        {
                            datiPensione.CodiceSedeDestinazione = AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB02_V;
            ...
            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Intestazione != null)
            {
                if (datiPensione == null)
                    datiPensione = new GestionePensione.DatiPensione();

                if (!string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Intestazione.T_WEBDOAS4))
                    datiPensione.DirittoAutonomo = AreaPrelievo.ResponseNew.Intestazione.T_WEBDOAS4;
            }
            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.NuoviDati2024 != null)
            {
                if (datiPensione == null)
                    datiPensione = new GestionePensione.DatiPensione();

                if (AreaPrelievo.ResponseNew.NuoviDati2024.AreaDati2024 != null)
                {
                    if (!string.IsNullOrEmpty(AreaPrelievo.ResponseNew.NuoviDati2024.AreaDati2024.T_GP1AJ10ZD))
                        datiPensione.DataCondizioniPerComputo = Utility.DataFromString(AreaPrelievo.ResponseNew.NuoviDati2024.AreaDati2024.T_GP1AJ10ZD, Utility.FormatoData.AAAAmmGG);

                    datiPensione.GP1AV91A = AreaPrelievo.ResponseNew.NuoviDati2024.AreaDati2024.T_GP1AV91A;
            ...
            //{
            //    if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2018 != null &&
            //        !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC))
            //    {
            //        if (AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC.Length >= 2 && AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC.Substring(1, 1) == "1")
                ...
                controlloDinamicoAbilitazioneMemo57_2023.ValoreControllo.Trim().ToUpperInvariant() == "SI")
            {
                if (AreaPrelievo != null)
                {
                    ...
                    {
                        if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DatiGenerici != null)
                            datiPensione.AnnoMonitoraggio = AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AT22;
                    }
                }
            }
            ...
            {
                if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2018 != null &&
                    !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC) && !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC.Trim()))
                {
                    if (AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC.Length >= 2 && AreaPrelievo.ResponseNew.Coda.AreaDati2018.T_GP1TPCLC.Substring(1, 1) == "2")
                        datiPensione.Caratterizzazione = "1";
                }
            }

            //ENG - RIC/TRF AGO SUPERSTITI SPACCHETTATE (SO 0003, SR 0017, SOART 0020, SOCOM 0023)
            if (tipoDomanda == GestionePrelievo.TipoDomanda.Ricostituzione)
            {
                if (categoriaFromHost == "0003" || categoriaFromHost == "0017" || categoriaFromHost == "0020" || categoriaFromHost == "0023")
                {
                    if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DatiGenerici != null && !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AJSP)
                        && !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AJSP.Trim()) && AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AJSP.Trim().ToUpperInvariant() == "1")
                    {
                        //Il campo GP1AJSP nel tracciato è una stringa da un carattere
                        datiPensione.GP1AJSP = '1';
                    }
                }
            }
        ...
        public static void ValorizzaDatiIstruttoria(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, GestionePrelievo.TipoRicostituzione tipoRicostituzione, List<string> categorieENPALS,
                ...
                AreaPrelievo.ResponseNew.Istruttoria != null || AreaPrelievo.ResponseNew.Coda != null))
            {
                ...
                if (istruttoria != null)
                {
                    ...
                    if (categoriaFromHost != "0198" && categoriaFromHost != "0199" && categoriaFromHost != "0127" && categoriaFromHost != "0128" && categoriaFromHost != "0028" && categoriaFromHost != "0027" &&
                        categoriaFromHost != "0029" && categoriaFromHost != "0143" && categoriaFromHost != "0129" && categoriaFromHost != "0200" && categoriaFromHost != "0197")
                        datiIstruttoria.ScadenzaRevisioneSanitaria = Utility.DataFromInt(istruttoria.T_GP1AF06A_V, istruttoria.T_GP1AF06M_V, 1);
                    if (!(categoriaFromHost == "0029" && AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05 != null && AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05.Trim().ToUpperInvariant() == "L1"))
                    ...
                    //Memo79
                    if (coda.AreaDati2012 != null)
                    {
                        if (coda.AreaDati2012.LISTT_GP2BM10 != null && coda.AreaDati2012.LISTT_GP2BM10.Count > 0)
                        {
                            int nSettimaneOI = 0;
                            int.TryParse(coda.AreaDati2012.LISTT_GP2BM10.First().T_GP2BM13.ToString(), out nSettimaneOI);
                            datiIstruttoria.NSettimaneOI = nSettimaneOI;
                        }
                    }
                    ...
                    if (elencoCodiciParticolari != null && elencoCodiciParticolari.Count > 0 && !string.IsNullOrEmpty(istruttoria.T_GP1AJ11))
                    {
                        if (AreaPrelievo.ResponseNew.DatiGenerici != null && !String.IsNullOrEmpty(AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB01_V))
                        {
                            GestioneDecodifica.CodiceParticolare codPart = elencoCodiciParticolari.Find(x =>
                                x.TraduzioneSuGp == Utility.StringToNullableChar(istruttoria.T_GP1AJ11) && x.CodCategoria.Trim().ToUpperInvariant() == AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AB01_V.Trim().ToUpperInvariant().PadLeft(4, '0'));
                            if (codPart != null)
        ...
        public static void ValorizzaDatiPagamento(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestionePagamento.DatiPagamento datiPagamento)
        {
            datiPagamento = null;
            if (AreaPrelievo.ResponseNew != null &&
                (AreaPrelievo.ResponseNew.Pagamento != null || AreaPrelievo.ResponseNew.Coda != null))
            {
        ...
        public static void ValorizzaDatiFamiliare(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, List<string> categorieSpacchettamentoENPALS, string categoriaFromHost,
            out List<Entity.DatiFamiliari> ListaFamiliari)
        {
            ListaFamiliari = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Familiari != null &&
                AreaPrelievo.ResponseNew.Familiari.LISTT_GP3.Count > 0)
            {
                byte progressivo = 0;
                ListaFamiliari = new List<Entity.DatiFamiliari>();
                foreach (Data.CAREPET.Familiari.T_GP3 familiare in AreaPrelievo.ResponseNew.Familiari.LISTT_GP3)
                {
        ...
        public static void ValorizzaDatiDanteCausa(Data.GAIN_New AreaPrelievo, ref List<GestioneDecodifica.StatoEstero> elencoStatiEsteri, List<GestioneDecodifica.TipoCalcolo> listaTipoCalcolo, out DatiAnagDanteCausa datiAnagDanteCausa, out GestioneDanteCausa.DatiDanteCausa datiDanteCausa)
        {
            datiAnagDanteCausa = null;
            datiDanteCausa = null;
            short resShort = 0;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DanteCausa != null)
            {
                datiAnagDanteCausa = new DatiAnagDanteCausa();
                datiDanteCausa = new GestioneDanteCausa.DatiDanteCausa();

                Data.CAREPET.DanteCausa areaDanteCausa = AreaPrelievo.ResponseNew.DanteCausa;
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null)
            {
                if (AreaPrelievo.ResponseNew.Coda.AreaDati2007 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2007.LISTT_ELTAB_GP7LC != null && AreaPrelievo.ResponseNew.Coda.AreaDati2007.LISTT_ELTAB_GP7LC.Count > 0)
                {
                    List<Data.CAREPET.Coda.Dati2007.T_ELTAB_GP7LC> listaT_ELTAB_GP7LC = AreaPrelievo.ResponseNew.Coda.AreaDati2007.LISTT_ELTAB_GP7LC;
                ...
                if (AreaPrelievo.ResponseNew.Coda.AreaDati2012 != null)
                {
                    Data.CAREPET.Coda.Dati2012 areaDati2012 = AreaPrelievo.ResponseNew.Coda.AreaDati2012;
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.SPRDSC21 != null)
            {
                Data.CAREPET.SPRDSC21New areaSPRDSC21 = AreaPrelievo.ResponseNew.SPRDSC21;
        ...
        public static void ValorizzaDatiResidenzeEstere(Data.GAIN_New AreaPrelievo, List<GestioneDecodifica.StatoEstero> elencoStatiEsteri, out List<GestioneAnagrafica.DatiResidenzaEstero> ListaResidenzeEstere)
        {
            ListaResidenzeEstere = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.ResidenzeEstero != null)
            {
                ListaResidenzeEstere = new List<GestioneAnagrafica.DatiResidenzaEstero>();
                Data.CAREPET.ResidenzeEstero residenzeEstero = AreaPrelievo.ResponseNew.ResidenzeEstero;
        ...
        public static void ValorizzaDatiStatiCivili(Data.GAIN_New AreaPrelievo, out List<GestioneAnagrafica.DatiStatoCivile> ListaStatiCivili)
        {
            ListaStatiCivili = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.StatoCivile != null)
            {
                ListaStatiCivili = new List<GestioneAnagrafica.DatiStatoCivile>();
                Data.CAREPET.StatoCivile statoCivile = AreaPrelievo.ResponseNew.StatoCivile;
        ...
        public static void ValorizzaDatiDelegato(Data.GAIN_New AreaPrelievo, out DatiDelegato datiDelegato)
        {
            datiDelegato = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Delegato != null)
            {
                datiDelegato = new DatiDelegato();
                Data.CAREPET.Delegato delegato = AreaPrelievo.ResponseNew.Delegato;
        ...
        public static void ValorizzaDatiTutore(Data.GAIN_New AreaPrelievo, out DatiTutore datiTutore)
        {
            datiTutore = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Tutore != null)
            {
                datiTutore = new DatiTutore();
                Data.CAREPET.Tutore tutore = AreaPrelievo.ResponseNew.Tutore;
        ...
        public static void ValorizzaDatiCalcoloRetributivo(Data.GAIN_New AreaPrelievo, List<string> categorieENPALS, GestionePrelievo.TipoRicostituzione tipoRicostituzione, ref GestionePensione.DatiPensione datiPensione,
            out List<GestioneCalcolo.DatiCalcoloRetributivo> ListaCalcoloRetributivo, out GestioneCalcolo.DatiCalcoloRetributivoENPAL CalcoloRetributivoENPALS, out List<GestioneQuotaFondoINPGI.DatiCalcoloRetributivoINPGI> ListaDatiRetributiviINPGI)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DatiRetributiviBIS != null)
            {
                ...
                Data.CAREPET.DatiRetributiviBIS calcRetr_bis = AreaPrelievo.ResponseNew.DatiRetributiviBIS;
            ...
            else if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DatiRetributivi_Contributivi != null)
            {
                //Necessario la valorizzazione della proprietà CodiceTipoQuota per ex-inpdai. 
                //Succeviamente verrà impostato a null per tutte le pensioni diverse da ex-inpdai. 
                List<CtrlDecorrenzaRetrExINPDAI> ctrlExInpdai = null;
                ...
                Data.CAREPET.DatiRetributivi_Contributivi calcRetr = AreaPrelievo.ResponseNew.DatiRetributivi_Contributivi;
            ...
            out GestioneCalcolo.DatiCalcoloContributivoENPAL CalcoloContributivoENPALS, out List<Liquidazione.BLCommon.Entity.DatiSuppRecordENPALS> ListaSuppRecordENPALS, out List<GestioneQuotaFondoIntegrativo.DatiQuotaFondoIntegrativo> ListaQuotaFondoIntegrativo, out List<GestioneQuotaFondoINPGI.DatiCalcoloContributivoINPGI> ListaDatiContributiviINPGI)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null)
            {
                ...
                Data.CAREPET.PannelloContributivo calcContr = AreaPrelievo.ResponseNew.PannelloContributivo;
        ...
        public static void ValorizzaDatiQuotePensione(Data.GAIN_New AreaPrelievo, out List<GestioneCalcolo.QuotePensione> ListaQuotePensione, out List<GestioneMiglioramentiContrattuali.DatiQuoteMiglioramentiContrattuali> ListaQuoteMiglioramentiContrattuali)
        {
        ...
        public static void ValorizzaDatiTrattenuteQuotePensione(Data.GAIN_New AreaPrelievo, out List<GestioneCalcolo.TrattenuteQuotePensione> listaTrattenute)
        {
            listaTrattenute = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2014 != null &&
                AreaPrelievo.ResponseNew.Coda.AreaDati2014.LISTT_TABTRATTOT != null && AreaPrelievo.ResponseNew.Coda.AreaDati2014.LISTT_TABTRATTOT.Count > 0)
            {
                List<Data.CAREPET.Coda.Dati2014.T_TABTRATTOT> listaTabTratt = AreaPrelievo.ResponseNew.Coda.AreaDati2014.LISTT_TABTRATTOT;
        ...
        public static void ValorizzaDatiDetrazioni(Data.GAIN_New AreaPrelievo, out GestioneDetrazioniImposta.DatiDetrazioni datiDetrazioni)
        {
            datiDetrazioni = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Istruttoria != null)
            {
                datiDetrazioni = new GestioneDetrazioniImposta.DatiDetrazioni();
                string detrazioni = AreaPrelievo.ResponseNew.Istruttoria.T_GP3CDTI_V.ToString().PadLeft(14, '0');
                ...
                datiDetrazioni.DecorrenzaDetrazioneImposte = Utility.DataFromInt(AreaPrelievo.ResponseNew.Istruttoria.T_GP3DDTIVRCA_V, AreaPrelievo.ResponseNew.Istruttoria.T_GP3DDTIVRCM_V, AreaPrelievo.ResponseNew.Istruttoria.T_GP3DDTIVRCG_V);
            }
        }

        public static void ValorizzaDatiSindacato(Data.GAIN_New AreaPrelievo, out GestionePensione.DatiSindacato datiSindacato)
        {
            datiSindacato = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Istruttoria != null && AreaPrelievo.ResponseNew.Istruttoria.LISTT_GP2BG10 != null
                && AreaPrelievo.ResponseNew.Istruttoria.LISTT_GP2BG10.Count > 0)
            {
                for (int i = AreaPrelievo.ResponseNew.Istruttoria.LISTT_GP2BG10.Count - 1; i >= 0; i--)
                {
                    Data.CAREPET.Istruttoria.T_GP2BG10 sindacato = AreaPrelievo.ResponseNew.Istruttoria.LISTT_GP2BG10[i];
        ...
        public static void ValorizzaDatiSupplementi(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, List<string> categorieENPALS, List<string> categorieCumulo, List<string> categorieTot,
            ...
            GestionePrelievo.TipoRicostituzione tipoRicostituzione, string tipo, string prodotto, out string errore)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Supplementi != null)
            {
                ...
                Data.CAREPET.Supplementi supplementi = AreaPrelievo.ResponseNew.Supplementi;
        ...
        public static void ValorizzaDatiSupplementiBase(Data.GAIN_New AreaPrelievo, List<string> categorieENPALS, out INPS.Pensioni.Liquidazione.BLCommon.Entity.SupplementiBase datiSupplementiBase)
        {
            datiSupplementiBase = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null && AreaPrelievo.ResponseNew.PannelloContributivo.T_GP1AF04 != 0M)
            {
                datiSupplementiBase = new INPS.Pensioni.Liquidazione.BLCommon.Entity.SupplementiBase();
                datiSupplementiBase.RenditaFacoltativaOrdinaria = AreaPrelievo.ResponseNew.PannelloContributivo.T_GP1AF04;
            }
        }

        public static void ValorizzaDatiIntegrazioneArt11(Data.GAIN_New AreaPrelievo, out GestioneIntegrazioneArt11.IntegrazioneArt11 datiIntegrazioneArt11)
        {
            datiIntegrazioneArt11 = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.IntegrazioneArticolo11 != null &&
                AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11 != null &&
                AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11.Count > 0)
            {
                datiIntegrazioneArt11 = new GestioneIntegrazioneArt11.IntegrazioneArt11();
                datiIntegrazioneArt11.Decorrenza = Utility.DataFromInt(AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11[0].T_GP2BC06A, AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11[0].T_GP2BC06M, 1);
                if (AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11[0].T_GP2BC07 != 0M)
                    datiIntegrazioneArt11.ImportoIVS = AreaPrelievo.ResponseNew.IntegrazioneArticolo11.LISTGPINTAR11[0].T_GP2BC07;
            }
        }

        public static void ValorizzaDatiEliminazione(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, out GestionePensione.DatiEliminazione datiEliminazione)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Pagamento != null)
            {
                datiEliminazione = new GestionePensione.DatiEliminazione();
                Data.CAREPET.Pagamento pag = AreaPrelievo.ResponseNew.Pagamento;
        ...
        public static void ValorizzaDatiMaggiorazioni(Data.GAIN_New AreaPrelievo, ref GestionePensione.DatiPensione datiPensione, out INPS.Pensioni.Liquidazione.BLCommon.GestioneMaggiorazioniBenefici.DatiMaggiorazioniBenefici datiMaggiorazioniBenefici, GestionePrelievo.TipoDomanda tipodomanda)
        {
            datiMaggiorazioniBenefici = null;
            if (AreaPrelievo.ResponseNew != null &&
                (AreaPrelievo.ResponseNew.Istruttoria != null ||
                (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2007 != null) ||
                (AreaPrelievo.ResponseNew.Redditi != null && AreaPrelievo.ResponseNew.Redditi.RedditiMaggiorazione != null) ||
                AreaPrelievo.ResponseNew.DatiGenerici != null) &&
                ...
                AreaPrelievo.Request.Controllo.TIPO_RICHIESTA != "51")
            {
                ...
                if (AreaPrelievo.ResponseNew.Istruttoria != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(istruttoria.T_GP1AV61) && istruttoria.T_GP1AV61 != "00")
                    {
                        ...
                        // Se T_GP1AV61 ha valore, allora recupero T_GP1NSETBEN se != 0 - ENG Ric/Trf IOCUM: salvare il campo T_GP1NSETBE anche se pari a 0
                        if (istruttoria.T_GP1NSETBEN != 0 || (tipodomanda == GestionePrelievo.TipoDomanda.Ricostituzione && categoriaFromHost == "0171"))
                ...
                if (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2007 != null)
                {
                    Data.CAREPET.Coda.Dati2007 areaDati2007 = AreaPrelievo.ResponseNew.Coda.AreaDati2007;
                ...
                if (AreaPrelievo.ResponseNew.Redditi != null && AreaPrelievo.ResponseNew.Redditi.RedditiMaggiorazione != null)
                {
                    Data.CAREPET.Redditi.Maggiorazione maggiorazione = AreaPrelievo.ResponseNew.Redditi.RedditiMaggiorazione;
                ...
                if (AreaPrelievo.ResponseNew.DatiGenerici != null)
                {
                    Data.CAREPET.DatiGenericiNew datiGenerici = AreaPrelievo.ResponseNew.DatiGenerici;
                ...
                {
                    if (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null)
                    {
                        Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB eltab = AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB.FirstOrDefault(x => x.T_GP2PBBPAR == 1);
                ...
                else if (datiMaggiorazioniBenefici.TipoSettimaneBeneficio == "02")
                {
                    if (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null)
                    {
                        Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB eltab = AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB.FirstOrDefault(x => x.T_GP2PBBPAR == 2);
                        if (eltab != null && eltab.T_GP2PBBSET != 0)
                ...
                else if (datiMaggiorazioniBenefici.TipoSettimaneBeneficio == "16")
                {
                    if (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null)
                    {
                        Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB eltab = AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB.FirstOrDefault(x => x.T_GP2PBBPAR == 16);
                        if (eltab != null && eltab.T_GP2PBBSET != 0)
                            datiMaggiorazioniBenefici.SettAnzContribPost311295 = eltab.T_GP2PBBSET;
                    }
                }
                else if (datiMaggiorazioniBenefici.TipoSettimaneBeneficio == "17")
                {
                    if (AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null)
                    {
                        Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB eltab = AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB.FirstOrDefault(x => x.T_GP2PBBPAR == 17);
                        if (eltab != null && eltab.T_GP2PBBSET != 0)
                            datiMaggiorazioniBenefici.SettAnzContribPost311295 = eltab.T_GP2PBBSET;
                    }
                }
        ...
        public static void ValorizzaPensioniDatiGenerici(Data.GAIN_New AreaPrelievo, GestionePrelievo.TipoDomanda tipoDomanda, bool? enteIstruttoreExInpdap, out GestioneDatiGenericiAgoCi.PensioniDatiGenerici datiPensioniDatiGenerici)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null &&
                AreaPrelievo.ResponseNew.Coda.AreaDati2013 != null)
            {
                datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                Data.CAREPET.Coda.Dati2013 dati2013 = AreaPrelievo.ResponseNew.Coda.AreaDati2013;
                ...
                if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null)
                {
                    if (AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03 != null && AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.Count > 0)
                    {
                            ...
                            AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05.Trim().ToUpperInvariant() == "L1"))
                        {
                            if (datiPensioniDatiGenerici == null)
                                datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                            datiPensioniDatiGenerici.ImportoLordoAllaDecorrenza = AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB06;
                        }
                    }
                }
            }
            else if (categoriaFromHost == "0027" || categoriaFromHost == "0127")
            {
                if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null)
                {
                    ...
                    {
                        if (AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05 != null &&
                           AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05.Trim().ToUpperInvariant() == "L")
                        {
                            if (datiPensioniDatiGenerici == null)
                                datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                            datiPensioniDatiGenerici.ImportoLordoAllaDecorrenza = AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB06;
            ...
            else if (categoriaFromHost == "0143")
            {
                ...
                {
                    if (AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05 != null &&
                        AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB05.Trim().ToUpperInvariant() == "M0")
                    {
                        if (datiPensioniDatiGenerici == null)
                            datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                        datiPensioniDatiGenerici.ImportoLordo = AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB06;
                    }
                }

            }

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();

                Data.CAREPET.Coda.Dati2008 dati2008 = AreaPrelievo.ResponseNew.Coda.AreaDati2008;
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null &&
                AreaPrelievo.ResponseNew.Coda.AreaDati2014 != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();

                Data.CAREPET.Coda.Dati2014 dati2014 = AreaPrelievo.ResponseNew.Coda.AreaDati2014;
            ...
            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Intestazione != null)
            {
                ...
                if (AreaPrelievo.ResponseNew.Intestazione.T_GP1AF09Z != 0)
                    datiPensioniDatiGenerici.DataAssunzioneCarico = Utility.DataFromString(AreaPrelievo.ResponseNew.Intestazione.T_GP1AF09Z.ToString() + "01", Utility.FormatoData.AAAAmmGG);
            }

            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Sentenze != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();

                if (AreaPrelievo.ResponseNew.Sentenze.T_GP1AXE1_V != 0)
                    datiPensioniDatiGenerici.CodRicalcoloSentenza = Utility.StringToNullableByte(AreaPrelievo.ResponseNew.Sentenze.T_GP1AXE1_V.ToString());
            }

            if (AreaPrelievo != null && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.DatiGenerici != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                datiPensioniDatiGenerici.ReqArt2DL503 = AreaPrelievo.ResponseNew.DatiGenerici.T_GP1AV91M;
            }

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null &&
                AreaPrelievo.ResponseNew.Coda.AreaDati2020 != null && AreaPrelievo.ResponseNew.Coda.AreaDati2020.T_GP2BB10_UNICO > 0)
            {
                Data.CAREPET.Coda.Dati2020 dati2020 = AreaPrelievo.ResponseNew.Coda.AreaDati2020;
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2021 != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();

                Data.CAREPET.Coda.Dati2021 dati2021 = AreaPrelievo.ResponseNew.Coda.AreaDati2021;
            ...
            {
                if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Invciv != null)
                {
                    if (datiPensioniDatiGenerici == null)
                        datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                    datiPensioniDatiGenerici.ImportoMensileAllaDecorrenzaOriginaria = AreaPrelievo.ResponseNew.Invciv.T_GP2BB061_V;
                    datiPensioniDatiGenerici.ImportoMensileAlGennaio2001 = AreaPrelievo.ResponseNew.Invciv.T_GP2BB062_V;
                }
            }
            //ENG - MEMO 74_2023
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.NuoviDati2024 != null && AreaPrelievo.ResponseNew.NuoviDati2024.AreaDatiGP2BO00 != null)
            {
                if (datiPensioniDatiGenerici == null)
                    datiPensioniDatiGenerici = new GestioneDatiGenericiAgoCi.PensioniDatiGenerici();
                Data.CAREPET.NuoviDati2024.DatiGP2BO00 dati2024 = AreaPrelievo.ResponseNew.NuoviDati2024.AreaDatiGP2BO00;
            ...
            GestioneDecodifica.AGO_CI_GetCategoriaByCategoriaNumerica(codiceCategoria, out siglaCategoria);
            if (!string.IsNullOrEmpty(siglaCategoria) && siglaCategoria.Trim().ToUpper().Equals("ESOTEL"))
            {
                if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null)
                    datiPensioniDatiGenerici.ImportoLordoAllaDecorrenza = AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.FirstOrDefault() != null ? AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.First().T_GP2BB06 : (decimal?)null;
            }
        }

        public static void ValorizzaDatiBititolarita(Data.GAIN_New AreaPrelievo, out List<GestioneAltrePensioni.AltraPensione> ListaBititolarita)
        {
            ListaBititolarita = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Bititolarieta != null)
            {
                ListaBititolarita = new List<GestioneAltrePensioni.AltraPensione>();
                Data.CAREPET.Bititolarieta bititolarieta = AreaPrelievo.ResponseNew.Bititolarieta;
        ...
        public static void ValorizzaDatiInabilitaINAIL(Data.GAIN_New AreaPrelievo, out List<GestionePensioneInailInabilita.DatiPensioniINAIL> listaInail,
            out GestionePensioneInailInabilita.DatiInabilita datiInabilita)
        {
            listaInail = null;
            datiInabilita = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.INAIL_Accompagnamento != null)
            {
                ...
                Data.CAREPET.INAIL_Accompagnamento inail_accomp = AreaPrelievo.ResponseNew.INAIL_Accompagnamento;
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2007 != null)
            {
                if (datiInabilita == null)
                    datiInabilita = new GestionePensioneInailInabilita.DatiInabilita();
                datiInabilita.CessazioneAssegnoAccompangamento = Utility.DataFromInt(AreaPrelievo.ResponseNew.Coda.AreaDati2007.T_GP2BACFAA, AreaPrelievo.ResponseNew.Coda.AreaDati2007.T_GP2BACFMM, 1);
            }
        }

        public static void ValorizzaDatiOneri(Data.GAIN_New AreaPrelievo, out List<GestioneOneri.DatiOneri> ListaDatiOneri, ref GestionePensione.DatiPensione datiPensione, GestionePrelievo.TipoDomanda tipoDomanda)
        {
            ListaDatiOneri = null;
            string codiceCategoria = GetCodiceCategoriaFromAreaPrelievo(AreaPrelievo);
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008 != null &&
                AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB != null && AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB.Count > 0)
            {
                ListaDatiOneri = new List<GestioneOneri.DatiOneri>();
                List<Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB> listaOneri = AreaPrelievo.ResponseNew.Coda.AreaDati2008.LISTT_ELTAB_GP2PB;
                ...
                foreach (Data.CAREPET.Coda.Dati2008.T_ELTAB_GP2PB on in listaOneri)
                {
                    if (on.T_GP2PBPLEG != 0)
                    {
                        ...
                        if ((on.T_GP2PBPLEG == 5000 || on.T_GP2PBPLEG == 5300 || on.T_GP2PBPLEG == 5800 || on.T_GP2PBPLEG == 6000 || on.T_GP2PBPLEG == 6100) && AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Istruttoria != null)
                        {
                            datiOneri.ScadenzaBeneficio = Utility.DataFromInt(AreaPrelievo.ResponseNew.Istruttoria.T_GP1AF06A_V, AreaPrelievo.ResponseNew.Istruttoria.T_GP1AF06M_V, 1);
                        }

                        //ENG - RIC INPGI MIGRATE
                        if ((codiceCategoria == "0243" || codiceCategoria == "0244" || codiceCategoria == "0245") && tipoDomanda == GestionePrelievo.TipoDomanda.Ricostituzione
                            && !String.IsNullOrEmpty(datiPensione.GP1AV91B) && datiPensione.GP1AV91B.Trim() == "2")
                        {
                            datiOneri.GP2PBB80 = on.T_GP2PBB80;
        ...
        public static void ValorizzaDatiBeneficiParticolari(Data.GAIN_New AreaPrelievo, out List<GestioneBeneficiParticolari.DatiBeneficiParticolari> ListaDatiBeneficiParticolari)
        {
        ...
        public static void ValorizzaRedditiSentenza495_93(Data.GAIN_New AreaPrelievo, out List<GestioneDanteCausa.DatiRedditoSentenza495_93> ListaDatiRedditiSentenza495_93)
        {
            ListaDatiRedditiSentenza495_93 = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Redditi != null && AreaPrelievo.ResponseNew.Redditi.RedditiSentenza495_93 != null &&
                AreaPrelievo.ResponseNew.Redditi.RedditiSentenza495_93.LISTT_GP7LKE0Z != null && AreaPrelievo.ResponseNew.Redditi.RedditiSentenza495_93.LISTT_GP7LKE0Z.Count > 0)
            {
                ListaDatiRedditiSentenza495_93 = new List<GestioneDanteCausa.DatiRedditoSentenza495_93>();
                List<Data.CAREPET.Redditi.Sentenza495_93.T_GP7LKE0Z> listaRedditiSentenza495_93 = AreaPrelievo.ResponseNew.Redditi.RedditiSentenza495_93.LISTT_GP7LKE0Z;
        ...
        public static void ValorizzaDatiBeneficioVittimeTerrorismo(Data.GAIN_New AreaPrelievo, out GestioneBeneficioVittimeTerrorismo.DatiBeneficioVittimeTerrorismo datiBeneficioVittimeTerrorismo, out bool isGP1AC01Valorizzato)
        {
            ...
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Pagamento != null)
            {
                ...
                if (!string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V))
                {
                    isGP1AC01Valorizzato = true;

                    if (AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V == "4")
                    {
                        datiBeneficioVittimeTerrorismo.TipologiaPrestazione = Utility.StringToNullableInt64(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.Substring(0, 1));
                        datiBeneficioVittimeTerrorismo.CodiceEvento = Utility.StringToNullableChar(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.PadRight(3, ' ').Substring(1, 1));
                        datiBeneficioVittimeTerrorismo.TipologiaBeneficio = Utility.StringToNullableInt64(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.PadRight(3, ' ').Substring(2, 1));
                    }
                    else
                    {
                        datiBeneficioVittimeTerrorismo.TipologiaPrestazione = Utility.StringToNullableInt64(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.Substring(0, 1));
                        datiBeneficioVittimeTerrorismo.CodiceEvento = Utility.StringToNullableChar(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.Substring(1, 1));
                        datiBeneficioVittimeTerrorismo.TipologiaBeneficio = Utility.StringToNullableInt64(AreaPrelievo.ResponseNew.Pagamento.T_GP1AC01_V.Substring(2, 1));
                    }
                }
            }

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Coda != null && AreaPrelievo.ResponseNew.Coda.AreaDati2009 != null)
            {
                if (datiBeneficioVittimeTerrorismo == null)
                    datiBeneficioVittimeTerrorismo = new GestioneBeneficioVittimeTerrorismo.DatiBeneficioVittimeTerrorismo();

                string soggettoBeneficiarioTraduzioneSuGP = string.Empty;
                soggettoBeneficiarioTraduzioneSuGP += !string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC021) ? AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC021.PadLeft(1, ' ') : " ";
                soggettoBeneficiarioTraduzioneSuGP += !string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC022) ? AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC022.PadLeft(1, ' ') : " ";
                soggettoBeneficiarioTraduzioneSuGP += !string.IsNullOrEmpty(AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC023) ? AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AC023.PadLeft(1, ' ') : " ";
                ...
                datiBeneficioVittimeTerrorismo.DataEventoTerroristico = Utility.DataFromInt(AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AP35A, AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AP35M, AreaPrelievo.ResponseNew.Coda.AreaDati2009.T_GP1AP35G);
            }
        }

        public static void ValorizzaDatiCalcoloVittimeTerrorismo(Data.GAIN_New AreaPrelievo, out List<GestioneCalcoloVittimeTerrorismo.DatiCalcoloVittimeTerrorismo> listaDatiCalcoloVittimeTerrorismo)
        {
        ...
        public static void ValorizzaAventiDiritto_Periodi(Data.GAIN_New AreaPrelievo, out List<GestioneAventiDiritto.AventeDirittoRecuperato> listaDatiAventiDiritto)
        {
            listaDatiAventiDiritto = null;
            string codiceFiscaleTitolare = string.Empty;
            string codiceNucleoTitolare = string.Empty;

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Pensionato != null)
            {
                codiceFiscaleTitolare = AreaPrelievo.ResponseNew.Pensionato.T_GP3CB08T_V;
            }

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.SPRDSC21 != null && AreaPrelievo.ResponseNew.SPRDSC21.LISTT_GP4DB00 != null && AreaPrelievo.ResponseNew.SPRDSC21.LISTT_GP4DB00.Count > 0)
            {
                listaDatiAventiDiritto = new List<GestioneAventiDiritto.AventeDirittoRecuperato>();
                List<Data.CAREPET.SPRDSC21New.T_GP4DB00> listaAventiDiritto = AreaPrelievo.ResponseNew.SPRDSC21.LISTT_GP4DB00;

                foreach (Data.CAREPET.SPRDSC21New.T_GP4DB00 aventeDirittoHost in listaAventiDiritto)
                {
                    ...
                    if (aventeDiritto.CodiceFiscale == codiceFiscaleTitolare)
                    {
                        ...
                        if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Familiari != null && AreaPrelievo.ResponseNew.Familiari.LISTT_GP3 != null && AreaPrelievo.ResponseNew.Familiari.LISTT_GP3.Count > 0)
                        {
                            Data.CAREPET.Familiari.T_GP3 familiare = AreaPrelievo.ResponseNew.Familiari.LISTT_GP3.Find(x => x.T_GP3CB08 == codiceFiscaleTitolare);
                            if (familiare != null)
        ...
        public static void ValorizzaSentenzaArt4(Data.GAIN_New AreaPrelievo, out List<GestioneSentenzaArt4.DatiSentenzaArt4> listaDatiSentenzaArt4)
        {
            listaDatiSentenzaArt4 = null;

            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.PannelloContributivo != null && AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03 != null && AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03.Count > 0)
            {
                listaDatiSentenzaArt4 = new List<GestioneSentenzaArt4.DatiSentenzaArt4>();
                List<Data.CAREPET.PannelloContributivo.T_GP2BB03> listaPannContr = AreaPrelievo.ResponseNew.PannelloContributivo.LISTT_GP2BB03;
        ...
        public static void ValorizzaSentenze(Data.GAIN_New AreaPrelievo, out List<GestioneSentenze.DatiSentenze> listaDatiSentenze)
        {
            listaDatiSentenze = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.Sentenze != null && AreaPrelievo.ResponseNew.Sentenze.LISTT_GP2SEN0 != null && AreaPrelievo.ResponseNew.Sentenze.LISTT_GP2SEN0.Count > 0)
            {
                listaDatiSentenze = new List<GestioneSentenze.DatiSentenze>();
                List<Data.CAREPET.Sentenze.T_GP2SEN0> listaSentenze = AreaPrelievo.ResponseNew.Sentenze.LISTT_GP2SEN0;
        ...
        //ENG - MEMO 74_2023 
        public static void ValorizzaDatiStatiEsteri(Data.GAIN_New AreaPrelievo, out List<GestioneContrib.StatoEsteroCumulo> listaStatiEsteriCumulo)
        {
            listaStatiEsteriCumulo = null;
            if (AreaPrelievo.ResponseNew != null && AreaPrelievo.ResponseNew.NuoviDati2024 != null && AreaPrelievo.ResponseNew.NuoviDati2024.LISTT_GP2BR00 != null && AreaPrelievo.ResponseNew.NuoviDati2024.LISTT_GP2BR00.Count() > 0)
            {
                listaStatiEsteriCumulo = new List<GestioneContrib.StatoEsteroCumulo>();
                List<Data.CAREPET.NuoviDati2024.DatiGP2BR00> listaDatiStatiEsteri = AreaPrelievo.ResponseNew.NuoviDati2024.LISTT_GP2BR00;
                ...
                foreach (Data.CAREPET.NuoviDati2024.DatiGP2BR00 stEst in listaDatiStatiEsteri)
                {
                    if (stEst.T_GP2BR02 != 0)
                    {
                        ...
                        if (AreaPrelievo.ResponseNew.NuoviDati2024.AreaDatiGP2BO00 != null)
                        {
                            Data.CAREPET.NuoviDati2024.DatiGP2BO00 dati2024 = AreaPrelievo.ResponseNew.NuoviDati2024.AreaDatiGP2BO00;
