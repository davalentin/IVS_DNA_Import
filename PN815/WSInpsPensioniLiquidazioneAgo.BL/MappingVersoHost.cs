...
namespace INPS.Pensioni.LiquidazioneAgo
{
    public class MappingVersoHost
    {
        ...
        public static void ValorizzaRichiesta(string matricolaOperatore, short sedeOperatore, ref EntityBLCommon.ContenitoreObject contenitore, ref EntityBLCommon.ContenitoreDecodifica contenitoreDecodifica,
            DateTime dataSistema, int annoCompetenza, out Data.HostRequest.GAPL_GARCRequest richiesta)
        {
            richiesta = new Data.HostRequest.GAPL_GARCRequest();
            ...
            #region DatiGenerici
            Data.CAREPET.DatiGenerici datiGenerici = null;
            ...
            #region SPRDSC21
            Data.CAREPET.SPRDSC21 sprdsc21 = null;
            ValorizzaSPRDSC21(ref contenitore, datiGenerici, out sprdsc21);
        ...
        public static void ValorizzaRichiesta(Data.GAPL_GARC AreaCalcolo, out Data.HostRequest.CopericonRequest richiesta)
        {
            string errori = string.Empty;
            long nDomus = AreaCalcolo.Request.DatiGenerici.T_NDOMUS;
            richiesta = new Data.HostRequest.CopericonRequest();
            richiesta.TipoProcedura = 1;
            richiesta.DataPrelievo = DateTime.Now;
            richiesta.MatricolaOperatore = AreaCalcolo.Request.DatiGenerici.T_TP1MATRICOLA;
            richiesta.CodCategoria = AreaCalcolo.Request.DatiGenerici.T_GP1AB01_V;
            richiesta.CodSede = AreaCalcolo.Request.DatiGenerici.T_GP1AB02_V.ToString().PadLeft(4, '0');
            richiesta.Certificato = AreaCalcolo.Request.DatiGenerici.T_GP1AB03_V.ToString().PadLeft(8, '0');
            richiesta.CodBeneficiLegge2062004 = !string.IsNullOrEmpty(AreaCalcolo.Request.Pagamento.T_GP1AC01_V) ? AreaCalcolo.Request.Pagamento.T_GP1AC01_V.PadRight(3, ' ') : string.Empty.PadLeft(3, ' ');
            long resLong = 0;
            long.TryParse(AreaCalcolo.Request.Pagamento.T_GP1AM01_V, out resLong);
            richiesta.CodEliminazione = resLong;
            if (richiesta.CodEliminazione > 0)
                richiesta.DataEliminazione = new DateTime(AreaCalcolo.Request.Pagamento.T_GP1AM02A_V, AreaCalcolo.Request.Pagamento.T_GP1AM02M_V, 1);
        ...
        private static void ValorizzaDatiGenerici(ref EntityBLCommon.ContenitoreObject contenitore, string matricolaOperatore, DateTime dataSistema, out Data.CAREPET.DatiGenerici datiGenerici)
        {
            datiGenerici = new Data.CAREPET.DatiGenerici();
            ...
            else if (Utility.IsDomandaCumulo(contenitore.DatiPensione.SiglaCategoria) || Utility.IsDomandaTotalizzazione(contenitore.DatiPensione.SiglaCategoria))
            {
                ...
                if (contenitore.ListaQuoteMiglioramentiContrattuali != null && contenitore.ListaQuoteMiglioramentiContrattuali.Count > 0)
                {
                    ...
                    foreach (GestioneMiglioramentiContrattuali.DatiQuoteMiglioramentiContrattuali quoteMiglioramenti in contenitore.ListaQuoteMiglioramentiContrattuali)
                    {
                     ...
                     || Utility.IsDomandaVESO33_DAP(contenitore.DatiPensione) || ((Utility.IsDomandaVESO33(contenitore.DatiPensione.SiglaCategoria) || Utility.IsDomandaVESO92(contenitore.DatiPensione.SiglaCategoria) || Utility.IsDomandaESPA(contenitore.DatiPensione.SiglaCategoria)) &&
        ...
        private static void ValorizzaFamiliari(ref EntityBLCommon.ContenitoreObject contenitore, Utility.TipoDomanda tipoDomanda, DateTime dataSistema, out Data.CAREPET.Familiari familiari)
        {
            ...
            if (listaFamiliari != null && listaFamiliari.Count > 0)
            {
                ...
                foreach (GestioneFamiliari.Familiare fam in listaFamiliari)
                {
                    ...
                    //ENG - Spacchettate SOPGI
                    if ((Utility.IsDomandaSpacchettamentoENPALS(contenitore.DatiPensione) || Utility.IsDomandaSpacchettamentoSOPGIPost072022(contenitore.DatiPensione, contenitore.DatiDanteCausa)) && titolare != null && fam.CodiceFiscale == titolare.CodiceFiscale)
                    {
                        if (contenitore.DatiIstruttoria != null)
                        {
            ...
            DateTime? inail_CessazioneAssegnoAccompangamento, out Data.CAREPET.Coda coda)
        {
                ...
                !(contenitore.DatiMaggiorazioniBenefici != null && contenitore.DatiMaggiorazioniBenefici.TipoSettimaneBeneficio == "01"))
            {
                ...
                bool isSettimaneBeneficioFromAnzContribPost311295 = contenitore.DatiMaggiorazioniBenefici.TipoSettimaneBeneficio == "16" || contenitore.DatiMaggiorazioniBenefici.TipoSettimaneBeneficio == "17" ? true : false;
        ...
        private static void ValorizzaSPRDSC21(ref EntityBLCommon.ContenitoreObject contenitore, Data.CAREPET.DatiGenerici datiGenerici, out Data.CAREPET.SPRDSC21 sprdsc21)
        {
            sprdsc21 = null;
            ...
            if (contenitore.DatiDanteCausa != null)
            {
                ...
                {
                    sprdsc21 = new Data.CAREPET.SPRDSC21();
            ...
            if (contenitore.ListaAventiDiritto != null && contenitore.ListaAventiDiritto.Count > 0)
            {
                ...
                if (sprdsc21 == null)
                    sprdsc21 = new Data.CAREPET.SPRDSC21();
                sprdsc21.LISTT_GP4DB00 = new List<Data.CAREPET.SPRDSC21.T_GP4DB00>();

                foreach (var aventeDiritto in contenitore.ListaAventiDiritto)
                {
                    Data.CAREPET.SPRDSC21.T_GP4DB00 gp4db00 = new Data.CAREPET.SPRDSC21.T_GP4DB00();
                    ...
                    {
                        gp4db00.LISTT_GP4DC00 = new List<Data.CAREPET.SPRDSC21.T_GP4DC00>();
                        int i = 1;
                        foreach (var periodo in aventeDiritto.ListaPeriodi)
                        {
                            Data.CAREPET.SPRDSC21.T_GP4DC00 gp4dc00 = new Data.CAREPET.SPRDSC21.T_GP4DC00();
